def solve(
    ...
    """
    #: L1
    rachel_shoe_cost = sara_shoe_cost * rachel_multiplier

    #: L2
    rachel_dress_cost = sara_dress_cost * rachel_multiplier

    #: L3
    rachel_total_budget = rachel_shoe_cost + rachel_dress_cost

    answer = rachel_total_budget  # FINAL ANSWER
    return answer