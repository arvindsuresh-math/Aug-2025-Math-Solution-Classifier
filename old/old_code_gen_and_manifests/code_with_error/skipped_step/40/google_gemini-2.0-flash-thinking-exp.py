def solve(
    ...
    #: L2
    discount_amount_per_ticket = ticket_cost * discount_rate

    #: L3
    cost_per_discounted_ticket = ticket_cost - discount_amount_per_ticket

    #: L4
    total_cost_discounted_tickets = cost_per_discounted_ticket * ticket_cost

    #: L5
    num_full_price_tickets = discount_threshold
    total_cost_full_price_tickets = ticket_cost * num_full_price_tickets
