def solve(
    ...
    #: L1
    bananas_type1_piles = num_piles_type1 * hands_per_pile_type1 * bananas_per_hand_type1

    #: L2
    num_piles_type2 = total_piles - num_piles_type1

    #: L3
    bananas_type2_piles = num_piles_type2 * hands_per_pile_type2 * bananas_per_hand_type2

    #: L4
    total_bananas = bananas_type1_piles + bananas_type2_piles

    #: L5
    bananas_per_monkey = 89.0
