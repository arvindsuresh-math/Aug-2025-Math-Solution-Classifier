def solve(
    ...
    #: L1
    large_painting_revenue = large_painting_price * large_paintings_last_month

    #: L2
    small_painting_revenue = small_painting_price * small_paintings_last_month

    #: L3
    total_sales_last_month = large_painting_revenue + small_painting_revenue

    #: L4
    total_sales_this_month = small_painting_price * 2
