def solve(
    ...
    #: L1
    milkshake_cost = money_left_unshredded / milkshake_fraction

    #: L2
    money_after_milkshake = total_earnings - milkshake_cost

    #: L3
    money_in_wallet = money_after_milkshake / savings_fraction
