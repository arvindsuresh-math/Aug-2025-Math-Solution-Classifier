def solve(
    ...
    #: L1
    jeff_skips_round1 = sam_skips_per_round - diff_round1

    #: L2
    jeff_skips_round2 = sam_skips_per_round - diff_round2

    #: L3
    jeff_skips_round3 = sam_skips_per_round + diff_round3

    #: L4
    jeff_skips_round4 = sam_skips_per_round * fraction_round4

    #: L5
    jeff_total_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4

    #: L6
    jeff_average_skips = diff_round1 / num_rounds
