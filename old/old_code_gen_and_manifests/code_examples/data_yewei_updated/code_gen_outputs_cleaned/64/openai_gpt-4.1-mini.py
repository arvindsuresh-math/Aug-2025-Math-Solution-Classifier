def solve(
    hourly_wage_main: int = 20,  # James earns $20 an hour at his main job
    ...
    #: L2
    hourly_wage_second = hourly_wage_main - wage_reduction
    ...
    #: L5
    earnings_second = hours_second_job * hourly_wage_second
