def solve(
    ...
    """Index: 60.
    Returns: the total number of hours Jerry will spend watching his daughters play and practice altogether.
    """
    #: L1
    ...
    #: L4
    total_hours_watching_practice = hours_watching_one_daughter_practice * num_daughters
