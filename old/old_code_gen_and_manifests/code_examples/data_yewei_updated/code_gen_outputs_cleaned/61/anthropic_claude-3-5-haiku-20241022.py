def solve(
    ...
    acorn_multiplier: int = 2,  # gained twice the berry weight from acorns
    ...
    #: L5
    small_animal_weight = remaining_weight - salmon_weight

    answer = small_animal_weight  # FINAL ANSWER
    return answer