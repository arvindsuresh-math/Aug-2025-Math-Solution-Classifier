def solve(
    ...
    teacher: int = 1, # and his teacher, Mr. Keith.
    slices_per_pie: int = 10, # each of the cookie pies were cut into 10 slices
    people_eating: int = 1 # Manny, his classmates, and Mr. Keith all had 1 piece
):
    """Index: 78.
    ...
    #: L2
    total_people = num_classmates + teacher + people_eating
