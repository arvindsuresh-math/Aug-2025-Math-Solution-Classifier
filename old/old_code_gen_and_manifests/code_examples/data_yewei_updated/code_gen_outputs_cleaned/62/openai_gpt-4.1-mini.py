def solve(
    ...
    """
    #: L1
    total_liters_held_by_10_cans = cans_with_8_liters * liters_per_can_8

    #: L2
    liters_left = total_liters - total_liters_held_by_10_cans

    #: L3
    remaining_cans = total_cans - cans_with_8_liters

    #: L4
    liters_per_remaining_can = liters_left / remaining_cans
