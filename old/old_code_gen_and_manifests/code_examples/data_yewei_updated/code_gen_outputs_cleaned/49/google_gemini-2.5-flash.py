def solve(
        ...
        ben_divisor: int = 3, # Ben got a late start and only collected a third of what Laurie did
    ...
    """
    #: L1
    ben_shells = laurie_shells / ben_divisor

    #: L2
    alan_shells = ben_shells * alan_multiplier

    answer = alan_shells # FINAL ANSWER
    return answer