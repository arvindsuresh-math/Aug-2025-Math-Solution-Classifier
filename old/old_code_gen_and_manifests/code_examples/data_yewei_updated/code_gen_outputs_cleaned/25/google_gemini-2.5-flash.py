def solve(
    ...
    balls_not_hit_first_batch = int(fraction_not_hit_first_batch * first_batch_size)

    #: L2
    fraction_not_hit_second_batch = 1 - fraction_hit_second_batch
    balls_not_hit_second_batch = int(fraction_not_hit_second_batch * second_batch_size)
