def solve(
    ...
    cost_per_hamburger: float = 3.0, # cost $3 each
    ...
    cost_per_spaghetti: float = 2.7, # cost $2.7
    ...
    """
    #: L1
    total_cost_hamburgers = num_hamburgers * cost_per_hamburger
    ...
    #: L4
    total_bill = total_cost_hamburgers + total_cost_fries + total_cost_sodas + num_spaghetti * cost_per_spaghetti
