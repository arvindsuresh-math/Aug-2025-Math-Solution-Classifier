def solve(
    ...
    #: L1
    times_jennifer_added_cans = 9.0 # eval: 9.0 = 9.0

    #: L2
    additional_cans_jennifer = times_jennifer_added_cans * cans_jennifer_per_mark_cans # eval: 54.0 = 9.0 * 6

    #: L3
    total_cans_jennifer = initial_cans_jennifer + additional_cans_jennifer # eval: 94.0 = 40 + 54.0
