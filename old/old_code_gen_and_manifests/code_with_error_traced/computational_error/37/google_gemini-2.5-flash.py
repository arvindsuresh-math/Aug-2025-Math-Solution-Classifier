def solve(
    ...
    #: L2
    cost_total_french_fries = 5.8 # eval: 5.8 = 5.8

    #: L3
    cost_total_soda = cost_soda * num_soda # eval: 2.5 = 0.5 * 5

    #: L4
    total_bill = cost_total_hamburgers + cost_total_french_fries + cost_total_soda + cost_spaghetti_platter # eval: 26.0 = 15 + 5.8 + 2.5 + 2.7

    #: L5
    cost_per_friend = total_bill / num_friends # eval: 5.2 = 26.0 / 5

    #: FA
    answer = cost_per_friend
    return answer # eval: return 5.2
