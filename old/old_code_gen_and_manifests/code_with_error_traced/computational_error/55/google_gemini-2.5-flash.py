def solve(
    ...
    #: L1
    total_flowers = 99 # eval: 99 = 99

    #: L2
    flowers_not_roses = tulips + daisies # eval: 75 = 40 + 35

    #: L3
    percentage_not_roses = (flowers_not_roses / total_flowers) * 100 # eval: 75.75757575757575 = (75 / 99) * 100

    #: FA
    answer = percentage_not_roses
    return answer # eval: return 75.75757575757575
