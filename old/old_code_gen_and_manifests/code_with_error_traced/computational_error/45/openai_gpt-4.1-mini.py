def solve(
    ...
    #: L2
    total_cost_snickers = 25 # eval: 25 = 25

    #: L3
    total_cost_skittles = cost_per_bag_skittles * num_bags_skittles # eval: 35 = 7 * 5

    #: L4
    total_cost = pinata_cost + total_cost_reeses + total_cost_snickers + total_cost_skittles # eval: 109 = 13 + 36 + 25 + 35

    #: FA
    answer = total_cost
    return answer # eval: return 109
