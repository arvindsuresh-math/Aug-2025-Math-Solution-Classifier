def solve(
    ...
    #: L2
    profit_per_dvd = 19.0 # eval: 19.0 = 19.0

    #: L3
    daily_profit = profit_per_dvd * movies_sold_per_day # eval: 9500.0 = 19.0 * 500

    #: L4
    weekly_profit = daily_profit * selling_days_per_week # eval: 47500.0 = 9500.0 * 5

    #: L5
    total_profit_from_sales = weekly_profit * number_of_weeks # eval: 950000.0 = 47500.0 * 20

    #: L6
    net_profit = total_profit_from_sales - movie_creation_cost # eval: 948000.0 = 950000.0 - 2000
