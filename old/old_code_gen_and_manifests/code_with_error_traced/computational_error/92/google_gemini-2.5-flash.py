def solve(
    ...
    #: L3
    bob_daily_savings = 1.0 # eval: 1.0 = 1.0

    #: L4
    bob_yearly_savings = bob_daily_savings * days_in_year # eval: 365.0 = 1.0 * 365

    #: L5
    total_saved = bob_yearly_savings + sally_yearly_savings # eval: 1460.0 = 365.0 + 1095.0

    #: FA
    answer = total_saved
    return answer # eval: return 1460.0
