def solve(
    ...
    #: L3
    bob_daily_savings = 12.0 # eval: 12.0 = 12.0

    #: L4
    bob_yearly_savings = bob_daily_savings * days_in_year # eval: 4380.0 = 12.0 * 365

    #: L5
    total_savings = sally_yearly_savings + bob_yearly_savings # eval: 5475.0 = 1095.0 + 4380.0

    #: FA
    answer = total_savings
    return answer # eval: return 5475.0
