def solve(
    ...
    #: L2
    time_parts1_and_2_minutes = 76 # eval: 76 = 76

    #: L3
    total_assignment_minutes = total_time_hours * 60 # eval: 120 = 2 * 60

    #: L4
    time_part3_minutes = total_assignment_minutes - time_parts1_and_2_minutes # eval: 44 = 120 - 76

    #: FA
    answer = time_part3_minutes
    return answer # eval: return 44
