def solve(
    ...
    #: L2
    spent_on_clothes_without_shoes = shirt_cost + pants_cost + coat_cost + socks_cost + belt_cost # eval: 143 = 30 + 46 + 38 + 11 + 18

    #: L3
    total_spent = 194 # eval: 194 = 194

    #: L4
    shoes_cost = total_spent - spent_on_clothes_without_shoes # eval: 51 = 194 - 143
