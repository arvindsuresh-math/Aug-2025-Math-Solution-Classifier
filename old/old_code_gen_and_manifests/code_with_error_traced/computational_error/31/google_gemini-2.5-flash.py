def solve(
    ...
    #: L3
    total_sales_last_month = 590 # eval: 590 = 590

    #: L4
    sales_this_month = total_sales_last_month * sales_multiplier_this_month # eval: 1180 = 590 * 2

    #: FA
    answer = sales_this_month
    return answer # eval: return 1180
