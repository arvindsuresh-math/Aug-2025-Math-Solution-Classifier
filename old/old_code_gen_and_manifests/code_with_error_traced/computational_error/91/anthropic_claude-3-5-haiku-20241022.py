def solve(
    ...
    #: L1
    total_hours_with_bonus = base_hours + bonus_hours # eval: 10 = 8 + 2

    #: L2
    total_daily_wage_with_bonus = 101 # eval: 101 = 101

    #: L3
    hourly_rate_with_bonus = total_daily_wage_with_bonus / total_hours_with_bonus # eval: 10.1 = 101 / 10
