def solve(
    ...
    #: L5
    total_coins_before_giving = coins_hour_1_total + coins_hour_2_total + coins_hour_3_total + coins_hour_4_total # eval: 125 = 5 + 35 + 35 + 50

    #: L6
    total_coins_after_giving = total_coins_before_giving - coins_given_to_coworker # eval: 110 = 125 - 15
