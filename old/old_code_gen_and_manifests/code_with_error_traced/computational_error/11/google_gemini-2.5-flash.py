def solve(
    ...
    #: L2
    money_from_allowance = 25 # eval: 25 = 25

    #: L3
    money_from_mowing_lawns = lawns_mowed * lawn_mowing_charge # eval: 60 = 4 * 15

    #: L4
    money_from_shoveling_driveways = total_money_saved - money_from_mowing_lawns - money_from_allowance # eval: 25 = 110 - 60 - 25

    #: L5
    num_driveways_shoveled = money_from_shoveling_driveways / driveway_shoveling_charge # eval: 3.5714285714285716 = 25 / 7

    #: FA
    answer = num_driveways_shoveled
    return answer # eval: return 3.5714285714285716
