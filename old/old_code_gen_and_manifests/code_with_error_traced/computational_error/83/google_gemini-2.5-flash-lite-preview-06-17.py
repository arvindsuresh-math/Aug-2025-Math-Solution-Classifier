def solve(
    ...
    #: L3
    zola_blue_hats = 58 # eval: 58 = 58

    #: L4
    zola_total_hats = zola_red_hats + zola_blue_hats # eval: 74.0 = 16.0 + 58

    #: L5
    combined_hats = paityn_total_hats + zola_total_hats # eval: 118.0 = 44 + 74.0
