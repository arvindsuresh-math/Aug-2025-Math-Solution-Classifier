def solve(
    ...
    #: L3
    jesse_avg_last_three_days = 5.0 # eval: 5.0 = 5.0
    ...
    #: L7
    total_miles_per_day = jesse_avg_last_three_days + mia_avg_last_three_days # eval: 11.0 = 5.0 + 6.0

    #: L8
    average_miles_per_day = total_miles_per_day / 2 # eval: 5.5 = 11.0 / 2

    #: FA
    answer = average_miles_per_day
    return answer # eval: return 5.5
