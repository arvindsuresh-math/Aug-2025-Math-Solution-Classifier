def solve(
    ...
    #: L3
    jesse_avg_final_three_days = 7.0 # eval: 7.0 = 7.0
    ...
    #: L7
    total_avg_both = jesse_avg_final_three_days + mia_avg_final_three_days # eval: 13.0 = 7.0 + 6.0

    #: L8
    average_of_their_averages = total_avg_both / 2 # eval: 6.5 = 13.0 / 2
