def solve(
    ...
    #: L1
    oil_in_specific_cans = 79 # eval: 79 = 79

    #: L2
    remaining_oil_liters = total_oil_liters - oil_in_specific_cans # eval: 211 = 290 - 79

    #: L3
    remaining_cans = total_cans - num_cans_with_specific_capacity # eval: 14 = 24 - 10

    #: L4
    oil_per_remaining_can = remaining_oil_liters / remaining_cans # eval: 15.071428571428571 = 211 / 14

    #: FA
    answer = oil_per_remaining_can
    return answer # eval: return 15.071428571428571
