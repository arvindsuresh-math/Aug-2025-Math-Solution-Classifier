def solve(
    ...
    #: L3
    green_john_took = 2 # eval: 2 = 2

    #: L4
    remaining_green_after_john = initial_green_hard_hats - green_john_took # eval: 13 = 15 - 2

    #: L5
    total_pink_green_remaining = remaining_green_after_john + remaining_pink_after_john # eval: 29 = 13 + 16

    #: L6
    total_remaining_hard_hats = total_pink_green_remaining + initial_yellow_hard_hats # eval: 53 = 29 + 24
