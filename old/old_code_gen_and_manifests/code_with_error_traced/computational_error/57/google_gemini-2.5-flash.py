def solve(
    ...
    #: L3
    butter_used_chocolate_peanut = 8.0 # eval: 8.0 = 8.0

    #: L4
    remaining_butter_after_two_types = total_butter_kg - butter_used_chocolate_peanut # eval: 2.0 = 10 - 8.0

    #: L5
    butter_for_sugar_cookies = remaining_butter_after_two_types / 3 # eval: 0.6666666666666666 = 2.0 / 3

    #: L6
    butter_left_final = remaining_butter_after_two_types - butter_for_sugar_cookies # eval: 1.3333333333333335 = 2.0 - 0.6666666666666666

    #: FA
    answer = butter_left_final
    return answer # eval: return 1.3333333333333335
