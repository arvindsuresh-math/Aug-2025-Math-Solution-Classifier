def solve(
    ...
    #: L1
    violin_practice_time = 70 # eval: 70 = 70

    #: L2
    total_daily_practice = violin_practice_time + piano_practice_time # eval: 90 = 70 + 20

    #: L3
    total_weekly_practice = total_daily_practice * practice_days_per_week # eval: 540 = 90 * 6

    #: L4
    total_monthly_practice = total_weekly_practice * weeks_in_month # eval: 2160 = 540 * 4

    #: FA
    answer = total_monthly_practice
    return answer # eval: return 2160
