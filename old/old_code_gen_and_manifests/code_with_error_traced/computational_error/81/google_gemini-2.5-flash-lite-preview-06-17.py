def solve(
    ...
    #: L3
    jeff_round3 = sam_skips_per_round + round3_diff # eval: 20 = 16 + 4

    #: L4
    jeff_round4 = 18.0 # eval: 18.0 = 18.0

    #: L5
    jeff_total_skips = jeff_round1 + jeff_round2 + jeff_round3 + jeff_round4 # eval: 66.0 = 15 + 13 + 20 + 18.0

    #: L6
    jeff_avg_skips = jeff_total_skips / 4 # eval: 16.5 = 66.0 / 4

    #: FA
    answer = jeff_avg_skips
    return answer # eval: return 16.5
