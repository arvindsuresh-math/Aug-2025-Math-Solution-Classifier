def solve(
    ...
    #: L1
    jeff_skips_round1 = 16 # eval: 16 = 16
    ...
    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4 # eval: 57.0 = 16 + 13 + 20 + 8.0

    #: L6
    average_jeff_skips = total_jeff_skips / rounds # eval: 14.25 = 57.0 / 4
