def solve(
    ...
    #: L1
    overtime_hours = 9 # eval: 9 = 9

    #: L2
    overtime_pay = overtime_hours * overtime_rate # eval: 180 = 9 * 20

    #: L3
    total_income = base_income + overtime_pay # eval: 680 = 500 + 180

    #: FA
    answer = total_income
    return answer # eval: return 680
