def solve(
    ...
    #: L3
    total_missed_balls = first_batch_hit_fraction + next_batch_missed_balls # eval: 50.400000000000006 = 0.4 + 50.00000000000001

    #: FA
    answer = total_missed_balls
    return answer # eval: return 50.400000000000006
