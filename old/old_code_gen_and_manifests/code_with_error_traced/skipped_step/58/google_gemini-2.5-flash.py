def solve(
    ...
    #: L5
    total_daily_amount = fraction_students_group1 + sum_allowance_group2 # eval: 80.66666666666667 = 0.6666666666666666 + 80.0

    #: FA
    answer = total_daily_amount
    return answer # eval: return 80.66666666666667
