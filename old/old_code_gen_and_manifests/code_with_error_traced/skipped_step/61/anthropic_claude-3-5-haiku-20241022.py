def solve(
    ...
    #: L3
    remaining_weight = total_weight_needed - berry_weight - salmon_fraction # eval: 799.5 = 1000 - 200.0 - 0.5

    #: L4
    salmon_weight = remaining_weight * salmon_fraction # eval: 399.75 = 799.5 * 0.5

    #: L5
    small_animals_weight = remaining_weight - salmon_weight # eval: 399.75 = 799.5 - 399.75
