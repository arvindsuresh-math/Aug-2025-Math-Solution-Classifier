def solve(
    ...
    #: L3
    remaining_pages = book_pages - fraction_remaining_to_read_tomorrow # eval: 119.5 = 120 - 0.5

    #: L4
    pages_to_read_tomorrow = remaining_pages * fraction_remaining_to_read_tomorrow # eval: 59.75 = 119.5 * 0.5

    #: FA
    answer = pages_to_read_tomorrow
    return answer # eval: return 59.75
