def solve(
    ...
    #: L2
    gumballs_to_bobby = (gumballs_remaining * 4) - 5 # eval: 19 = (6 * 4) - 5

    #: L3
    total_gumballs_purchased = gumballs_to_todd + gumballs_remaining + gumballs_to_bobby + gumballs_remaining # eval: 35 = 4 + 6 + 19 + 6
