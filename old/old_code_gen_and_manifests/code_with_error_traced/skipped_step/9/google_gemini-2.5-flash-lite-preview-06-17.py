def solve(
    ...
    #: L6
    overtime_pay_per_day = overtime_hourly_rate * hourly_wage # eval: 486.0 = 27.0 * 18.0

    #: L7
    overtime_pay_total = overtime_pay_per_day * days_worked # eval: 2430.0 = 486.0 * 5

    #: L8
    total_earnings = regular_pay_total + overtime_pay_total # eval: 3150.0 = 720.0 + 2430.0

    #: FA
    answer = total_earnings
    return answer # eval: return 3150.0
