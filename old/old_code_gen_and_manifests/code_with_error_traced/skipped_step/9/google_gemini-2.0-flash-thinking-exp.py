def solve(
    ...
    #: L6
    overtime_pay_per_day = overtime_multiplier_fraction * overtime_hours_per_day # eval: 1.0 = 0.5 * 2

    #: L7
    total_overtime_pay = overtime_pay_per_day * num_days # eval: 5.0 = 1.0 * 5

    #: L8
    total_pay = total_base_pay + total_overtime_pay # eval: 725.0 = 720.0 + 5.0

    #: FA
    answer = total_pay
    return answer # eval: return 725.0
