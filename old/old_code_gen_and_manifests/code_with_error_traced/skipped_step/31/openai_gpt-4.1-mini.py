def solve(
    ...
    #: L3
    total_sales_last_month = sold_small_last_month + sales_small_last_month # eval: 124 = 4 + 120

    #: L4
    total_sales_this_month = total_sales_last_month * multiplier_this_month # eval: 248 = 124 * 2
