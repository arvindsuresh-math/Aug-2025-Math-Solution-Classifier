def solve(
    ...
    #: L4
    total_cost_discounted_tickets = cost_per_discounted_ticket * discount_threshold # eval: 380.0 = 38.0 * 10

    #: L5
    total_cost_full_price_tickets = ticket_cost * discount_threshold # eval: 400 = 40 * 10

    #: L6
    total_paid = total_cost_full_price_tickets + total_cost_discounted_tickets # eval: 780.0 = 400 + 380.0
