def solve(
    ...
    #: L4
    hours_watching_both_daughters_practice = num_daughters * num_daughters # eval: 4 = 2 * 2

    #: L5
    total_hours_at_field = hours_watching_both_daughters_games + hours_watching_both_daughters_practice # eval: 36 = 32 + 4
