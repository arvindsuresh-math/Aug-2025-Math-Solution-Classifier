def solve(
    ...
    #: L5
    total_paid_4_months = monthly_installment_rate_stated * months_paid # eval: 260 = 65 * 4

    #: L6
    final_balance = remaining_balance_initial - total_paid_4_months # eval: 520.0 = 780.0 - 260
