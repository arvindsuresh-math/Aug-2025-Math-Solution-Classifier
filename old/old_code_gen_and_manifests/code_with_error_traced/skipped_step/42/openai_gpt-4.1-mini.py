def solve(
    ...
    #: L3
    bananas_in_remaining_piles = piles_with_9_hands * hands_in_remaining_piles * bananas_per_hand_12hands # eval: 648 = 6 * 12 * 9

    #: L4
    total_bananas = bananas_in_6_piles + bananas_in_remaining_piles # eval: 1404 = 756 + 648

    #: L5
    bananas_per_monkey = total_bananas / num_monkeys # eval: 117.0 = 1404 / 12

    #: FA
    answer = bananas_per_monkey
    return answer # eval: return 117.0
