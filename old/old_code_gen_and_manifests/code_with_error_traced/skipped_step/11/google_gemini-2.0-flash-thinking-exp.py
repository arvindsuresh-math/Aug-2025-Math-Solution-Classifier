def solve(
    ...
    #: L4
    shoveling_earnings = change_left - lawn_mowing_earnings - allowance_saved # eval: -60 = 15 - 60 - 15

    #: L5
    driveways_shoveled = shoveling_earnings / shoveling_charge # eval: -8.571428571428571 = -60 / 7

    #: FA
    answer = driveways_shoveled
    return answer # eval: return -8.571428571428571
