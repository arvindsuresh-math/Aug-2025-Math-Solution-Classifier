def solve(
    ...
    #: L4
    valuable_files_second_round = additional_files_downloaded - non_valuable_files_second_round # eval: 160.0 = 400 - 240.0

    #: L5
    total_valuable_files = percentage_deleted_first_round + valuable_files_second_round # eval: 160.7 = 0.7 + 160.0

    #: FA
    answer = total_valuable_files
    return answer # eval: return 160.7
