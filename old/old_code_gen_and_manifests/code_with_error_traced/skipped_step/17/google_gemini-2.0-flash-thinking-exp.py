def solve(
    ...
    #: L5
    total_pink_green_remaining = john_takes_green_multiplier + remaining_pink_after_john # eval: 18 = 2 + 16

    #: L6
    total_remaining_hard_hats = total_pink_green_remaining + initial_yellow_hard_hats # eval: 42 = 18 + 24
