def solve(
    ...
    #: L1
    ben_shells = laurie_shells - ben_shell_fraction # eval: 35.666666666666664 = 36 - 0.3333333333333333

    #: L2
    alan_shells = ben_shells * alan_shell_multiplier # eval: 142.66666666666666 = 35.666666666666664 * 4

    #: FA
    answer = alan_shells
    return answer # eval: return 142.66666666666666
