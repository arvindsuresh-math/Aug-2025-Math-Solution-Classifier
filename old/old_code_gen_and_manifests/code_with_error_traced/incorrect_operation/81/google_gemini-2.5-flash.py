def solve(
    ...
    #: L4
    jeff_skips_round4 = sam_skips_round1 - jeff_skips_factor_round4 # eval: 15.5 = 16 - 0.5

    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4 # eval: 63.5 = 15 + 13 + 20 + 15.5

    #: L6
    average_jeff_skips_per_round = total_jeff_skips / num_rounds # eval: 15.875 = 63.5 / 4

    #: FA
    answer = average_jeff_skips_per_round
    return answer # eval: return 15.875
