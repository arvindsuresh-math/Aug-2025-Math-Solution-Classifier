def solve(
    ...
    #: L3
    multiplier_third_ship = twice_as_many - twice_as_many # eval: 0 = 2 - 2

    #: L4
    total_factor = 1 + twice_as_many + multiplier_third_ship # eval: 3 = 1 + 2 + 0

    #: L5
    people_first_ship = total_people_consumed / total_factor # eval: 282.3333333333333 = 847 / 3
