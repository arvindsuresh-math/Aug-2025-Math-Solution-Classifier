def solve(
    ...
    #: L2
    hours_watching_both_daughters_games = hours_watching_one_daughter_games + num_daughters # eval: 18 = 16 + 2
    ...
    #: L5
    total_hours_at_field = hours_watching_both_daughters_games + hours_watching_both_daughters_practice # eval: 82 = 18 + 64

    #: FA
    answer = total_hours_at_field
    return answer # eval: return 82
