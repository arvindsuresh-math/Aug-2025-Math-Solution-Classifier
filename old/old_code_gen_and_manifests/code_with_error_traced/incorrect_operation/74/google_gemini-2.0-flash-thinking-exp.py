def solve(
    ...
    #: L1
    weight_lost_person2 = weight_lost_person1 + weight_diff_person2 # eval: 34 = 27 + 7

    #: L2
    weight_lost_remaining = total_weight_lost - weight_lost_person1 - weight_lost_person2 # eval: 42 = 103 - 27 - 34

    #: L3
    weight_lost_each_remaining = weight_lost_remaining / num_remaining_people # eval: 21.0 = 42 / 2
