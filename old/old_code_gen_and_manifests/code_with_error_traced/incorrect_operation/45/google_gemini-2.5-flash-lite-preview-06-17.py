def solve(
    ...
    #: L1
    cost_reeses = num_bags_reeses - cost_per_bag_reeses # eval: -5 = 4 - 9
    ...
    #: L4
    total_cost = cost_pinata + cost_reeses + cost_snickers + cost_skittles # eval: 58 = 13 + -5 + 15 + 35

    #: FA
    answer = total_cost
    return answer # eval: return 58
