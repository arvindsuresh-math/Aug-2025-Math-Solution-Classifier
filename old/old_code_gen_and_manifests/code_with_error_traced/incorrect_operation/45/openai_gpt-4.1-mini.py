def solve(
    ...
    #: L1
    total_cost_reeses = cost_per_bag_reeses + num_bags_reeses # eval: 13 = 9 + 4
    ...
    #: L4
    total_cost = pinata_cost + total_cost_reeses + total_cost_snickers + total_cost_skittles # eval: 76 = 13 + 13 + 15 + 35
