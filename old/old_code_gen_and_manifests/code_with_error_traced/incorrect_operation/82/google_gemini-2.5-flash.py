def solve(
    ...
    #: L2
    overtime_earnings = overtime_hours - overtime_rate_per_hour # eval: -10 = 10 - 20

    #: L3
    total_income = base_income + overtime_earnings # eval: 490 = 500 + -10

    #: FA
    answer = total_income
    return answer # eval: return 490
