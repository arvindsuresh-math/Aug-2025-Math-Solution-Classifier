def solve(
    ...
    #: L3
    fourth_earthquake_collapses = third_earthquake_collapses + multiplier # eval: 18 = 16 + 2

    #: L4
    total_collapses = initial_collapses + second_earthquake_collapses + third_earthquake_collapses + fourth_earthquake_collapses # eval: 46 = 4 + 8 + 16 + 18
