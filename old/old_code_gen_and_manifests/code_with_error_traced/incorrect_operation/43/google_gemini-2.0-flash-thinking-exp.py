def solve(
    ...
    #: L3
    collapsed_earthquake_4 = collapsed_earthquake_3 + collapse_multiplier # eval: 18 = 16 + 2

    #: L4
    total_collapsed_buildings = initial_collapsed_buildings + collapsed_earthquake_2 + collapsed_earthquake_3 + collapsed_earthquake_4 # eval: 46 = 4 + 8 + 16 + 18
