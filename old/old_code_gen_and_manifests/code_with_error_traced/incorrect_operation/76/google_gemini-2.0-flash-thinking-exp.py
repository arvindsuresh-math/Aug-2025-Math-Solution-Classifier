def solve(
    ...
    #: L1
    num_cucumbers = num_potatoes + fewer_cucumbers_than_potatoes # eval: 297 = 237 + 60

    #: L2
    num_peppers = num_cucumbers * pepper_multiplier # eval: 594 = 297 * 2

    #: L3
    total_vegetables = num_potatoes + num_cucumbers + num_peppers # eval: 1128 = 237 + 297 + 594

    #: FA
    answer = total_vegetables
    return answer # eval: return 1128
