def solve(
    ...
    #: L1
    total_pages_to_write = num_books - pages_per_book # eval: -397 = 3 - 400

    #: L2
    days_to_write = total_pages_to_write / pages_per_day # eval: -19.85 = -397 / 20

    #: FA
    answer = days_to_write
    return answer # eval: return -19.85
