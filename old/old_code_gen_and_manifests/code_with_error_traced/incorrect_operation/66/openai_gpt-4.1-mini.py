def solve(
    ...
    #: L5
    total_paid_4_months = monthly_payment - months_paid # eval: 61.0 = 65.0 - 4

    #: L6
    balance_after_4_months = remaining_balance - total_paid_4_months # eval: 719.0 = 780.0 - 61.0

    #: FA
    answer = balance_after_4_months
    return answer # eval: return 719.0
