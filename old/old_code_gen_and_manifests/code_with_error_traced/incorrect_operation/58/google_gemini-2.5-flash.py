def solve(
    ...
    #: L2
    num_students_group2 = total_students + num_students_group1 # eval: 100.0 = 60 + 40.0

    #: L3
    sum_allowance_group1 = num_students_group1 * allowance_group1 # eval: 240.0 = 40.0 * 6

    #: L4
    sum_allowance_group2 = num_students_group2 * allowance_group2 # eval: 400.0 = 100.0 * 4

    #: L5
    total_daily_amount = sum_allowance_group1 + sum_allowance_group2 # eval: 640.0 = 240.0 + 400.0
