def solve(
    ...
    #: L1
    time_part2_minutes = time_part1_minutes + time_multiplier_part2 # eval: 27 = 25 + 2

    #: L2
    time_parts1_and_2_minutes = time_part1_minutes + time_part2_minutes # eval: 52 = 25 + 27

    #: L3
    total_assignment_minutes = total_time_hours * 60 # eval: 120 = 2 * 60

    #: L4
    time_part3_minutes = total_assignment_minutes - time_parts1_and_2_minutes # eval: 68 = 120 - 52
