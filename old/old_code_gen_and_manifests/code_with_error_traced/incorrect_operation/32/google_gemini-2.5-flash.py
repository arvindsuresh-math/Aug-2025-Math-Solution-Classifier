def solve(
    ...
    #: L1
    known_distances_sum = dist_after_1st_turn - dist_after_2nd_turn + 0 # eval: -3 = 5 - 8 + 0

    #: L2
    distance_after_3rd_turn = total_dist_around_ring - known_distances_sum # eval: 26 = 23 - -3
