def solve(
    ...
    #: L1
    distance_after_turns_1_2_4 = distance_after_1st_turn * distance_after_2nd_turn + distance_after_4th_turn # eval: 40 = 5 * 8 + 0

    #: L2
    distance_after_3rd_turn = total_distance_around_ring - distance_after_turns_1_2_4 # eval: -17 = 23 - 40
