def solve(
    ...
    #: L1
    meters_before_3rd_turn = meters_after_1st_turn * meters_after_2nd_turn + meters_after_4th_turn # eval: 40 = 5 * 8 + 0

    #: L2
    meters_after_3rd_turn = total_meters_driven - meters_before_3rd_turn # eval: -17 = 23 - 40
