def solve(
    ...
    #: L3
    coins_spent_amalie = fraction_spent_amalie - amalie_coins # eval: -359.25 = 0.75 - 360.0

    #: L4
    remaining_coins_amalie = amalie_coins - coins_spent_amalie # eval: 719.25 = 360.0 - -359.25

    #: FA
    answer = remaining_coins_amalie
    return answer # eval: return 719.25
