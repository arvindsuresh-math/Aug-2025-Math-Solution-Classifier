def solve(
    ...
    #: L1
    bananas_type1 = piles_type1 + hands_per_pile_type1 * bananas_per_hand_type1 # eval: 132 = 6 + 9 * 14
    ...
    #: L4
    total_bananas = bananas_type1 + bananas_type2 # eval: 564 = 132 + 432

    #: L5
    bananas_per_monkey = total_bananas / num_monkeys # eval: 47.0 = 564 / 12
