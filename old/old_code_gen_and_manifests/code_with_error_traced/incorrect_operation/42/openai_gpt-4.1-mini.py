def solve(
    ...
    #: L3
    bananas_in_remaining_piles = remaining_piles + hands_in_remaining_piles * bananas_per_hand_12hands # eval: 112 = 4 + 12 * 9

    #: L4
    total_bananas = bananas_in_6_piles + bananas_in_remaining_piles # eval: 868 = 756 + 112

    #: L5
    bananas_per_monkey = total_bananas / num_monkeys # eval: 72.33333333333333 = 868 / 12

    #: FA
    answer = bananas_per_monkey
    return answer # eval: return 72.33333333333333
