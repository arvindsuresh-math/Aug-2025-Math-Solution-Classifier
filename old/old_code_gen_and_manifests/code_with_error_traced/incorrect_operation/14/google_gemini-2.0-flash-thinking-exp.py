def solve(
    ...
    #: L2
    pages_per_hour = pages_read_in_time + intervals_in_hour # eval: 11.0 = 8 + 3.0

    #: L3
    time_needed_hours = total_pages_to_read / pages_per_hour # eval: 10.909090909090908 = 120 / 11.0
