def solve(
    ...
    #: L2
    pages_per_hour = pages_per_segment + sets_of_minutes_in_hour # eval: 11.0 = 8 + 3.0

    #: L3
    hours_to_read_target_pages = target_pages / pages_per_hour # eval: 10.909090909090908 = 120 / 11.0
