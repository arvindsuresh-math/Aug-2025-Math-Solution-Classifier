def solve(
    ...
    #: L2
    jesse_remaining_miles = total_race_miles + jesse_day_four_miles - jesse_miles_first_three_days # eval: 38.0 = 30 + 10 - 2.0

    #: L3
    jesse_avg_final_three_days = jesse_remaining_miles / num_final_days # eval: 12.666666666666666 = 38.0 / 3
    ...
    #: L7
    total_avg_both = jesse_avg_final_three_days + mia_avg_final_three_days # eval: 18.666666666666664 = 12.666666666666666 + 6.0

    #: L8
    average_of_their_averages = total_avg_both / 2 # eval: 9.333333333333332 = 18.666666666666664 / 2

    #: FA
    answer = average_of_their_averages
    return answer # eval: return 9.333333333333332
