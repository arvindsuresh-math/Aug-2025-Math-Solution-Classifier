def solve(
    ...
    #: L2
    jesse_miles_remaining = total_miles + jesse_day_4_miles - jesse_miles_first_3_days # eval: 38.0 = 30 + 10 - 2.0

    #: L3
    jesse_avg_last_3_days = jesse_miles_remaining / 3 # eval: 12.666666666666666 = 38.0 / 3
    ...
    #: L7
    total_avg_last_3_days = jesse_avg_last_3_days + mia_avg_last_3_days # eval: 18.666666666666664 = 12.666666666666666 + 6.0

    #: L8
    average_of_averages = total_avg_last_3_days / 2 # eval: 9.333333333333332 = 18.666666666666664 / 2
