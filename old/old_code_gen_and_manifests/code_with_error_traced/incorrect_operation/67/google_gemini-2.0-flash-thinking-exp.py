def solve(
    ...
    #: L1
    jesse_distance_initial = jesse_initial_days - jesse_initial_avg_distance # eval: 2.3333333333333335 = 3 - 0.6666666666666666

    #: L2
    jesse_remaining_distance = total_distance - jesse_day_four_distance - jesse_distance_initial # eval: 17.666666666666668 = 30 - 10 - 2.3333333333333335

    #: L3
    jesse_avg_final_days = jesse_remaining_distance / final_days # eval: 5.888888888888889 = 17.666666666666668 / 3
    ...
    #: L7
    total_avg_final_days = jesse_avg_final_days + mia_avg_final_days # eval: 11.88888888888889 = 5.888888888888889 + 6.0

    #: L8
    average_of_their_averages = total_avg_final_days / 2 # eval: 5.944444444444445 = 11.88888888888889 / 2

    #: FA
    answer = average_of_their_averages
    return answer # eval: return 5.944444444444445
