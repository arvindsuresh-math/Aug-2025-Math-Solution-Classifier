def solve(
    ...
    #: L7
    total_avg_last_three_days = jesse_avg_last_three_days - mia_avg_last_three_days # eval: 0.0 = 6.0 - 6.0

    #: L8
    average_of_averages = total_avg_last_three_days / 2 # eval: 0.0 = 0.0 / 2
