def solve(
    ...
    #: L2
    living_room_fabric_area = living_room_length + living_room_width # eval: 10 = 4 + 6

    #: L3
    bedroom_fabric_area = bedroom_length * bedroom_width # eval: 8 = 2 * 4

    #: L4
    fabric_left = total_fabric_area - living_room_fabric_area - bedroom_fabric_area # eval: 174 = 192 - 10 - 8
