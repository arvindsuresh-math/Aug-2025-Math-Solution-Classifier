def solve(
    ...
    #: L1
    total_supplies_cost = monthly_supplies_cost + season_length_months # eval: 104 = 100 + 4

    #: L2
    months_to_save = total_months_in_year - season_length_months # eval: 8 = 12 - 4

    #: L3
    monthly_savings_needed = total_supplies_cost / months_to_save # eval: 13.0 = 104 / 8

    #: L4
    chores_per_month = monthly_savings_needed / chore_charge # eval: 1.3 = 13.0 / 10
