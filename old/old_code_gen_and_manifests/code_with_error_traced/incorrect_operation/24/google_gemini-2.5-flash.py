def solve(
    ...
    #: L1
    total_paid_so_far = payment_tuesday * payment_thursday # eval: 345 = 15 * 23

    #: L2
    remaining_credit_to_pay = credit_limit - total_paid_so_far # eval: -245 = 100 - 345

    #: FA
    answer = remaining_credit_to_pay
    return answer # eval: return -245
