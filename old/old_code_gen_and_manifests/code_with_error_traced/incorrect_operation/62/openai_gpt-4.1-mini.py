def solve(
    ...
    #: L1
    total_liters_in_10_cans = cans_with_8_liters + liters_per_can_8_liters # eval: 18 = 10 + 8

    #: L2
    remaining_liters = total_liters - total_liters_in_10_cans # eval: 272 = 290 - 18

    #: L3
    remaining_cans = total_cans - cans_with_8_liters # eval: 14 = 24 - 10

    #: L4
    liters_per_remaining_can = remaining_liters / remaining_cans # eval: 19.428571428571427 = 272 / 14
