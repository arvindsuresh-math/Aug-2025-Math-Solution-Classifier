def solve(
    ...
    #: L2
    remaining_liters = total_liters + liters_in_8_liter_cans # eval: 370 = 290 + 80

    #: L3
    remaining_cans = total_cans - num_cans_with_8_liters # eval: 14 = 24 - 10

    #: L4
    liters_per_remaining_can = remaining_liters / remaining_cans # eval: 26.428571428571427 = 370 / 14

    #: FA
    answer = liters_per_remaining_can
    return answer # eval: return 26.428571428571427
