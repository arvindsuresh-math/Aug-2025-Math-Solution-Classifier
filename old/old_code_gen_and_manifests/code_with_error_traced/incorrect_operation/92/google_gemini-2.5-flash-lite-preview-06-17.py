def solve(
    ...
    #: L1
    sally_saved_per_day = sally_daily_wage + fraction_saved # eval: 6.5 = 6 + 0.5

    #: L2
    sally_total_saved = sally_saved_per_day * days_in_year # eval: 2372.5 = 6.5 * 365
    ...
    #: L5
    total_saved = sally_total_saved + bob_total_saved # eval: 3102.5 = 2372.5 + 730.0
