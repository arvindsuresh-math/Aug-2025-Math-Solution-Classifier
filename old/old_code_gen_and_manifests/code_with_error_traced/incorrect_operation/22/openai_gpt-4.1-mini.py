def solve(
    ...
    #: L1
    bobbies_last_name_length = jamies_last_name_length + 2 + letters_removed_from_bobbie # eval: 8 = 4 + 2 + 2

    #: L2
    samanthas_last_name_length = bobbies_last_name_length - difference_samantha_bobbie # eval: 5 = 8 - 3
