def solve(
    ...
    #: L3
    discounted_ticket_price = ticket_price + discount_per_ticket # eval: 42.0 = 40 + 2.0

    #: L4
    total_discounted_tickets_cost = discounted_ticket_price * discounted_tickets # eval: 84.0 = 42.0 * 2
    ...
    #: L6
    total_cost = total_full_price_tickets_cost + total_discounted_tickets_cost # eval: 484.0 = 400 + 84.0

    #: FA
    answer = total_cost
    return answer # eval: return 484.0
