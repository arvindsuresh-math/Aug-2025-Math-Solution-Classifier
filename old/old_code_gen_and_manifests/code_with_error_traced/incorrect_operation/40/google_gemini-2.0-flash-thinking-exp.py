def solve(
    ...
    #: L4
    total_cost_discounted_tickets = cost_per_discounted_ticket + num_discounted_tickets # eval: 40.0 = 38.0 + 2
    ...
    #: L6
    total_paid = total_cost_full_price_tickets + total_cost_discounted_tickets # eval: 440.0 = 400 + 40.0

    #: FA
    answer = total_paid
    return answer # eval: return 440.0
