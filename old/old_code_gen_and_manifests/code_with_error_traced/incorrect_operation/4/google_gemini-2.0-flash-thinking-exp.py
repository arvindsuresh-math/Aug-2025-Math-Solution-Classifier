def solve(
    ...
    #: L2
    total_pages_per_week = pages_per_friend_per_week + num_friends # eval: 8 = 6 + 2

    #: L3
    total_pages_per_year = total_pages_per_week * weeks_per_year # eval: 416 = 8 * 52

    #: FA
    answer = total_pages_per_year
    return answer # eval: return 416
