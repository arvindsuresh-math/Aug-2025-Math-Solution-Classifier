def solve(
    ...
    #: L1
    initial_money = wallet_cost + fraction_money_has # eval: 100.5 = 100 + 0.5

    #: L2
    grandparents_gift = parents_gift * grandparents_gift_multiplier # eval: 30 = 15 * 2

    #: L3
    money_needed = wallet_cost - initial_money - parents_gift - grandparents_gift # eval: -45.5 = 100 - 100.5 - 15 - 30

    #: FA
    answer = money_needed
    return answer # eval: return -45.5
