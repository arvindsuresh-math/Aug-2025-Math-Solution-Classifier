def solve(
    ...
    #: L4
    first_tank_fish_after_eating = first_tank_fish_count + 1 # eval: 17.0 = 16.0 + 1

    #: L5
    fish_difference = first_tank_fish_after_eating - second_tank_fish_count # eval: 5.0 = 17.0 - 12.0
