def solve(
    ...
    #: L2
    weight_from_acorns = weight_from_berries - acorns_multiplier # eval: 198.0 = 200.0 - 2

    #: L3
    remaining_weight_needed = total_weight_needed - weight_from_berries - weight_from_acorns # eval: 602.0 = 1000 - 200.0 - 198.0

    #: L4
    weight_from_salmon = remaining_weight_needed * salmon_fraction_of_remaining # eval: 301.0 = 602.0 * 0.5

    #: L5
    weight_from_small_animals = remaining_weight_needed - weight_from_salmon # eval: 301.0 = 602.0 - 301.0

    #: FA
    answer = weight_from_small_animals
    return answer # eval: return 301.0
