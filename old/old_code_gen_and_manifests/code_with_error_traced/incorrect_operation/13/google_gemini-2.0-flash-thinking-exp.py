def solve(
    ...
    #: L1
    cream_cheese_cost = cheddar_cost + cream_cheese_cost_factor # eval: 10.5 = 10 + 0.5

    #: L2
    cold_cuts_cost = cheddar_cost * cold_cuts_cost_factor # eval: 20 = 10 * 2

    #: L3
    total_cost = cheddar_cost + cream_cheese_cost + cold_cuts_cost # eval: 40.5 = 10 + 10.5 + 20

    #: FA
    answer = total_cost
    return answer # eval: return 40.5
