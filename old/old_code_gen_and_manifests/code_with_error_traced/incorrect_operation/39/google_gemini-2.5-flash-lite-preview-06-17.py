def solve(
    ...
    #: L2
    billy_total_candy = billy_candy_per_house - billy_houses # eval: -64 = 11 - 75

    #: L3
    difference_in_candy = anna_total_candy - billy_total_candy # eval: 904 = 840 - -64

    #: FA
    answer = difference_in_candy
    return answer # eval: return 904
