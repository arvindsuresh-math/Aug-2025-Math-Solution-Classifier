def solve(
    ...
    #: L1
    gnomes_in_first_four_houses = num_houses_with_3_gnomes - gnomes_per_house # eval: 1 = 4 - 3

    #: L2
    gnomes_in_fifth_house = total_gnomes - gnomes_in_first_four_houses # eval: 19 = 20 - 1
