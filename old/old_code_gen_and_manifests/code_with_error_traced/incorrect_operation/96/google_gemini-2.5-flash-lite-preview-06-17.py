def solve(
    ...
    #: L1
    total_inches_rain = inches_monday - inches_tuesday # eval: 1 = 4 - 3

    #: L2
    total_gallons_collected = total_inches_rain * gallons_per_inch # eval: 15 = 1 * 15

    #: L3
    total_money_made = total_gallons_collected * price_per_gallon # eval: 18.0 = 15 * 1.2

    #: FA
    answer = total_money_made
    return answer # eval: return 18.0
