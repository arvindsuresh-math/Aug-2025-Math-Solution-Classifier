def solve(
    ...
    #: L1
    pencils_shared_with_friends = num_friends - pencils_per_friend # eval: -3 = 5 - 8

    #: L2
    total_pencils_arnel_had = pencils_kept + pencils_shared_with_friends # eval: 7 = 10 + -3

    #: L3
    pencils_per_box = total_pencils_arnel_had / num_boxes # eval: 0.7 = 7 / 10

    #: FA
    answer = pencils_per_box
    return answer # eval: return 0.7
