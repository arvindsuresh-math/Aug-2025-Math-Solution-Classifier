def solve(
    ...
    balls_not_hit_first_set = fraction_not_hit_first_set - first_set_balls # eval: -99.4 = 0.6 - 100
    ...
    #: L3
    total_balls_not_hit = balls_not_hit_first_set + balls_not_hit_second_set # eval: -49.4 = -99.4 + 50.00000000000001
