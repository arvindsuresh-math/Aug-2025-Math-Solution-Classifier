def solve(
    ...
    #: L2
    next_batch_missed_balls = (1 + next_batch_hit_fraction) * next_batch_balls # eval: 100.0 = (1 + 0.3333333333333333) * 75

    #: L3
    total_missed_balls = first_batch_missed_balls + next_batch_missed_balls # eval: 160.0 = 60.0 + 100.0

    #: FA
    answer = total_missed_balls
    return answer # eval: return 160.0
