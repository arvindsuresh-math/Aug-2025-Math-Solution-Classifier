def solve(
    ...
    first_batch_not_hit_count = first_batch_not_hit_fraction - first_batch_count # eval: -99.4 = 0.6 - 100
    ...
    #: L3
    total_not_hit = first_batch_not_hit_count + second_batch_not_hit_count # eval: -49.4 = -99.4 + 50.00000000000001

    #: FA
    answer = total_not_hit
    return answer # eval: return -49.4
