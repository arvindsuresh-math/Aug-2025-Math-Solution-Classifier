def solve(
    ...
    #: L2
    money_left_after_milkshake = initial_earnings + milkshake_cost # eval: 32.0 = 28 + 4.0

    #: L3
    money_in_wallet = money_left_after_milkshake * savings_fraction # eval: 16.0 = 32.0 * 0.5

    #: L4
    money_lost = money_in_wallet - money_left_after_shredding # eval: 15.0 = 16.0 - 1
