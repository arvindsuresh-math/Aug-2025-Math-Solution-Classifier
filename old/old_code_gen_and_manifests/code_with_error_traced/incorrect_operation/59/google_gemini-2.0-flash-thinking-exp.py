def solve(
    ...
    #: L5
    total_collected_before_giving = coins_hour_1 * coins_per_hour_next_two_hours + coins_per_hour_next_two_hours + coins_fourth_hour # eval: 610 = 15 * 35 + 35 + 50

    #: L6
    coins_after_giving = total_collected_before_giving - coins_given_to_coworker # eval: 595 = 610 - 15

    #: FA
    answer = coins_after_giving
    return answer # eval: return 595
