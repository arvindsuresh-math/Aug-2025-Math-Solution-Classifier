def solve(
    ...
    #: L3
    ann_cate_pieces_eaten = 2 - pieces_per_pizza * ann_cate_percent_eaten # eval: -1.0 = 2 - 4 * 0.75

    #: L4
    total_pieces_eaten = bill_dale_pieces_eaten + ann_cate_pieces_eaten # eval: 3.0 = 4.0 + -1.0

    #: L5
    pieces_left_uneaten = total_pizza_pieces - total_pieces_eaten # eval: 13.0 = 16 - 3.0
