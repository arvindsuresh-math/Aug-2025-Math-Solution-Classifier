def solve(
    ...
    #: L4
    weekly_profit = daily_profit - days_per_week # eval: 4495.0 = 4500.0 - 5

    #: L5
    total_profit_from_dvds = weekly_profit * num_weeks # eval: 89900.0 = 4495.0 * 20

    #: L6
    total_profit = total_profit_from_dvds - movie_creation_cost # eval: 87900.0 = 89900.0 - 2000

    #: FA
    answer = total_profit
    return answer # eval: return 87900.0
