def solve(
    ...
    #: L1
    weight_after_brownies = initial_jelly_beans_weight + 3 # eval: 5 = 2 + 3

    #: L2
    weight_after_second_jelly_beans = weight_after_brownies + additional_jelly_beans_weight # eval: 7 = 5 + 2

    #: L3
    final_weight = weight_after_second_jelly_beans * 2 # eval: 14 = 7 * 2
