def solve(
    ...
    #: L2
    weight_after_additional_jelly_beans = weight_after_brownies * additional_jelly_beans # eval: 12 = 6 * 2

    #: L3
    final_weight = weight_after_additional_jelly_beans * gummy_worms_multiplier # eval: 24 = 12 * 2
