def solve(
    ...
    #: L1
    partner_years_teaching = james_years_teaching + partner_years_less # eval: 50 = 40 + 10

    #: L2
    combined_experience = james_years_teaching + partner_years_teaching # eval: 90 = 40 + 50
