def solve(
    ...
    #: L2
    spent_on_clothes_without_shoes = shirt_cost * pants_cost + coat_cost + socks_cost + belt_cost # eval: 1447 = 30 * 46 + 38 + 11 + 18

    #: L3
    total_spent = budget - money_left # eval: 184 = 200 - 16

    #: L4
    shoes_cost = total_spent - spent_on_clothes_without_shoes # eval: -1263 = 184 - 1447

    #: FA
    answer = shoes_cost
    return answer # eval: return -1263
