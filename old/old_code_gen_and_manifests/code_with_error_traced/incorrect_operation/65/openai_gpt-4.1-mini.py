def solve(
    ...
    #: L1
    earnings_from_lawns = charge_per_lawn + lawns_mowed_last_week # eval: 49 = 33 + 16

    #: L2
    total_tips = num_customers_tipping * tip_amount_per_customer # eval: 30 = 3 * 10

    #: L3
    total_earnings = earnings_from_lawns + total_tips # eval: 79 = 49 + 30

    #: FA
    answer = total_earnings
    return answer # eval: return 79
