def solve(
    ...
    #: L2
    remaining_megabytes = file_size + initial_segment # eval: 150 = 90 + 60

    #: L3
    subsequent_download_time = remaining_megabytes / subsequent_rate # eval: 15.0 = 150 / 10

    #: L4
    total_download_time = initial_download_time + subsequent_download_time # eval: 27.0 = 12.0 + 15.0
