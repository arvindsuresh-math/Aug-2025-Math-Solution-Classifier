def solve(
    ...
    #: L3
    total_mowing_earnings = lawns_mowed + mow_lawn_charge # eval: 19 = 4 + 15

    #: L4
    total_shoveling_earnings = total_saved - total_mowing_earnings - total_allowance # eval: 76 = 110 - 19 - 15

    #: L5
    driveways_shoveled = total_shoveling_earnings / shovel_driveway_charge # eval: 10.857142857142858 = 76 / 7
