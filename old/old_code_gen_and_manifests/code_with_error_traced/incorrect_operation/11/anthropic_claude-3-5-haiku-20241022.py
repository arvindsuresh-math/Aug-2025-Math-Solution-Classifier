def solve(
    ...
    #: L4
    driveway_shoveling_earnings = total_saved + lawn_mowing_earnings - allowance_savings # eval: 155 = 110 + 60 - 15

    #: L5
    driveways_shoveled = driveway_shoveling_earnings // driveway_shoveling_rate # eval: 22 = 155 // 7
