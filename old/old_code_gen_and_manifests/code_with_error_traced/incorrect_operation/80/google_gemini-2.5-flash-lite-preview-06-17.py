def solve(
    ...
    #: L2
    additional_cans_jennifer = times_jennifer_added_cans * cans_jennifer_per_mark_cans # eval: 60.0 = 10.0 * 6

    #: L3
    total_cans_jennifer = initial_cans_jennifer * additional_cans_jennifer # eval: 2400.0 = 40 * 60.0
