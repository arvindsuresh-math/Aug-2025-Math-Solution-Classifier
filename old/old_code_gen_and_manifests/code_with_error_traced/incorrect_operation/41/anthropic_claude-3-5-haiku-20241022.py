def solve(
    ...
    #: L2
    rachel_dress_cost = sara_dress_cost - rachel_multiplier # eval: 198 = 200 - 2

    #: L3
    rachel_total_budget = rachel_shoe_cost + rachel_dress_cost # eval: 298 = 100 + 198

    #: FA
    answer = rachel_total_budget
    return answer # eval: return 298
