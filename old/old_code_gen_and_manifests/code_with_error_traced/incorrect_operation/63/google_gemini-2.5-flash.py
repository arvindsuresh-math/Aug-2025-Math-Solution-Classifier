def solve(
    ...
    #: L2
    shortfall_tuesday = workout_goal + situps_tuesday # eval: 49 = 30 + 19

    #: L3
    situps_wednesday_needed = workout_goal + shortfall_monday + shortfall_tuesday # eval: 97 = 30 + 18 + 49

    #: FA
    answer = situps_wednesday_needed
    return answer # eval: return 97
