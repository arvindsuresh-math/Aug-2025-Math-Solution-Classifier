def solve(
    ...
    #: L1
    pages_today = pages_yesterday + 2 # eval: 14 = 12 + 2

    #: L2
    pages_read_total = pages_yesterday + pages_today # eval: 26 = 12 + 14

    #: L3
    pages_remaining = total_pages - pages_read_total # eval: 94 = 120 - 26

    #: L4
    pages_tomorrow = pages_remaining / 2 # eval: 47.0 = 94 / 2
