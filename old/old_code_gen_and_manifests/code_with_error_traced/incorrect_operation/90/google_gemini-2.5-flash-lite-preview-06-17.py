def solve(
    ...
    #: L1
    total_days = days_dec - days_jan + days_feb # eval: 28 = 31 - 31 + 28

    #: L2
    cups_per_day = morning_feed + afternoon_feed # eval: 1.0 = 0.5 + 0.5

    #: L3
    total_cups_needed = cups_per_day * total_days # eval: 28.0 = 1.0 * 28
