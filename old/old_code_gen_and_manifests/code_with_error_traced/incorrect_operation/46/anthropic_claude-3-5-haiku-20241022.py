def solve(
    ...
    #: L3
    total_weekly_practice = total_daily_practice * practice_days_per_week # eval: 480 = 80 * 6

    #: L4
    total_monthly_practice = total_weekly_practice + weeks_in_month # eval: 484 = 480 + 4

    #: FA
    answer = total_monthly_practice
    return answer # eval: return 484
