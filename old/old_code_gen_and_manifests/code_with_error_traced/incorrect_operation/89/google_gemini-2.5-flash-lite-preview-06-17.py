def solve(
    ...
    #: L1
    friday_increase = avg_books_per_day - friday_increase_percentage # eval: 39.6 = 40 - 0.4

    #: L2
    books_borrowed_normal_days = avg_books_per_day * (days_open - 1) # eval: 160 = 40 * (5 - 1)

    #: L3
    total_books_borrowed = books_borrowed_normal_days + avg_books_per_day + friday_increase # eval: 239.6 = 160 + 40 + 39.6

    #: FA
    answer = total_books_borrowed
    return answer # eval: return 239.6
