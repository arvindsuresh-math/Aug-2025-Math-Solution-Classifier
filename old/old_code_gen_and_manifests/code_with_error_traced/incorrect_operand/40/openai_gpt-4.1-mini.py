def solve(
    ...
    #: L3
    discounted_ticket_price = discount_threshold - discount_per_ticket # eval: 8.0 = 10 - 2.0

    #: L4
    total_discounted_tickets_cost = discounted_ticket_price * discounted_tickets # eval: 16.0 = 8.0 * 2
    ...
    #: L6
    total_cost = total_full_price_tickets_cost + total_discounted_tickets_cost # eval: 416.0 = 400 + 16.0

    #: FA
    answer = total_cost
    return answer # eval: return 416.0
