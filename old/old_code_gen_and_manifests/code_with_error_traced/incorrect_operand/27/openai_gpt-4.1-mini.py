def solve(
    ...
    #: L2
    valuable_first_round = non_valuable_first_round - non_valuable_first_round # eval: 0.0 = 560.0 - 560.0
    ...
    #: L5
    total_valuable_files = valuable_first_round + valuable_second_round # eval: 160.0 = 0.0 + 160.0
