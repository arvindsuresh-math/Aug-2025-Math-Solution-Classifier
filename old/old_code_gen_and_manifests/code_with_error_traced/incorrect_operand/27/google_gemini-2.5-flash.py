def solve(
    ...
    #: L2
    valuable_first_round = additional_files_downloaded - non_valuable_first_round # eval: -160.0 = 400 - 560.0
    ...
    #: L5
    total_valuable_files = valuable_second_round + valuable_first_round # eval: 0.0 = 160.0 + -160.0
