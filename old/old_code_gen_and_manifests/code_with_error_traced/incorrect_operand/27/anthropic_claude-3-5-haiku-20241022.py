def solve(
    ...
    #: L3
    second_round_non_valuable_files = second_download_files * first_download_delete_percent # eval: 280.0 = 400 * 0.7

    #: L4
    second_round_valuable_files = second_download_files - second_round_non_valuable_files # eval: 120.0 = 400 - 280.0

    #: L5
    total_valuable_files = first_round_valuable_files + second_round_valuable_files # eval: 360.0 = 240.0 + 120.0
