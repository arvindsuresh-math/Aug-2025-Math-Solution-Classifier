def solve(
    ...
    #: L4
    valuable_files_second_round = additional_files_downloaded - percentage_deleted_first_round # eval: 399.3 = 400 - 0.7

    #: L5
    total_valuable_files = valuable_files_first_round + valuable_files_second_round # eval: 639.3 = 240.0 + 399.3

    #: FA
    answer = total_valuable_files
    return answer # eval: return 639.3
