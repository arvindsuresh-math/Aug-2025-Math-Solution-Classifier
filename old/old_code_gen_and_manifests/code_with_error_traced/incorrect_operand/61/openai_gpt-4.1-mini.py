def solve(
    ...
    #: L3
    remaining_weight_needed = total_weight_needed - weight_from_acorns - weight_from_acorns # eval: 200.0 = 1000 - 400.0 - 400.0

    #: L4
    weight_from_salmon = remaining_weight_needed / 2 # eval: 100.0 = 200.0 / 2

    #: L5
    weight_from_small_animals = remaining_weight_needed - weight_from_salmon # eval: 100.0 = 200.0 - 100.0
