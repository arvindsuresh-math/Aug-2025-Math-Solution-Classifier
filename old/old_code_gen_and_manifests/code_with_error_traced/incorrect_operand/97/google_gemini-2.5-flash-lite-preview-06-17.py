def solve(
    ...
    #: L1
    num_mystery_books = num_history_books + num_biographies # eval: 18 = 12 + 6

    #: L2
    total_books = num_history_books + num_romance_books + num_poetry_books + num_mystery_books + num_western_novels + num_biographies # eval: 53 = 12 + 8 + 4 + 18 + 5 + 6
