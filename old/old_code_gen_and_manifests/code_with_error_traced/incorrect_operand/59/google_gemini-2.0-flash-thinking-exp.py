def solve(
    ...
    #: L5
    total_collected_before_giving = coins_given_to_coworker + coins_per_hour_next_two_hours + coins_per_hour_next_two_hours + coins_fourth_hour # eval: 135 = 15 + 35 + 35 + 50
