def solve(
    ...
    #: L1
    distance_after_turns_1_2_4 = distance_after_1st_turn + distance_after_2nd_turn + distance_after_2nd_turn # eval: 21 = 5 + 8 + 8

    #: L2
    distance_after_3rd_turn = total_distance_around_ring - distance_after_turns_1_2_4 # eval: 2 = 23 - 21
