def solve(
    ...
    #: L1
    known_distances_sum = dist_after_1st_turn + dist_after_1st_turn + 0 # eval: 10 = 5 + 5 + 0

    #: L2
    distance_after_3rd_turn = total_dist_around_ring - known_distances_sum # eval: 13 = 23 - 10
