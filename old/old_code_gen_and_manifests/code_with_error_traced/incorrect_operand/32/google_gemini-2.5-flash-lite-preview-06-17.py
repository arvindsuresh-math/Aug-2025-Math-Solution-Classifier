def solve(
    ...
    #: L1
    meters_before_3rd_turn = meters_after_2nd_turn + meters_after_2nd_turn + meters_after_4th_turn # eval: 16 = 8 + 8 + 0

    #: L2
    meters_after_3rd_turn = total_meters_driven - meters_before_3rd_turn # eval: 7 = 23 - 16
