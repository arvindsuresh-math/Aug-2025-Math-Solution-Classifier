def solve(
    ...
    #: L2
    first_and_second_part_time = hours_to_complete + second_part_time # eval: 52 = 2 + 50

    #: L3
    total_assignment_time = hours_to_complete * 60 # eval: 120 = 2 * 60

    #: L4
    third_part_time = total_assignment_time - first_and_second_part_time # eval: 68 = 120 - 52
