def solve(
    ...
    #: L8
    previous_monthly_income = (previous_rent_utility_percentage * income_increase) / (previous_rent_utility_percentage - new_rent_utility_percentage) # eval: 1599.9999999999998 = (0.4 * 600) / (0.4 - 0.25)

    #: FA
    answer = previous_monthly_income
    return answer # eval: return 1599.9999999999998
