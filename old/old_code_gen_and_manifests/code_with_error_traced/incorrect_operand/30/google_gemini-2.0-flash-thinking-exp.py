def solve(
    ...
    #: L3
    pieces_eaten_ann_cate = num_ann_cate * percent_eaten_bill_dale * percent_eaten_ann_cate # eval: 0.75 = 2 * 0.5 * 0.75

    #: L4
    total_pieces_eaten = pieces_eaten_bill_dale + pieces_eaten_ann_cate # eval: 4.75 = 4.0 + 0.75

    #: L5
    pieces_left_uneaten = total_pizza_pieces - total_pieces_eaten # eval: 11.25 = 16 - 4.75
