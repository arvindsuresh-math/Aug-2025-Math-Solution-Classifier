def solve(
    ...
    #: L5
    total_paid_4_months = monthly_payment * laptop_cost # eval: 65000.0 = 65.0 * 1000

    #: L6
    balance_after_4_months = remaining_balance - total_paid_4_months # eval: -64220.0 = 780.0 - 65000.0

    #: FA
    answer = balance_after_4_months
    return answer # eval: return -64220.0
