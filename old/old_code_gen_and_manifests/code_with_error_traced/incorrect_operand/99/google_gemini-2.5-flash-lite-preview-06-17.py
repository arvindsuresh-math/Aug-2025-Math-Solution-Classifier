def solve(
    ...
    #: L1
    gallons_in_second_tank = gallons_in_first_tank / gallons_in_first_tank # eval: 1.0 = 48 / 48

    #: L2
    num_fish_second_tank = gallons_in_second_tank / fish_size_second_tank # eval: 0.5 = 1.0 / 2
    ...
    #: L5
    difference_in_fish = num_fish_first_tank_after_eating - num_fish_second_tank # eval: 14.5 = 15.0 - 0.5
