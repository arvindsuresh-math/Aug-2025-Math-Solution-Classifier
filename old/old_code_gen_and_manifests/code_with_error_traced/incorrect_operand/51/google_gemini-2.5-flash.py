def solve(
    ...
    #: L2
    living_room_fabric_area = living_room_length * living_room_length # eval: 16 = 4 * 4

    #: L3
    bedroom_fabric_area = bedroom_length * bedroom_width # eval: 8 = 2 * 4

    #: L4
    fabric_left = original_bolt_area - living_room_fabric_area - bedroom_fabric_area # eval: 168 = 192 - 16 - 8

    #: FA
    answer = fabric_left
    return answer # eval: return 168
