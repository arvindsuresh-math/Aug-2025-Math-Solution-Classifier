def solve(
    ...
    #: L1
    total_snakes_eaten = num_jaguars * num_jaguars # eval: 36 = 6 * 6

    #: L2
    total_birds_eaten = total_snakes_eaten * birds_per_snake # eval: 108 = 36 * 3

    #: L3
    total_beetles_eaten = total_birds_eaten * beetles_per_bird # eval: 1296 = 108 * 12

    #: FA
    answer = total_beetles_eaten
    return answer # eval: return 1296
