def solve(
    ...
    #: L2
    total_birds_eaten = birds_per_snake * total_snakes_eaten # eval: 90 = 3 * 30

    #: L3
    total_beetles_eaten = birds_per_snake * total_birds_eaten # eval: 270 = 3 * 90

    #: FA
    answer = total_beetles_eaten
    return answer # eval: return 270
