def solve(
    ...
    #: L1
    total_weight_loss = weight_loss_per_month * weight_loss_per_month # eval: 9 = 3 * 3

    #: L2
    weight_on_fight_day = current_weight - total_weight_loss # eval: 88 = 97 - 9

    #: FA
    answer = weight_on_fight_day
    return answer # eval: return 88
