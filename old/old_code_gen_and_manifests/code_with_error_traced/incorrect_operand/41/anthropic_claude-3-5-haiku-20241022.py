def solve(
    ...
    #: L1
    rachel_shoe_cost = sara_shoe_cost * sara_dress_cost # eval: 10000 = 50 * 200

    #: L2
    rachel_dress_cost = sara_dress_cost * rachel_multiplier # eval: 400 = 200 * 2

    #: L3
    rachel_total_budget = rachel_shoe_cost + rachel_dress_cost # eval: 10400 = 10000 + 400

    #: FA
    answer = rachel_total_budget
    return answer # eval: return 10400
