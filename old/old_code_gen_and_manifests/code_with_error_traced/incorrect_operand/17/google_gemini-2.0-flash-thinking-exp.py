def solve(
    ...
    #: L5
    total_pink_green_remaining = remaining_green_after_john + john_takes_pink # eval: 9 = 3 + 6

    #: L6
    total_remaining_hard_hats = total_pink_green_remaining + initial_yellow_hard_hats # eval: 33 = 9 + 24
