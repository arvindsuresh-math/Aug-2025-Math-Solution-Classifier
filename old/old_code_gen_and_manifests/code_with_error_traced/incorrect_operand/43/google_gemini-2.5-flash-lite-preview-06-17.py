def solve(
    ...
    #: L3
    fourth_earthquake_collapses = third_earthquake_collapses * initial_collapses # eval: 64 = 16 * 4

    #: L4
    total_collapses = initial_collapses + second_earthquake_collapses + third_earthquake_collapses + fourth_earthquake_collapses # eval: 92 = 4 + 8 + 16 + 64

    #: FA
    answer = total_collapses
    return answer # eval: return 92
