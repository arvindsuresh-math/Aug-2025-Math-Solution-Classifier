def solve(
    ...
    #: L4
    green_flowers = yellow_and_purple_flowers * yellow_flowers # eval: 280.0 = 28.0 * 10

    #: L5
    total_flowers = yellow_and_purple_flowers + green_flowers # eval: 308.0 = 28.0 + 280.0

    #: FA
    answer = total_flowers
    return answer # eval: return 308.0
