def solve(
    ...
    #: L2
    amalie_coins = (amalie_ratio / total_coins) * total_coins # eval: 45.0 = (45 / 440) * 440

    #: L3
    coins_spent_by_amalie = fraction_spent_by_amalie * amalie_coins # eval: 33.75 = 0.75 * 45.0

    #: L4
    amalie_remaining_coins = amalie_coins - coins_spent_by_amalie # eval: 11.25 = 45.0 - 33.75
