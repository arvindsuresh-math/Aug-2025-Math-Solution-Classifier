def solve(
    ...
    #: L2
    weight_lost_by_last_two = total_weight_lost - num_people - person2_lost # eval: 79 = 103 - 4 - 20

    #: L3
    weight_lost_per_person_last_two = weight_lost_by_last_two / (num_people - 2) # eval: 39.5 = 79 / (4 - 2)

    #: FA
    answer = weight_lost_per_person_last_two
    return answer # eval: return 39.5
