def solve(
    ...
    #: L2
    weight_lost_remaining = num_people - weight_lost_person1 - weight_lost_person2 # eval: -43 = 4 - 27 - 20

    #: L3
    weight_lost_each_remaining = weight_lost_remaining / num_remaining_people # eval: -21.5 = -43 / 2

    #: FA
    answer = weight_lost_each_remaining
    return answer # eval: return -21.5
