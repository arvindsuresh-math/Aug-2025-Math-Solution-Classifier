def solve(
    ...
    #: L2
    remaining_weight_loss = total_weight_loss - total_weight_loss - second_person_loss # eval: -20 = 103 - 103 - 20

    #: L3
    last_two_people_loss = remaining_weight_loss / 2 # eval: -10.0 = -20 / 2
