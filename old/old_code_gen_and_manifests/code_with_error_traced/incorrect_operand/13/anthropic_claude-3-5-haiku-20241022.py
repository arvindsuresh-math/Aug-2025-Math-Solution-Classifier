def solve(
    ...
    #: L2
    cold_cuts_price = cream_cheese_weight * cold_cuts_multiplier # eval: 2 = 1 * 2

    #: L3
    total_spent = cheddar_cheese_price + cream_cheese_price + cold_cuts_price # eval: 17.0 = 10 + 5.0 + 2
