def solve(
    ...
    #: L2
    total_daily_pay_with_bonus = daily_wage + bonus_workday_hours # eval: 90 = 80 + 10

    #: L3
    hourly_rate_with_bonus = total_daily_pay_with_bonus / bonus_workday_hours # eval: 9.0 = 90 / 10
