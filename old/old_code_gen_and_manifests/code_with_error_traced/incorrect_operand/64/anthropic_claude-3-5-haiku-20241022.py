def solve(
    ...
    #: L3
    earnings_main_job = hours_main_job * hours_main_job # eval: 900 = 30 * 30
    ...
    #: L6
    total_weekly_earnings = earnings_main_job + earnings_second_job # eval: 1140.0 = 900 + 240.0

    #: FA
    answer = total_weekly_earnings
    return answer # eval: return 1140.0
