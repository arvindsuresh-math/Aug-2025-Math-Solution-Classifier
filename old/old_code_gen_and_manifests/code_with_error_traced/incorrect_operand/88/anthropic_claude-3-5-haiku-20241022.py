def solve(
    ...
    #: L2
    geckos_two_years_ago = geckos_last_year * geckos_last_year # eval: 7396 = 86 * 86

    #: L3
    total_geckos_sold = geckos_last_year + geckos_two_years_ago # eval: 7482 = 86 + 7396

    #: FA
    answer = total_geckos_sold
    return answer # eval: return 7482
