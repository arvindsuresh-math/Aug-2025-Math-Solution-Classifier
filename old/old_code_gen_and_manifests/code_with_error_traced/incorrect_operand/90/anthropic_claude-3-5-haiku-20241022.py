def solve(
    ...
    #: L1
    total_days = morning_feed + days_january + days_february # eval: 59.5 = 0.5 + 31 + 28

    #: L2
    daily_feed = morning_feed + afternoon_feed # eval: 1.0 = 0.5 + 0.5

    #: L3
    total_bird_food = daily_feed * total_days # eval: 59.5 = 1.0 * 59.5
