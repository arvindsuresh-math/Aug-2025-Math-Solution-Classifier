def solve(
    ...
    #: L2
    total_pages_per_week = pages_per_friend_per_week * pages_per_friend_per_week # eval: 36 = 6 * 6

    #: L3
    total_pages_per_year = total_pages_per_week * 52 # eval: 1872 = 36 * 52

    #: FA
    answer = total_pages_per_year
    return answer # eval: return 1872
