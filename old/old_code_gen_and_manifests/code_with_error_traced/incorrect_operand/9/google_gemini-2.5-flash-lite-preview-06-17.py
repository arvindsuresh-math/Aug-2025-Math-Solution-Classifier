def solve(
    ...
    #: L7
    overtime_pay_total = overtime_hourly_rate * days_worked # eval: 135.0 = 27.0 * 5

    #: L8
    total_earnings = regular_pay_total + overtime_pay_total # eval: 855.0 = 720.0 + 135.0

    #: FA
    answer = total_earnings
    return answer # eval: return 855.0
