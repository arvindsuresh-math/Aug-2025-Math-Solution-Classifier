def solve(
    ...
    #: L4
    overtime_pay_per_hour = hourly_wage + hourly_wage # eval: 36.0 = 18.0 + 18.0

    #: L5
    total_base_pay = base_pay_per_shift * days_worked # eval: 720.0 = 144.0 * 5

    #: L6
    daily_overtime_pay = overtime_pay_per_hour * overtime_hours_per_day # eval: 72.0 = 36.0 * 2

    #: L7
    total_overtime_pay = daily_overtime_pay * days_worked # eval: 360.0 = 72.0 * 5

    #: L8
    total_pay = total_base_pay + total_overtime_pay # eval: 1080.0 = 720.0 + 360.0

    #: FA
    answer = total_pay
    return answer # eval: return 1080.0
