def solve(
    ...
    #: L1
    regular_shift_pay = hours_worked_per_day * hourly_wage # eval: 180.0 = 10 * 18.0
    ...
    #: L5
    total_base_pay = regular_shift_pay * num_days # eval: 900.0 = 180.0 * 5
    ...
    #: L8
    total_pay = total_base_pay + total_overtime_pay # eval: 1170.0 = 900.0 + 270.0

    #: FA
    answer = total_pay
    return answer # eval: return 1170.0
