def solve(
    ...
    #: L2
    books_borrowed_normal_days = avg_books_per_day * (avg_books_per_day - 1) # eval: 1560 = 40 * (40 - 1)

    #: L3
    total_books_borrowed = books_borrowed_normal_days + avg_books_per_day + friday_increase # eval: 1616.0 = 1560 + 40 + 16.0

    #: FA
    answer = total_books_borrowed
    return answer # eval: return 1616.0
