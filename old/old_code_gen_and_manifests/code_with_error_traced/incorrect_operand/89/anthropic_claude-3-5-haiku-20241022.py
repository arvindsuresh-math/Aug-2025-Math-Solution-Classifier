def solve(
    ...
    #: L2
    total_books_regular_days = library_days * library_days # eval: 25 = 5 * 5

    #: L3
    total_books_in_week = total_books_regular_days + friday_extra_books # eval: 41.0 = 25 + 16.0

    #: FA
    answer = total_books_in_week
    return answer # eval: return 41.0
