def solve(
    ...
    #: L2
    total_books_mon_to_fri = daily_average_books * daily_average_books # eval: 1600 = 40 * 40

    #: L3
    total_books_week = total_books_mon_to_fri + friday_increase_books # eval: 1616.0 = 1600 + 16.0
