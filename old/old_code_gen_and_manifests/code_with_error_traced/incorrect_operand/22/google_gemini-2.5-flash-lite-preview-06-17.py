def solve(
    ...
    #: L1
    bobbie_last_name_len = (bobbie_letters_removed * bobbie_name_multiplier) + bobbie_letters_removed # eval: 6 = (2 * 2) + 2

    #: L2
    samantha_last_name_len = bobbie_last_name_len - samantha_letters_fewer # eval: 3 = 6 - 3
