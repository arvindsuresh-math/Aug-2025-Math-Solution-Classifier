def solve(
    ...
    #: L1
    bobbie_last_name_length = samantha_fewer_letters * bobbie_length_multiplier + bobbie_letters_off # eval: 8 = 3 * 2 + 2

    #: L2
    samantha_last_name_length = bobbie_last_name_length - samantha_fewer_letters # eval: 5 = 8 - 3
