def solve(
    ...
    #: L1
    first_batch_not_hit_fraction = 1 - second_batch_count # eval: -74 = 1 - 75
    first_batch_not_hit_count = first_batch_not_hit_fraction * first_batch_count # eval: -7400 = -74 * 100
    ...
    #: L3
    total_not_hit = first_batch_not_hit_count + second_batch_not_hit_count # eval: -7350.0 = -7400 + 50.00000000000001

    #: FA
    answer = total_not_hit
    return answer # eval: return -7350.0
