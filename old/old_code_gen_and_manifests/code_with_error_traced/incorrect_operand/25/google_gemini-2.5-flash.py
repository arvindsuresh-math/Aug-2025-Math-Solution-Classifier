def solve(
    ...
    #: L1
    fraction_not_hit_first_set = 1 - second_set_balls # eval: -74 = 1 - 75
    balls_not_hit_first_set = fraction_not_hit_first_set * first_set_balls # eval: -7400 = -74 * 100
    ...
    #: L3
    total_balls_not_hit = balls_not_hit_first_set + balls_not_hit_second_set # eval: -7350.0 = -7400 + 50.00000000000001
