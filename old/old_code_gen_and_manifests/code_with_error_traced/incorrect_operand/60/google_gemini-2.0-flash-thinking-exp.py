def solve(
    ...
    #: L3
    practice_hours_one_daughter = game_duration_hours * practice_hours_per_game # eval: 8 = 2 * 4

    #: L4
    total_practice_hours = practice_hours_one_daughter * num_daughters # eval: 16 = 8 * 2

    #: L5
    total_hours = total_game_hours + total_practice_hours # eval: 48 = 32 + 16
