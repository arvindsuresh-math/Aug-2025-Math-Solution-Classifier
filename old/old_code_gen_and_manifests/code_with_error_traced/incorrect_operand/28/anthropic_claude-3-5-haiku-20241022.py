def solve(
    ...
    #: L1
    gnomes_in_first_four_houses = total_gnomes * gnomes_per_known_house # eval: 60 = 20 * 3

    #: L2
    gnomes_in_fifth_house = total_gnomes - gnomes_in_first_four_houses # eval: -40 = 20 - 60
