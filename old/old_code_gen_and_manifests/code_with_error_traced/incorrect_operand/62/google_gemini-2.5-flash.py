def solve(
    ...
    #: L1
    oil_in_specific_cans = num_cans_with_specific_capacity * capacity_per_specific_can # eval: 80 = 10 * 8

    #: L2
    remaining_oil_liters = oil_in_specific_cans - oil_in_specific_cans # eval: 0 = 80 - 80

    #: L3
    remaining_cans = total_cans - num_cans_with_specific_capacity # eval: 14 = 24 - 10

    #: L4
    oil_per_remaining_can = remaining_oil_liters / remaining_cans # eval: 0.0 = 0 / 14
