def solve(
    ...
    #: L3
    total_shorts_and_shoes = total_shorts_cost + price_per_shorts # eval: 42 = 35 + 7

    #: L4
    remaining_amount = total_spent - total_shorts_and_shoes # eval: 33 = 75 - 42

    #: L5
    cost_per_top = remaining_amount / num_tops # eval: 8.25 = 33 / 4

    #: FA
    answer = cost_per_top
    return answer # eval: return 8.25
