def solve(
    ...
    #: L2
    jeff_skips_round2 = num_rounds - jeff_skips_fewer_round2 # eval: 1 = 4 - 3
    ...
    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4 # eval: 44.0 = 15 + 1 + 20 + 8.0

    #: L6
    average_jeff_skips_per_round = total_jeff_skips / num_rounds # eval: 11.0 = 44.0 / 4
