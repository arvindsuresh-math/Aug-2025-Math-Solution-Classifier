def solve(
    ...
    #: L2
    total_additional_cans = initial_cans_jennifer * additional_cans_per_5_mark # eval: 240 = 40 * 6

    #: L3
    total_cans_jennifer = initial_cans_jennifer + total_additional_cans # eval: 280 = 40 + 240

    #: FA
    answer = total_cans_jennifer
    return answer # eval: return 280
