def solve(
    ...
    #: L2
    money_left_after_milkshake = milkshake_cost - milkshake_cost # eval: 0.0 = 4.0 - 4.0

    #: L3
    money_in_wallet = money_left_after_milkshake * savings_fraction # eval: 0.0 = 0.0 * 0.5

    #: L4
    money_lost = money_in_wallet - money_left_after_shredding # eval: -1.0 = 0.0 - 1
