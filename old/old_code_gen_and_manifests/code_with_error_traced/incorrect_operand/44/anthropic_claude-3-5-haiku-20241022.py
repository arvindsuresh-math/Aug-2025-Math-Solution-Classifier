def solve(
    ...
    #: L1
    accommodation_cost = budget * budget # eval: 1000000 = 1000 * 1000
    ...
    #: L4
    coursework_materials_cost = budget - (accommodation_cost + food_cost + entertainment_cost) # eval: -999550.0 = 1000 - (1000000 + 300.0 + 250.0)

    #: FA
    answer = coursework_materials_cost
    return answer # eval: return -999550.0
