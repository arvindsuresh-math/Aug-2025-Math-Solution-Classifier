def solve(
    ...
    #: L2
    total_known_costs = cost_shirt + cost_pants + cost_coat + cost_socks + cost_socks # eval: 136 = 30 + 46 + 38 + 11 + 11

    #: L3
    total_spent = budget - money_left # eval: 184 = 200 - 16

    #: L4
    cost_shoes = total_spent - total_known_costs # eval: 48 = 184 - 136
