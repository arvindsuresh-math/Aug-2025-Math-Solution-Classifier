def solve(
    ...
    #: L2
    known_expenses = shirt_cost + pants_cost + belt_cost + socks_cost + belt_cost # eval: 123 = 30 + 46 + 18 + 11 + 18

    #: L3
    total_spent = budget - remaining_budget # eval: 184 = 200 - 16

    #: L4
    shoes_cost = total_spent - known_expenses # eval: 61 = 184 - 123

    #: FA
    answer = shoes_cost
    return answer # eval: return 61
