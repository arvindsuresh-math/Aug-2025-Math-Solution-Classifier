def solve(
    ...
    #: L2
    other_items_total = shirt_cost + pants_cost + shirt_cost + socks_cost + belt_cost # eval: 135 = 30 + 46 + 30 + 11 + 18

    #: L3
    total_spent = budget - money_left # eval: 184 = 200 - 16

    #: L4
    shoes_cost = total_spent - other_items_total # eval: 49 = 184 - 135
