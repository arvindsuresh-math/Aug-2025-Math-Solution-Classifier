def solve(
    ...
    #: L2
    remaining_mb = first_rate_mb_per_sec - first_part_mb # eval: -55 = 5 - 60

    #: L3
    time_remaining = remaining_mb / second_rate_mb_per_sec # eval: -5.5 = -55 / 10

    #: L4
    total_time = time_first_part + time_remaining # eval: 6.5 = 12.0 + -5.5
