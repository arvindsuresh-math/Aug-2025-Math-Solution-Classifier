def solve(
    ...
    #: L4
    weekly_profit = movies_sold_per_day * days_sold_per_week # eval: 2500 = 500 * 5

    #: L5
    total_profit_before_cost = weekly_profit * number_of_weeks # eval: 50000 = 2500 * 20

    #: L6
    total_profit_after_cost = total_profit_before_cost - movie_creation_cost # eval: 48000 = 50000 - 2000

    #: FA
    answer = total_profit_after_cost
    return answer # eval: return 48000
