def solve(
    ...
    #: L5
    total_profit_before_movie_cost = weekly_profit * profit_per_dvd # eval: 202500.0 = 22500.0 * 9.0

    #: L6
    total_profit_after_movie_cost = total_profit_before_movie_cost - movie_creation_cost # eval: 200500.0 = 202500.0 - 2000

    #: FA
    answer = total_profit_after_movie_cost
    return answer # eval: return 200500.0
