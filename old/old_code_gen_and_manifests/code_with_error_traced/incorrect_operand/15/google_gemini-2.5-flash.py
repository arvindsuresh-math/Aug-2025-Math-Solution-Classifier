def solve(
    ...
    #: L5
    total_profit_from_sales = dvd_selling_price * number_of_weeks # eval: 300.0 = 15.0 * 20

    #: L6
    net_profit = total_profit_from_sales - movie_creation_cost # eval: -1700.0 = 300.0 - 2000

    #: FA
    answer = net_profit
    return answer # eval: return -1700.0
