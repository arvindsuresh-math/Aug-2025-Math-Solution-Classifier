def solve(
    ...
    #: L2
    total_candy_billy = candy_per_house_anna * houses_subdivision_billy # eval: 1050 = 14 * 75

    #: L3
    difference_in_candy = total_candy_anna - total_candy_billy # eval: -210 = 840 - 1050

    #: FA
    answer = difference_in_candy
    return answer # eval: return -210
