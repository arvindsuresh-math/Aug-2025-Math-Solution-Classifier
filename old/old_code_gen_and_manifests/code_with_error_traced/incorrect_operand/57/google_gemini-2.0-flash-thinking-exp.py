def solve(
    ...
    #: L4
    remaining_butter_after_chocolate_peanut_butter = total_butter_kg - fraction_sugar_remaining # eval: 9.666666666666666 = 10 - 0.3333333333333333

    #: L5
    butter_sugar = remaining_butter_after_chocolate_peanut_butter * fraction_sugar_remaining # eval: 3.222222222222222 = 9.666666666666666 * 0.3333333333333333

    #: L6
    butter_left = remaining_butter_after_chocolate_peanut_butter - butter_sugar # eval: 6.444444444444445 = 9.666666666666666 - 3.222222222222222

    #: FA
    answer = butter_left
    return answer # eval: return 6.444444444444445
