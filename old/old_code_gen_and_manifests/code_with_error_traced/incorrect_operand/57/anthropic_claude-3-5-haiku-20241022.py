def solve(
    ...
    #: L6
    final_remaining_butter = sugar_cookie_fraction - sugar_cookie_butter # eval: -0.6666666666666667 = 0.3333333333333333 - 1.0

    #: FA
    answer = final_remaining_butter
    return answer # eval: return -0.6666666666666667
