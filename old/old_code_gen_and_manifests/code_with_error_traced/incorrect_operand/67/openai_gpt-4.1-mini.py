def solve(
    ...
    #: L1
    jesse_miles_first_three_days = 3 * jesse_day_four_miles # eval: 30 = 3 * 10

    #: L2
    jesse_miles_left = total_miles - jesse_day_four_miles - jesse_miles_first_three_days # eval: -10 = 30 - 10 - 30

    #: L3
    jesse_avg_last_three_days = jesse_miles_left / 3 # eval: -3.3333333333333335 = -10 / 3
    ...
    #: L7
    total_avg_last_three_days = jesse_avg_last_three_days + mia_avg_last_three_days # eval: 2.6666666666666665 = -3.3333333333333335 + 6.0

    #: L8
    average_of_averages = total_avg_last_three_days / 2 # eval: 1.3333333333333333 = 2.6666666666666665 / 2
