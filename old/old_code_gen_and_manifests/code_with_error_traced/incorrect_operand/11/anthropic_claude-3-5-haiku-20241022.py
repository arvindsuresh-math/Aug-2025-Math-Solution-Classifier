def solve(
    ...
    #: L3
    lawn_mowing_earnings = lawns_mowed * shoe_cost # eval: 380 = 4 * 95

    #: L4
    driveway_shoveling_earnings = total_saved - lawn_mowing_earnings - allowance_savings # eval: -285 = 110 - 380 - 15

    #: L5
    driveways_shoveled = driveway_shoveling_earnings // driveway_shoveling_rate # eval: -41 = -285 // 7
