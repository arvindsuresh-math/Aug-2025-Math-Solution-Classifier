def solve(
    ...
    #: L4
    money_from_shoveling_driveways = total_money_saved - shoes_cost - money_from_allowance # eval: 0 = 110 - 95 - 15

    #: L5
    num_driveways_shoveled = money_from_shoveling_driveways / driveway_shoveling_charge # eval: 0.0 = 0 / 7
