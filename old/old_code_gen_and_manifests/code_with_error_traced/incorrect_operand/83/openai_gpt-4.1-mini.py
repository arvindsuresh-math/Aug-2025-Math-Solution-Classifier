def solve(
    ...
    #: L2
    zola_red_hats = zola_red_fraction * paityn_red_hats # eval: 16.0 = 0.8 * 20

    #: L3
    zola_blue_hats = zola_blue_multiplier * paityn_blue_hats # eval: 48 = 2 * 24

    #: L4
    zola_total_hats = zola_red_fraction + zola_blue_hats # eval: 48.8 = 0.8 + 48

    #: L5
    combined_hats = zola_total_hats + paityn_total_hats # eval: 92.8 = 48.8 + 44

    #: L6
    hats_per_person = combined_hats / 2 # eval: 46.4 = 92.8 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 46.4
