def solve(
    sam_time_per_widget: int = 10, # He can assemble 1 widget every 10 minutes
    joint_widgets: int = 2, # they put together 2 complete widgets
    joint_time: int = 15, # every 15 minutes
    ...
    """
    # L1 is a statement of fact, captured in the arguments.
    
    #: L2
    jack_time_per_widget = joint_time
