def solve(
    ...
    repeats_per_bracelet: int = 3, # 3 repeats per bracelet
    repeats_per_necklace: int = 5, # 5 repeats per necklace
    num_bracelets: int = 1, # 1 bracelets
    num_necklaces: int = 10 # 10 necklaces
):
    """Index: 3779.
    Returns: the total number of beads needed for 1 bracelets and 10 necklaces.
    """
    #: L1
    num_red_beads = num_green_beads * red_beads_multiplier

    #: L2
    total_beads_per_repeat = num_red_beads + num_green_beads + num_purple_beads
