def solve(
        green_beads_per_repeat: int = 3,  # 3 green beads per repeat
        purple_beads_per_repeat: int = 5,  # 5 purple beads per repeat
    ...
    Returns the total number of beads needed for bracelets and necklaces."""
    
    # First find the number of red beads per repeat: 3 green * 2 red/green = <<3*2=6>>6 red
    red_beads_per_repeat = green_beads_per_repeat * red_bead_multiplier
    ...
    total_beads = total_necklace_beads + (beads_per_bracelet * num_bracelets)
