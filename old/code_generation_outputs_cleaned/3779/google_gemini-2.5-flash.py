def solve(
        num_green_beads_per_pattern: int = 3, # 3 green beads
        num_purple_beads_per_pattern: int = 5, # 5 purple beads
        red_beads_multiplier: int = 2, # twice as many red beads as green beads
        pattern_repeats_per_bracelet: int = 3, # pattern repeats three times per bracelet
        pattern_repeats_per_necklace: int = 5, # 5 times per necklace
        num_bracelets: int = 1, # 1 bracelets
    ...
    num_red_beads_per_pattern = num_green_beads_per_pattern * red_beads_multiplier
    ...
    total_beads_per_pattern = num_red_beads_per_pattern + num_green_beads_per_pattern + num_purple_beads_per_pattern
    ...
    beads_per_bracelet = total_beads_per_pattern * pattern_repeats_per_bracelet
    ...
    beads_per_necklace = total_beads_per_pattern * pattern_repeats_per_necklace
    ...
    total_beads_used = total_beads_necklaces + (beads_per_bracelet * num_bracelets)
