def solve(
    green_beads_per_pattern: int = 3, # 3 green beads in the pattern
    purple_beads_per_pattern: int = 5, # 5 purple beads in the pattern
    ...
    red_beads_per_pattern = green_beads_per_pattern * red_beads_multiplier
    ...
    beads_per_pattern = red_beads_per_pattern + green_beads_per_pattern + purple_beads_per_pattern
    ...
    beads_per_bracelet = beads_per_pattern * repeats_per_bracelet
    ...
    beads_per_necklace = beads_per_pattern * repeats_per_necklace
    ...
    total_beads = total_beads_necklaces + beads_per_bracelet
