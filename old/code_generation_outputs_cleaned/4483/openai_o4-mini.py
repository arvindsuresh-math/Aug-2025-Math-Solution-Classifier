def solve(
    ...
    fraction_interested: float = 1/2,      # Bryan is only interested in half of the records
    bryan_price_interested: int = 6,       # Bryan offers 6 dollars each for the half he is interested in
    bryan_price_not_interested: int = 1    # Bryan offers 1 dollar each for the remaining half
):
    ...
    half_records = total_records * fraction_interested
    ...
    bryan_payment_interested = half_records * bryan_price_interested
    ...
    bryan_payment_not_interested = half_records * bryan_price_not_interested

    # In total Bryan is willing to offer Peggy 600 + 100 = <<600+100=700>>700 dollars for her entire record collection.
    bryan_total = bryan_payment_interested + bryan_payment_not_interested
