def solve(
    ...
    sammy_price: int = 4,  # Sammy will buy all of them for 4 dollars each
    bryan_interested_price: int = 6,  # Bryan will offer 6 dollars each for half the records
    bryan_uninterested_price: int = 1  # Bryan will offer 1 dollar each for the remaining half
):
    ...
    bryan_interested_total = half_records * bryan_interested_price
    ...
    bryan_uninterested_total = half_records * bryan_uninterested_price
    
    # In total Bryan is willing to offer Peggy 600+100=<<600+100=700>>700 dollars for her entire record collection.
    bryan_total = bryan_interested_total + bryan_uninterested_total
