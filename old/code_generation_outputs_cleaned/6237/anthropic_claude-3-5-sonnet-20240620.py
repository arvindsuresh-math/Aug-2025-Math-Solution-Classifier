def solve(
    ...
    twelve_hour_shifts: int = 1,  # and 1 12-hour shift this week
    ...
    reported_tips_fraction: float = 1/3  # he only reports 1/3rd of his tips to the IRS
):
    ...
    eight_hour_shift_total = eight_hour_shifts * 8
    ...
    total_hours = eight_hour_shift_total + (twelve_hour_shifts * 12)
