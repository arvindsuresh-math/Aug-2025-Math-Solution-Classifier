def solve(
    ...
    hours_per_8_hour_shift: int = 8, # Each shift is 8 hours
    num_12_hour_shifts: int = 1, # He has 1 12-hour shift
    hours_per_12_hour_shift: int = 12, # The shift is 12 hours
    tips_per_hour: int = 12, # He makes an average of $12 in tips each hour
    tax_rate: float = 0.2, # He's supposed to pay 20% of his income in taxes
    fraction_of_tips_reported: float = 1/3 # He only reports 1/3rd of his tips to the IRS
):
    ...
    total_hours = hours_from_8_hour_shifts + hours_per_12_hour_shift
    ...
    reported_tips = total_tips * fraction_of_tips_reported
    ...
    # The final answer is the amount of taxes Brendan pays each week
    return taxes_paid