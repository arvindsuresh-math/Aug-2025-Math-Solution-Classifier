...
```
    ...
    Processing tier3:   0%|          | 0/1261 [00:00<?, ?it/s]
    ...
    --- Summary Report ---
    Answer Correctness Breakdown:
      - Pass (Correct Answer): 4750 / 4793 (99.10%)
      - Fail (Wrong Answer):     42 / 4793 (0.88%)
      - Fail (Not Executable):    1 / 4793 (0.02%)
    
    --- Integrity Rates (file-based) ---
    Perfect Structural Match: 4482 / 4793 (93.51%) of all templates
    Perfect Semantic Match:   4182 / 4481 (93.33%) of eligible templates
    
    --- Integrity Rates (index-based) ---
    Perfect Structural Match: 2766 / 2915 (94.89%) of all indices
    Perfect Semantic Match:   2598 / 2915 (89.13%) of all indices
