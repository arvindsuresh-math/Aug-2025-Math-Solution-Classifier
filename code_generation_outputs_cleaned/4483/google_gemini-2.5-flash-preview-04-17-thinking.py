def solve(
    sammy_price_per_record: int = 4, # 4 dollars each
    bryan_interested_fraction: float = 1/2, # half of the records
    bryan_price_interested_half: int = 6, # 6 dollars each for the half that he is interested in
    bryan_price_remaining_half: int = 1, # 1 dollar each for the remaining half
    ...
    records_in_half = total_records * bryan_interested_fraction
    ...
    bryan_offer_interested_half = records_in_half * bryan_price_interested_half
    ...
    bryan_offer_remaining_half = records_in_half * bryan_price_remaining_half

    # In total Bryan is willing to offer Peggy 600+100=<<600+100=700>>700 dollars for her entire record collection.
    bryan_total_offer = bryan_offer_interested_half + bryan_offer_remaining_half
