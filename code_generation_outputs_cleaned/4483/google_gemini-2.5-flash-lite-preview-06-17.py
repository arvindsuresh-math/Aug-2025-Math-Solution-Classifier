def solve(
    num_records: int = 200, # Peggy has 200 records
    sammy_offer_per_record: int = 4, # Sammy will buy all of them for 4 dollars each
    bryan_offer_per_record_interested: int = 6, # Bryan will offer 6 dollars each for the half that he is interested in
    bryan_offer_per_record_not_interested: int = 1 # Bryan will offer 1 dollar each for the remaining half that he is not interested in
):
    ...
    sammy_total_offer = num_records * sammy_offer_per_record
    ...
    bryan_offer_interested_half = half_records * bryan_offer_per_record_interested
    ...
    bryan_offer_not_interested_half = half_records * bryan_offer_per_record_not_interested

    # In total Bryan is willing to offer Peggy 600+100=<<600+100=700>>700 dollars for her entire record collection.
    bryan_total_offer = bryan_offer_interested_half + bryan_offer_not_interested_half
    ...
    # The final answer is the difference in profit between Sammy versus Bryan's deal
