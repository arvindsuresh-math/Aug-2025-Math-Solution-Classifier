def solve(
        sammy_price_per_record: int = 4, # Sammy will buy all of them for 4 dollars each
        bryan_price_first_half: int = 6, # Bryan will offer 6 dollars each for the half that he is interested in
        bryan_price_second_half: int = 1, # Bryan will offer 1 dollar each for the remaining half
    ...
    sammy_offer = num_records * sammy_price_per_record
    ...
    bryan_profit_first_half = records_in_half * bryan_price_first_half
    ...
    bryan_profit_second_half = records_in_half * bryan_price_second_half

    # In total Bryan is willing to offer Peggy 600+100=<<600+100=700>>700 dollars for her entire record collection.
    bryan_total_offer = bryan_profit_first_half + bryan_profit_second_half
    ...
    # The final answer is the difference in profit
