def solve(
    ...
    bryan_price_interested: int = 6,  # Bryan will offer 6 dollars each for half the records
    bryan_price_not_interested: int = 1  # Bryan will offer 1 dollar each for the remaining half
):
    ...
    sammy_total = num_records * sammy_price_per_record
