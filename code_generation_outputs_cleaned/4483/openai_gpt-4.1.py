def solve(
    ...
    price_per_record_bryan_interested: int = 6,  # Bryan will offer 6 dollars each for the half he is interested in
    price_per_record_bryan_not_interested: int = 1,  # Bryan will offer 1 dollar each for the remaining half
    ...
    bryan_interested_total = half_records * price_per_record_bryan_interested
    ...
    bryan_not_interested_total = half_records * price_per_record_bryan_not_interested
