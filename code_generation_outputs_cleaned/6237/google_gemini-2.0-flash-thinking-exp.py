def solve(
    ...
    hourly_tips: int = 12, # He also makes an average of $12 in tips each hour
    ...
    total_hours = hours_8_hour_shifts + hours_per_12_hour_shift
    ...
    # The final answer is the amount of taxes Brendan pays
    return taxes_paid