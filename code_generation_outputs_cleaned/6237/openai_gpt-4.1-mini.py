def solve(
    ...
    num_8_hour_shifts: int = 2,  # Brendan is scheduled for 2 8-hour shifts
    hours_per_8_hour_shift: int = 8,  # each 8-hour shift is 8 hours
    num_12_hour_shifts: int = 1,  # Brendan has 1 12-hour shift
    hours_per_12_hour_shift: int = 12,  # the 12-hour shift is 12 hours
    tips_per_hour: int = 12,  # Brendan makes an average of $12 in tips each hour
    tax_rate: float = 0.2,  # Brendan is supposed to pay 20% of his income in taxes
    tip_reporting_fraction: float = 1/3  # Brendan only reports 1/3rd of his tips to the IRS
):
    ...
    total_hours_8_shifts = num_8_hour_shifts * hours_per_8_hour_shift
    ...
    total_hours = total_hours_8_shifts + (num_12_hour_shifts * hours_per_12_hour_shift)
    ...
    total_wages = hourly_wage * total_hours
    ...
    reported_tips = total_tips * tip_reporting_fraction
    ...
    reported_income = total_wages + reported_tips
