def solve(
    ...
    hours_per_shift_1: int = 8,  # Brendan is scheduled for 2 8-hour shifts
    hours_per_shift_2: int = 8,
    hours_per_shift_3: int = 12,  # and 1 12-hour shift
    tips_per_hour: float = 12,  # Brendan makes an average of $12 in tips each hour
    tax_rate: float = 0.2,  # Brendan is supposed to pay 20% of his income in taxes
    tips_reported_fraction: float = 1/3  # Brendan only reports 1/3rd of his tips to the IRS
):
    ...
    total_hours_8_hour_shifts = hours_per_shift_1 * 2
    ...
    total_hours_worked = total_hours_8_hour_shifts + hours_per_shift_3
    ...
    taxes_owed = total_reported_income * tax_rate
