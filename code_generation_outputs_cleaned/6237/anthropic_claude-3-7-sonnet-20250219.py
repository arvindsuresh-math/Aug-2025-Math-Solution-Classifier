def solve(
    ...
    num_8hour_shifts: int = 2,  # He's scheduled for 2 8-hour shifts
    hours_per_regular_shift: int = 8,  # 8-hour shifts
    num_12hour_shifts: int = 1,  # 1 12-hour shift this week
    hours_per_long_shift: int = 12,  # 12-hour shift
    hourly_tips: int = 12,  # He makes an average of $12 in tips each hour
    ...
    hours_from_regular_shifts = num_8hour_shifts * hours_per_regular_shift
    ...
    total_hours = hours_from_regular_shifts + hours_per_long_shift
    ...
    total_tips = hourly_tips * total_hours
