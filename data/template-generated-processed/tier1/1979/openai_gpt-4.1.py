def solve():
    ...
    """
    # L1
    slices_per_watermelon = 40 # cuts a single watermelon into 40 slices
    black_seeds_per_slice = 20 # each slice has 20 black seeds
    total_black_seeds = black_seeds_per_slice * slices_per_watermelon

    # L2
    white_seeds_per_slice = 20 # each slice has 20 white seeds
