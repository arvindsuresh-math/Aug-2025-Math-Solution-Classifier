def solve():
    """Index: 2245.
    Returns: the number of lions in Londolozi after 1 year.
    """
    # L1
    ...
    # L3
    initial_lions = 100 # There are 100 lions in Londolozi at first
    total_lions = initial_lions + lions_added_in_year
