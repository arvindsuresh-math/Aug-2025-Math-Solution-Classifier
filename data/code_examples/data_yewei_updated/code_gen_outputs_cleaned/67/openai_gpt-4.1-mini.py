def solve(
    ...
    jesse_day_four_miles: int = 10,  # On day four Jesse runs 10 miles
    mia_avg_first_four_days: int = 3,  # Mia averages 3 miles a day over the first 4 days
    total_days: int = 7  # the race lasts a week (7 days)
):
    """Index: 67.
    Returns: the average of Jesse's and Mia's average miles they have to run over the final three days.
    """
    #: L1
