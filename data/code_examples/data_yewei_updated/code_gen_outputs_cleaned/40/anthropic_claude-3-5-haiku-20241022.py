def solve(
    ...
    #: L4
    discounted_tickets_total = discounted_ticket_price * discounted_tickets
    
    #: L5
    regular_tickets_total = ticket_price * discount_threshold
    
    #: L6
    total_cost = regular_tickets_total + discounted_tickets_total
