def solve(
    ...
    lawn_mowing_price: int = 15,  # He charges $15 to mow a lawn
    driveway_shoveling_price: int = 7,  # He charges $7 to shovel
    ...
    #: L2
    allowance_savings = monthly_allowance * months_saved

    #: L3
    lawn_mowing_earnings = lawns_mowed * lawn_mowing_price

    #: L4
    driveway_shoveling_earnings = total_saved - lawn_mowing_earnings - allowance_savings

    #: L5
    driveways_shoveled = driveway_shoveling_earnings // driveway_shoveling_price
