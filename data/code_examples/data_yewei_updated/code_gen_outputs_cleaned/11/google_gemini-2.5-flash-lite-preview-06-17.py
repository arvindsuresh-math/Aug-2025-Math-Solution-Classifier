def solve(
    ...
    """
    #: L1
    total_money_spent_and_change = shoe_cost + change_after_purchase

    #: L2
    total_allowance_saved = months_saving * allowance_per_month

    #: L3
    money_earned_mowing = num_lawns_mowed * charge_mow_lawn

    #: L4
    money_earned_shoveling = total_money_spent_and_change - total_allowance_saved - money_earned_mowing

    #: L5
    num_driveways_shoveled = money_earned_shoveling / charge_shovel_driveway
