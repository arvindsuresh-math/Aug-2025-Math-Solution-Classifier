def solve(
        ...
        lisa_fraction_of_total: float = 1/2, # half of the $60 was earned by Lisa
    ...
    """
    #: L1
    lisa_earnings = total_earnings * lisa_fraction_of_total
    ...
    answer = earnings_difference # FINAL ANSWER
    return answer