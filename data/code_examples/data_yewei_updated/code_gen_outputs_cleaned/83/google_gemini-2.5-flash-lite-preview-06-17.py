def solve(
    ...
    num_people: int = 2 # share them equally between themselves
):
    """Index: 83.
    Returns: the number of hats each person gets when they share them equally.
    """
    #: L1
    ...
    #: L5
    combined_hats = paityn_total_hats + zola_total_hats

    #: L6
    hats_per_person = combined_hats / num_people
