def solve(
    ...
    #: L2
    walk_hours_total = walk_hours_to_work * 2

    #: L3
    bike_hours_to_work = bike_time_one_way * bike_days_per_week

    #: L4
    bike_hours_total = bike_hours_to_work * 2

    #: L5
    total_hours = walk_hours_total + bike_hours_total
