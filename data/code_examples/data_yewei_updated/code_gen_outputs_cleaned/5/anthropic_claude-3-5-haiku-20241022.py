def solve(
    ...
    purple_flower_percentage: float = 0.8,  # 80% more of those in purple
    green_flower_percentage: float = 0.25  # 25% as many green flowers as yellow and purple
):
    """Index: 5.
    Returns: the total number of flowers in Mark's garden."""
    
    #: L1
    additional_purple_flowers = yellow_flowers * purple_flower_percentage
