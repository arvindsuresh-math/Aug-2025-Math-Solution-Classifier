def solve(
    ...
    fourth_turn_distance: int = 0,  # After the 4th turn, it immediately exits the tunnel
    total_ring_distance: int = 23  # The car has driven a total of 23 meters around the ring
):
    """Index: 32.
    ...
    #: L2
    third_turn_distance = total_ring_distance - known_distances
