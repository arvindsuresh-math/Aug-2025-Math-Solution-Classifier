def solve(
        piano_practice_minutes_per_day: int = 20, # practices the piano for 20 minutes a day
    ...
    """
    #: L1
    violin_practice_minutes_per_day = piano_practice_minutes_per_day * violin_practice_multiplier
    ...
    answer = total_practice_minutes_per_month # FINAL ANSWER
    return answer