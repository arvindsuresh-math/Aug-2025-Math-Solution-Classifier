def solve(
    ...
    num_cans_with_8_liters: int = 10, # 10 of the cans are holding 8 liters each
    ...
    """
    #: L1
    liters_in_first_cans = num_cans_with_8_liters * liters_per_can_8

    #: L2
    remaining_liters = total_liters - liters_in_first_cans
