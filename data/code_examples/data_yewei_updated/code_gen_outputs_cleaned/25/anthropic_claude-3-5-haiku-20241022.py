def solve(
    ...
    """
    #: L1
    first_batch_missed = (1 - first_batch_hit_fraction) * first_batch_balls

    #: L2
    next_batch_missed = (1 - next_batch_hit_fraction) * next_batch_balls

    #: L3
    total_missed_balls = first_batch_missed + next_batch_missed
