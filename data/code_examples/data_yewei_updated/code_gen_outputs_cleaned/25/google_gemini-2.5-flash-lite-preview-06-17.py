def solve(
    ...
    """
    #: L1
    first_batch_missed_fraction = 1 - first_batch_hit_fraction
    balls_missed_first_batch = first_batch_missed_fraction * first_batch_count

    #: L2
    second_batch_missed_fraction = 1 - second_batch_hit_fraction
    balls_missed_second_batch = second_batch_missed_fraction * second_batch_count

    #: L3
    total_balls_missed = balls_missed_first_batch + balls_missed_second_batch

    answer = total_balls_missed # FINAL ANSWER
    return answer