def solve(
    ...
    initial_download_size: int = 60  # first 60 megabytes download at initial rate
):
    """Index: 47.
    Returns: the total time in seconds to download the entire file."""
    #: L1
    initial_download_time = initial_download_size / initial_rate

    #: L2
    remaining_download_size = file_size - initial_download_size

    #: L3
    subsequent_download_time = remaining_download_size / subsequent_rate
