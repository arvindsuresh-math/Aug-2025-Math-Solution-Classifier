def solve(
        ...
        num_frozen_yoghurt_cartons: int = 4, # 4 cartons of frozen yoghurt
        cost_per_ice_cream_carton: int = 4, # Each carton of ice cream cost $4
        cost_per_frozen_yoghurt_carton: int = 1 # each carton of frozen yoghurt cost $1
    ):
    """Index: 53.
    ...
    #: L2
    cost_frozen_yoghurt = num_frozen_yoghurt_cartons * cost_per_frozen_yoghurt_carton

    #: L3
    difference_in_cost = cost_ice_cream - cost_frozen_yoghurt
