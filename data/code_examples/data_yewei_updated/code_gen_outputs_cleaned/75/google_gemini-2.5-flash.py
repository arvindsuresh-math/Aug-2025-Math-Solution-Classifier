def solve(
    ...
    """
    #: L1
    dale_toast_cost = dale_toast_slices * cost_toast_per_slice

    #: L2
    andrew_toast_cost = andrew_toast_slices * cost_toast_per_slice

    #: L3
    dale_eggs_cost = dale_eggs * cost_egg_per_egg

    #: L4
    andrew_eggs_cost = andrew_eggs * cost_egg_per_egg
