def solve(
    ...
    #: L4
    num_green_flowers = (percent_green_of_yellow_purple / 100) * total_yellow_purple # eval: 7.0 = (25 / 100) * 28.0

    #: L5
    total_flowers = total_yellow_purple + num_green_flowers # eval: 35.0 = 28.0 + 7.0
