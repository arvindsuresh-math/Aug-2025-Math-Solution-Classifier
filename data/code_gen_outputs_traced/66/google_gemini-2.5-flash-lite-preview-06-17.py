def solve(
    ...
    #: L4
    monthly_installment_payment = remaining_balance / 12 # eval: 65.0 = 780.0 / 12

    #: L5
    total_paid_in_installments = monthly_installment_payment * months_to_pay # eval: 260.0 = 65.0 * 4
