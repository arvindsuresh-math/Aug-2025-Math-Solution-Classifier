def solve(
    ...
    #: L3
    biking_time_to_work = biking_time_one_way * biking_days_per_week # eval: 2 = 1 * 2
    #: L4
    biking_time_round_trip = biking_time_to_work * 2 # eval: 4 = 2 * 2
    #: L5
    total_commute_time = walking_time_round_trip + biking_time_round_trip # eval: 16 = 12 + 4
    answer = total_commute_time  # FINAL ANSWER # eval: 16 = 16  # FINAL ANSWER
