def solve(
    ...
    """
    #: L1
    bobbie_last_name_length = jamie_last_name_length * bobbie_multiplier_of_jamie + bobbie_letters_removed # eval: 10 = 4 * 2 + 2
    #: L2
    samantha_last_name_length = bobbie_last_name_length - samantha_fewer_than_bobbie # eval: 7 = 10 - 3
