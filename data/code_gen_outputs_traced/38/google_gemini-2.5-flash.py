def solve(
    ...
    """
    #: L1
    total_water_ounces = num_people * party_cup_size # eval: 72 = 12 * 6
    #: L2
    ounces_of_tea_needed = total_water_ounces / mom_cup_size # eval: 9.0 = 72 / 8
    answer = ounces_of_tea_needed # FINAL ANSWER # eval: 9.0 = 9.0 # FINAL ANSWER
