def solve(
    ...
    #: L4
    money_from_shoveling = total_money_saved - total_allowance - money_from_mowing # eval: 35 = 110 - 15 - 60
    #: L5
    num_driveways_shoveled = money_from_shoveling / charge_shovel_driveway # eval: 5.0 = 35 / 7
    answer = num_driveways_shoveled # FINAL ANSWER # eval: 5.0 = 5.0 # FINAL ANSWER
