def solve(
    ...
    #: L3
    cost_dale_eggs = dale_num_eggs * cost_egg_per_egg # eval: 6 = 2 * 3
    #: L4
    cost_andrew_eggs = andrew_num_eggs * cost_egg_per_egg # eval: 6 = 2 * 3
    #: L5
    total_breakfast_cost = cost_dale_toast + cost_andrew_toast + cost_dale_eggs + cost_andrew_eggs # eval: 15 = 2 + 1 + 6 + 6
    answer = total_breakfast_cost # FINAL ANSWER # eval: 15 = 15 # FINAL ANSWER
