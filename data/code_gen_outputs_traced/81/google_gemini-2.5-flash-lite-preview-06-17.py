def solve(
    ...
    #: L5
    jeff_total_skips = jeff_round1 + jeff_round2 + jeff_round3 + jeff_round4 # eval: 56.0 = 15 + 13 + 20 + 8.0
    #: L6
    jeff_avg_skips = jeff_total_skips / 4 # eval: 14.0 = 56.0 / 4
    answer = jeff_avg_skips # FINAL ANSWER # eval: 14.0 = 14.0 # FINAL ANSWER
