def solve(
    ...
    #: L3
    combined_cost_shorts_shoes = cost_shorts + cost_shoes # eval: 55 = 35 + 20
    #: L4
    cost_tops_total = total_spent - combined_cost_shorts_shoes # eval: 20 = 75 - 55
    #: L5
    cost_per_top = cost_tops_total / num_tops # eval: 5.0 = 20 / 4
