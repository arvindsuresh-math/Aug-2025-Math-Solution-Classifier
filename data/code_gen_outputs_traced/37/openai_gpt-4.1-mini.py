def solve(
    ...
    #: L4
    total_bill = total_cost_hamburgers + total_cost_fries + total_cost_sodas + (cost_per_spaghetti * num_spaghetti) # eval: 25.0 = 15.0 + 4.8 + 2.5 + (2.7 * 1)
    #: L5
    amount_per_friend = total_bill / num_friends # eval: 5.0 = 25.0 / 5
    answer = amount_per_friend  # FINAL ANSWER # eval: 5.0 = 5.0  # FINAL ANSWER
