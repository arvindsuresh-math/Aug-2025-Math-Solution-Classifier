def solve(
    ...
    #: L3
    total_gumballs_purchased = gumballs_to_todd + gumballs_to_alisha + gumballs_to_bobby + gumballs_remaining # eval: 45 = 4 + 8 + 27 + 6
    answer = total_gumballs_purchased # FINAL ANSWER # eval: 45 = 45 # FINAL ANSWER
