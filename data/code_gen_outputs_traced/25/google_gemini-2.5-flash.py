def solve(
    ...
    balls_not_hit_first_set = fraction_not_hit_first_set * first_set_balls # eval: 60.0 = 0.6 * 100
    #: L2
    ...
    #: L3
    total_balls_not_hit = balls_not_hit_first_set + balls_not_hit_second_set # eval: 110.0 = 60.0 + 50.00000000000001
    answer = total_balls_not_hit # FINAL ANSWER # eval: 110.0 = 110.0 # FINAL ANSWER
