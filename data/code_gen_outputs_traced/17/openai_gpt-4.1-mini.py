def solve(
    ...
    #: L5
    pink_green_total = green_after_john + pink_after_john # eval: 19 = 3 + 16
    #: L6
    total_remaining = pink_green_total + yellow_hard_hats # eval: 43 = 19 + 24
    answer = total_remaining  # FINAL ANSWER # eval: 43 = 43  # FINAL ANSWER
