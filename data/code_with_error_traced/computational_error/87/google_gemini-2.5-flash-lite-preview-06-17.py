def solve(
    ...
    #: L1
    current_weight = 590.0 # eval: 590.0 = 590.0

    #: L2
    weight_gained = current_weight - initial_weight # eval: 190.0 = 590.0 - 400

    #: L3
    value_increase = weight_gained * price_per_pound # eval: 570.0 = 190.0 * 3
