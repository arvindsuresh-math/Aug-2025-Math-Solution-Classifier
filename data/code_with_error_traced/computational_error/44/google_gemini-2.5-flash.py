def solve(
    ...
    #: L1
    accommodation_cost = 151.0 # eval: 151.0 = 151.0
    ...
    #: L4
    coursework_materials_cost = budget - (accommodation_cost + food_cost + entertainment_cost) # eval: 299.0 = 1000 - (151.0 + 300.0 + 250.0)
