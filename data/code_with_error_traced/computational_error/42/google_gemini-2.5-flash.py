def solve(
    ...
    #: L2
    remaining_piles = 3 # eval: 3 = 3

    #: L3
    bananas_from_type2_piles = remaining_piles * hands_per_pile_type2 * bananas_per_hand_type2 # eval: 324 = 3 * 12 * 9

    #: L4
    total_bananas = bananas_from_type1_piles + bananas_from_type2_piles # eval: 1080 = 756 + 324

    #: L5
    bananas_per_monkey = total_bananas / num_monkeys # eval: 90.0 = 1080 / 12
