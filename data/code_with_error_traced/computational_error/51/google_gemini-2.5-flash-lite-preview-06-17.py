def solve(
    ...
    #: L2
    living_room_fabric_area = 25 # eval: 25 = 25

    #: L3
    bedroom_fabric_area = bedroom_length * bedroom_width # eval: 8 = 2 * 4

    #: L4
    fabric_left = total_fabric_area - living_room_fabric_area - bedroom_fabric_area # eval: 159 = 192 - 25 - 8

    #: FA
    answer = fabric_left
    return answer # eval: return 159
