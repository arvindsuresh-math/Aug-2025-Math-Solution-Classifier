def solve(
    ...
    #: L5
    total_coins_before_giving_away = coins_hour_1 + coins_hour_2_3 + coins_hour_2_3 + coins_hour_4 # eval: 135 = 15 + 35 + 35 + 50

    #: L6
    coins_after_giving_away = 121 # eval: 121 = 121

    #: FA
    answer = coins_after_giving_away
    return answer # eval: return 121
