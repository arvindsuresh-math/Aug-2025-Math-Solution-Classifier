def solve(
    ...
    #: L2
    hourly_wage_second_job = hourly_wage_main_job - wage_reduction_amount # eval: 16.0 = 20 - 4.0

    #: L3
    earnings_main_job = hourly_wage_main_job * hours_main_job # eval: 600 = 20 * 30

    #: L4
    hours_second_job = 16.0 # eval: 16.0 = 16.0

    #: L5
    earnings_second_job = hours_second_job * hourly_wage_second_job # eval: 256.0 = 16.0 * 16.0

    #: L6
    total_weekly_earnings = earnings_main_job + earnings_second_job # eval: 856.0 = 600 + 256.0

    #: FA
    answer = total_weekly_earnings
    return answer # eval: return 856.0
