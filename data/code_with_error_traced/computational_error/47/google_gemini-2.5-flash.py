def solve(
    ...
    #: L2
    remaining_megabytes = 31 # eval: 31 = 31

    #: L3
    time_second_part = remaining_megabytes / rate_second_part # eval: 3.1 = 31 / 10

    #: L4
    total_download_time = time_first_part + time_second_part # eval: 15.1 = 12.0 + 3.1

    #: FA
    answer = total_download_time
    return answer # eval: return 15.1
