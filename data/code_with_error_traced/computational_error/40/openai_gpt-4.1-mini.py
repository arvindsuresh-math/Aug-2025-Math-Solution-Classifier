def solve(
    ...
    #: L2
    discount_per_ticket = 3.0 # eval: 3.0 = 3.0

    #: L3
    discounted_ticket_price = ticket_price - discount_per_ticket # eval: 37.0 = 40 - 3.0

    #: L4
    total_discounted_tickets_cost = discounted_ticket_price * discounted_tickets # eval: 74.0 = 37.0 * 2
    ...
    #: L6
    total_cost = total_full_price_tickets_cost + total_discounted_tickets_cost # eval: 474.0 = 400 + 74.0

    #: FA
    answer = total_cost
    return answer # eval: return 474.0
