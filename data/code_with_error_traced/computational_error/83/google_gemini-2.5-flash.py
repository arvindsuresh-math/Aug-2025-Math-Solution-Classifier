def solve(
    ...
    #: L1
    paityn_total_hats = 43 # eval: 43 = 43
    ...
    #: L5
    combined_total_hats = zola_total_hats + paityn_total_hats # eval: 107.0 = 64.0 + 43

    #: L6
    hats_per_person = combined_total_hats / 2 # eval: 53.5 = 107.0 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 53.5
