def solve(
    ...
    #: L2
    next_batch_missed_balls = 51.00000000000001 # eval: 51.00000000000001 = 51.00000000000001

    #: L3
    total_missed_balls = first_batch_missed_balls + next_batch_missed_balls # eval: 111.0 = 60.0 + 51.00000000000001
