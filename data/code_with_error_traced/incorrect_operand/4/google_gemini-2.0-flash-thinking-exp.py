def solve(
    ...
    #: L2
    total_pages_per_week = pages_per_letter * num_friends # eval: 6 = 3 * 2

    #: L3
    total_pages_per_year = total_pages_per_week * weeks_per_year # eval: 312 = 6 * 52

    #: FA
    answer = total_pages_per_year
    return answer # eval: return 312
