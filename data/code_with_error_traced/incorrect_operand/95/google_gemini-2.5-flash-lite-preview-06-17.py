def solve(
    ...
    #: L4
    num_regular_nickels = total_nickels - value_quarter # eval: 99.75 = 100.0 - 0.25

    #: L5
    value_iron_nickels = num_iron_nickels * value_iron_nickel # eval: 60.0 = 20.0 * 3

    #: L6
    value_regular_nickels = num_regular_nickels * value_nickel # eval: 4.987500000000001 = 99.75 * 0.05

    #: L7
    total_value = value_iron_nickels + value_regular_nickels # eval: 64.9875 = 60.0 + 4.987500000000001

    #: FA
    answer = total_value
    return answer # eval: return 64.9875
