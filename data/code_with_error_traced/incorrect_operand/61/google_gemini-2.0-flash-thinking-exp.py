def solve(
    ...
    #: L4
    weight_from_salmon = remaining_weight_needed * weight_from_berries # eval: 80000.0 = 400.0 * 200.0

    #: L5
    weight_from_small_animals = remaining_weight_needed - weight_from_salmon # eval: -79600.0 = 400.0 - 80000.0

    #: FA
    answer = weight_from_small_animals
    return answer # eval: return -79600.0
