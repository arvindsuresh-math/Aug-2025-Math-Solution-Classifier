def solve(
    ...
    #: L1
    slices_from_large_pizzas = slices_per_small_pizza * slices_per_large_pizza # eval: 128 = 8 * 16

    #: L2
    slices_from_small_pizzas = num_small_pizzas * slices_per_small_pizza # eval: 16 = 2 * 8

    #: L3
    total_slices_eaten = slices_from_large_pizzas + slices_from_small_pizzas # eval: 144 = 128 + 16
