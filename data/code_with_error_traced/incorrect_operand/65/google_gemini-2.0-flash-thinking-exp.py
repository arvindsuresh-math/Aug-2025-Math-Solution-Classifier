def solve(
    ...
    #: L2
    earnings_from_tips = customers_tipped * lawns_mowed # eval: 48 = 3 * 16

    #: L3
    total_earnings = earnings_from_mowing + earnings_from_tips # eval: 576 = 528 + 48

    #: FA
    answer = total_earnings
    return answer # eval: return 576
