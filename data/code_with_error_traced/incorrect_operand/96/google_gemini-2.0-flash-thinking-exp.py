def solve(
    ...
    #: L2
    total_gallons_collected = total_rain_inches * price_per_gallon # eval: 8.4 = 7 * 1.2

    #: L3
    total_money_made = total_gallons_collected * price_per_gallon # eval: 10.08 = 8.4 * 1.2

    #: FA
    answer = total_money_made
    return answer # eval: return 10.08
