def solve(
    ...
    #: L1
    jolyn_older_than_aivo = jolyn_older_than_therese + leon_older_than_aivo # eval: 4 = 2 + 2

    #: L2
    jolyn_older_than_leon = jolyn_older_than_aivo - leon_older_than_aivo # eval: 2 = 4 - 2
