def solve(
    ...
    #: L3
    butter_used_chocolate_peanut = butter_for_peanut_butter + butter_for_peanut_butter # eval: 4.0 = 2.0 + 2.0

    #: L4
    remaining_butter_after_two_types = total_butter_kg - butter_used_chocolate_peanut # eval: 6.0 = 10 - 4.0

    #: L5
    butter_for_sugar_cookies = remaining_butter_after_two_types / 3 # eval: 2.0 = 6.0 / 3

    #: L6
    butter_left_final = remaining_butter_after_two_types - butter_for_sugar_cookies # eval: 4.0 = 6.0 - 2.0
