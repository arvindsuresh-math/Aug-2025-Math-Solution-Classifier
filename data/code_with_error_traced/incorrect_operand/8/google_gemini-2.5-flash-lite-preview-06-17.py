def solve(
    ...
    #: L2
    spent_on_clothes_without_shoes = belt_cost + pants_cost + coat_cost + socks_cost + belt_cost # eval: 131 = 18 + 46 + 38 + 11 + 18

    #: L3
    total_spent = budget - money_left # eval: 184 = 200 - 16

    #: L4
    shoes_cost = total_spent - spent_on_clothes_without_shoes # eval: 53 = 184 - 131
