def solve(
    ...
    #: L4
    overtime_hourly_rate = overtime_hours_per_shift + overtime_rate # eval: 11.0 = 2 + 9.0

    #: L5
    base_pay_total = base_pay_per_shift * days_worked # eval: 720.0 = 144.0 * 5

    #: L6
    overtime_pay_per_shift = overtime_hourly_rate * overtime_hours_per_shift # eval: 22.0 = 11.0 * 2

    #: L7
    overtime_pay_total = overtime_pay_per_shift * days_worked # eval: 110.0 = 22.0 * 5

    #: L8
    total_pay = base_pay_total + overtime_pay_total # eval: 830.0 = 720.0 + 110.0

    #: FA
    answer = total_pay
    return answer # eval: return 830.0
