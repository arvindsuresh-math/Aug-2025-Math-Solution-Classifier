def solve(
    ...
    #: L3
    bike_time_to_work_per_week = walk_days_per_week * bike_days_per_week # eval: 6 = 3 * 2

    #: L4
    total_bike_time_per_week = bike_time_to_work_per_week * 2 # eval: 12 = 6 * 2

    #: L5
    total_time_per_week = total_walk_time_per_week + total_bike_time_per_week # eval: 24 = 12 + 12
