def solve(
    ...
    #: L3
    bob_daily_savings = 0.5 * sally_daily_earnings # eval: 3.0 = 0.5 * 6

    #: L4
    bob_yearly_savings = bob_daily_savings * days_per_year # eval: 1095.0 = 3.0 * 365

    #: L5
    total_savings = sally_yearly_savings + bob_yearly_savings # eval: 2190.0 = 1095.0 + 1095.0
