def solve(
    ...
    #: L4
    bob_yearly_savings = bob_daily_savings * bob_daily_earnings # eval: 8.0 = 2.0 * 4

    #: L5
    total_saved = bob_yearly_savings + sally_yearly_savings # eval: 1103.0 = 8.0 + 1095.0

    #: FA
    answer = total_saved
    return answer # eval: return 1103.0
