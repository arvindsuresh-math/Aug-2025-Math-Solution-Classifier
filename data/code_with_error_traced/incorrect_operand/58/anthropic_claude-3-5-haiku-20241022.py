def solve(
    ...
    #: L4
    total_low_allowance = low_daily_allowance * low_daily_allowance # eval: 16 = 4 * 4

    #: L5
    total_daily_allowance = total_high_allowance + total_low_allowance # eval: 256.0 = 240.0 + 16
