def solve(
    ...
    #: L2
    months_to_save = total_months_in_year - chore_price # eval: 2 = 12 - 10

    #: L3
    monthly_savings_needed = total_baseball_supplies_cost / months_to_save # eval: 200.0 = 400 / 2

    #: L4
    chores_per_month = monthly_savings_needed / chore_price # eval: 20.0 = 200.0 / 10
