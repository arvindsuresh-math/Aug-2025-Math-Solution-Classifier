def solve(
    ...
    #: L1
    new_weight = price_per_pound * weight_increase_factor # eval: 4.5 = 3 * 1.5

    #: L2
    weight_gained = new_weight - starting_weight # eval: -395.5 = 4.5 - 400

    #: L3
    value_increase = weight_gained * price_per_pound # eval: -1186.5 = -395.5 * 3

    #: FA
    answer = value_increase
    return answer # eval: return -1186.5
