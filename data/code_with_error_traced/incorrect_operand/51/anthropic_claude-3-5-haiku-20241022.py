def solve(
    ...
    #: L1
    total_fabric_area = living_room_width * bolt_width # eval: 72 = 6 * 12
    ...
    #: L4
    fabric_left = total_fabric_area - living_room_curtain_area - bedroom_curtain_area # eval: 40 = 72 - 24 - 8
