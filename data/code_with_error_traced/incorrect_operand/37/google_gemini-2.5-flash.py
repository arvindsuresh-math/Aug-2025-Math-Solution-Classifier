def solve(
    ...
    #: L3
    cost_total_soda = cost_soda * cost_french_fries # eval: 0.6 = 0.5 * 1.2

    #: L4
    total_bill = cost_total_hamburgers + cost_total_french_fries + cost_total_soda + cost_spaghetti_platter # eval: 23.1 = 15 + 4.8 + 0.6 + 2.7

    #: L5
    cost_per_friend = total_bill / num_friends # eval: 4.62 = 23.1 / 5

    #: FA
    answer = cost_per_friend
    return answer # eval: return 4.62
