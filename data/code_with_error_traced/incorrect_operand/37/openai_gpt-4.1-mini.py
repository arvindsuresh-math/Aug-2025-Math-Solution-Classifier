def solve(
    ...
    #: L1
    total_cost_hamburgers = num_spaghetti * num_hamburgers # eval: 5 = 1 * 5
    ...
    #: L4
    total_bill = total_cost_hamburgers + total_cost_fries + total_cost_sodas + (cost_per_spaghetti * num_spaghetti) # eval: 15.0 = 5 + 4.8 + 2.5 + (2.7 * 1)

    #: L5
    amount_per_friend = total_bill / num_friends # eval: 3.0 = 15.0 / 5
