def solve(
    ...
    #: L4
    total_coefficient_s = coefficient_first_ship + coefficient_second_ship + total_people_consumed # eval: 850 = 1 + 2 + 847

    #: L5
    people_on_first_ship = total_people_consumed / total_coefficient_s # eval: 0.9964705882352941 = 847 / 850

    #: FA
    answer = people_on_first_ship
    return answer # eval: return 0.9964705882352941
