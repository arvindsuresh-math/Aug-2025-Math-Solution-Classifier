def solve(
    ...
    #: L4
    total_bill = total_cost_hamburgers + total_cost_fries + cost_per_spaghetti + (cost_per_spaghetti * num_spaghetti) # eval: 25.2 = 15.0 + 4.8 + 2.7 + (2.7 * 1)

    #: L5
    amount_per_friend = total_bill / num_friends # eval: 5.04 = 25.2 / 5

    #: FA
    answer = amount_per_friend
    return answer # eval: return 5.04
