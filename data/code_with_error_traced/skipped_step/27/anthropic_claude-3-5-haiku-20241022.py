def solve(
    ...
    #: L2
    first_round_valuable_files = first_download_files - first_download_files # eval: 0 = 800 - 800
    ...
    #: L5
    total_valuable_files = first_round_valuable_files + second_round_valuable_files # eval: 160.0 = 0 + 160.0
