def solve(
    ...
    #: L4
    total_shoveling_earnings = lawns_mowed - total_mowing_earnings - total_allowance # eval: -71 = 4 - 60 - 15

    #: L5
    driveways_shoveled = total_shoveling_earnings / shovel_driveway_charge # eval: -10.142857142857142 = -71 / 7

    #: FA
    answer = driveways_shoveled
    return answer # eval: return -10.142857142857142
