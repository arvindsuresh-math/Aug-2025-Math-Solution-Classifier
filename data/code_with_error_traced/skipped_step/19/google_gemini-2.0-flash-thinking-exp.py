def solve(
    ...
    #: L2
    weekly_work_distance = biking_speed * num_workdays # eval: 125 = 25 * 5

    #: L3
    total_weekly_distance = weekly_work_distance + weekend_ride_distance # eval: 325 = 125 + 200

    #: L4
    total_time_hours = total_weekly_distance / biking_speed # eval: 13.0 = 325 / 25
