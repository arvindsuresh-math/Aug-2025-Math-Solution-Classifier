def solve(
    ...
    #: L5
    remaining_pink_and_green = remaining_pink_after_john + carl_takes_pink # eval: 20 = 16 + 4

    #: L6
    total_remaining_hats = remaining_pink_and_green + initial_yellow_hats # eval: 44 = 20 + 24
