def solve(
    ...
    #: L1
    accommodation_cost = budget - accommodation_percentage # eval: 999.85 = 1000 - 0.15
    ...
    #: L4
    coursework_materials_cost = budget - (accommodation_cost + food_cost + entertainment_cost) # eval: -549.8499999999999 = 1000 - (999.85 + 300.0 + 250.0)

    #: FA
    answer = coursework_materials_cost
    return answer # eval: return -549.8499999999999
