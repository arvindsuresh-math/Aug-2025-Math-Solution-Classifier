def solve(
    ...
    #: L2
    allowance_saved = saving_months + allowance_per_month # eval: 8 = 3 + 5

    #: L3
    lawn_mowing_earnings = mowed_lawns * lawn_mowing_charge # eval: 60 = 4 * 15

    #: L4
    shoveling_earnings = total_saved - lawn_mowing_earnings - allowance_saved # eval: 42 = 110 - 60 - 8

    #: L5
    driveways_shoveled = shoveling_earnings / shoveling_charge # eval: 6.0 = 42 / 7
