def solve(
    ...
    #: L2
    num_students_low_allowance = total_students + num_students_high_allowance # eval: 100.0 = 60 + 40.0

    #: L3
    total_allowance_high = num_students_high_allowance * high_allowance # eval: 240.0 = 40.0 * 6

    #: L4
    total_allowance_low = num_students_low_allowance * low_allowance # eval: 400.0 = 100.0 * 4

    #: L5
    total_daily_allowance = total_allowance_high + total_allowance_low # eval: 640.0 = 240.0 + 400.0

    #: FA
    answer = total_daily_allowance
    return answer # eval: return 640.0
