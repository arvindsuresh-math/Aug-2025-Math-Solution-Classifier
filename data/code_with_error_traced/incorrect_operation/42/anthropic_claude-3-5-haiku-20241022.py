def solve(
    ...
    #: L1
    first_pile_total_bananas = first_pile_type_count + first_pile_hands * first_pile_bananas_per_hand # eval: 132 = 6 + 9 * 14

    #: L2
    second_pile_type_count = total_piles - first_pile_type_count # eval: 4 = 10 - 6

    #: L3
    second_pile_total_bananas = second_pile_type_count * second_pile_hands * second_pile_bananas_per_hand # eval: 432 = 4 * 12 * 9

    #: L4
    total_bananas = first_pile_total_bananas + second_pile_total_bananas # eval: 564 = 132 + 432

    #: L5
    bananas_per_monkey = total_bananas / total_monkeys # eval: 47.0 = 564 / 12
