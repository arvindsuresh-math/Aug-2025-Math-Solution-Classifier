def solve(
    ...
    #: L2
    months_to_save = total_months + season_length_months # eval: 16 = 12 + 4

    #: L3
    monthly_savings_goal = total_savings_needed / months_to_save # eval: 25.0 = 400 / 16

    #: L4
    chores_per_month = monthly_savings_goal / chore_charge # eval: 2.5 = 25.0 / 10
