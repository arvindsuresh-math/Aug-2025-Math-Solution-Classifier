def solve(
    ...
    #: L2
    weight_after_additional_jelly_beans = weight_after_brownies - additional_jelly_beans_weight # eval: 4 = 6 - 2

    #: L3
    final_weight = weight_after_additional_jelly_beans * gummy_worm_multiplier # eval: 8 = 4 * 2
