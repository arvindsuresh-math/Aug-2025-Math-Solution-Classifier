def solve(
    ...
    #: L2
    spent_on_known_items = shirt_cost * suit_pants_cost + suit_coat_cost + socks_cost + belt_cost # eval: 1447 = 30 * 46 + 38 + 11 + 18

    #: L3
    total_spent = budget - remaining_budget # eval: 184 = 200 - 16

    #: L4
    shoes_cost = total_spent - spent_on_known_items # eval: -1263 = 184 - 1447
