def solve(
    ...
    #: L1
    walk_time_to_work_week = walk_time_one_way - walk_trips_per_week # eval: -1 = 2 - 3

    #: L2
    walk_time_total_week = walk_time_to_work_week * 2 # eval: -2 = -1 * 2
    ...
    #: L5
    total_time_week = walk_time_total_week + bike_time_total_week # eval: 2 = -2 + 4
