def solve(
    ...
    #: L5
    total_coins_before_giving_away = coins_hour_1 * coins_hour_2_3 + coins_hour_2_3 + coins_hour_4 # eval: 610 = 15 * 35 + 35 + 50

    #: L6
    coins_after_giving_away = total_coins_before_giving_away - coins_given_to_coworker # eval: 595 = 610 - 15
