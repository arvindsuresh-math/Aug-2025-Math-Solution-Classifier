def solve(
    ...
    #: L4
    total_bill = total_cost_hamburgers * total_cost_fries + total_cost_sodas + cost_spaghetti # eval: 77.2 = 15 * 4.8 + 2.5 + 2.7

    #: L5
    cost_per_friend = total_bill / num_friends # eval: 15.440000000000001 = 77.2 / 5

    #: FA
    answer = cost_per_friend
    return answer # eval: return 15.440000000000001
