def solve(
    ...
    #: L2
    fries_total = fries_price + num_fries # eval: 5.2 = 1.2 + 4

    #: L3
    soda_total = soda_price * num_sodas # eval: 2.5 = 0.5 * 5

    #: L4
    total_bill = hamburger_total + fries_total + soda_total + spaghetti_price # eval: 25.4 = 15.0 + 5.2 + 2.5 + 2.7

    #: L5
    individual_share = total_bill / num_friends # eval: 5.08 = 25.4 / 5

    #: FA
    answer = individual_share
    return answer # eval: return 5.08
