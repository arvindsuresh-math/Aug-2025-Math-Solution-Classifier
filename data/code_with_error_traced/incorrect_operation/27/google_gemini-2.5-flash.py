def solve(
    ...
    #: L3
    non_useful_second_round = fraction_irrelevant_second_round + additional_files_downloaded # eval: 400.6 = 0.6 + 400

    #: L4
    valuable_second_round = additional_files_downloaded - non_useful_second_round # eval: -0.6000000000000227 = 400 - 400.6

    #: L5
    total_valuable_files = valuable_second_round + valuable_first_round # eval: 239.39999999999998 = -0.6000000000000227 + 240.0
