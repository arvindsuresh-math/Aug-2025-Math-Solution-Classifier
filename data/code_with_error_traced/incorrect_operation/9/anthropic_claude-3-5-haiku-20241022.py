def solve(
    ...
    #: L5
    base_pay_total = base_pay_per_shift + days_worked # eval: 149.0 = 144.0 + 5
    ...
    #: L8
    total_pay = base_pay_total + overtime_pay_total # eval: 419.0 = 149.0 + 270.0

    #: FA
    answer = total_pay
    return answer # eval: return 419.0
