def solve(
    ...
    #: L1
    time_part_2 = time_part_1 * time_multiplier_part_2 # eval: 50 = 25 * 2

    #: L2
    time_part_1_and_2 = time_part_1 + time_part_2 # eval: 75 = 25 + 50

    #: L3
    total_time_minutes = total_time_hours - 60 # eval: -58 = 2 - 60

    #: L4
    time_part_3 = total_time_minutes - time_part_1_and_2 # eval: -133 = -58 - 75

    #: FA
    answer = time_part_3
    return answer # eval: return -133
