def solve(
    ...
    #: L1
    second_part_time = first_part_time - second_part_multiplier # eval: 23 = 25 - 2

    #: L2
    first_and_second_part_time = first_part_time + second_part_time # eval: 48 = 25 + 23

    #: L3
    total_assignment_time = hours_to_complete * 60 # eval: 120 = 2 * 60

    #: L4
    third_part_time = total_assignment_time - first_and_second_part_time # eval: 72 = 120 - 48
