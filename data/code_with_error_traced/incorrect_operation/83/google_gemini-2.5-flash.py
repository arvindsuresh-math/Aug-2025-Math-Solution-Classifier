def solve(
    ...
    #: L2
    zola_red_hats = zola_red_hats_multiplier + paityn_red_hats # eval: 20.8 = 0.8 + 20

    #: L3
    zola_blue_hats = zola_blue_hats_multiplier * paityn_blue_hats # eval: 48 = 2 * 24

    #: L4
    zola_total_hats = zola_blue_hats + zola_red_hats # eval: 68.8 = 48 + 20.8

    #: L5
    combined_total_hats = zola_total_hats + paityn_total_hats # eval: 112.8 = 68.8 + 44

    #: L6
    hats_per_person = combined_total_hats / 2 # eval: 56.4 = 112.8 / 2
