def solve(
    ...
    #: L1
    jolyn_older_than_aivo = jolyn_older_than_therese * therese_older_than_aivo # eval: 10 = 2 * 5

    #: L2
    jolyn_older_than_leon = jolyn_older_than_aivo - leon_older_than_aivo # eval: 8 = 10 - 2
