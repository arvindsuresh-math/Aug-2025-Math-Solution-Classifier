def solve(
    ...
    #: L1
    second_person_loss = first_person_loss + difference_second_first # eval: 34 = 27 + 7

    #: L2
    remaining_weight_loss = total_weight_lost - first_person_loss - second_person_loss # eval: 42 = 103 - 27 - 34

    #: L3
    last_two_each_loss = remaining_weight_loss / 2 # eval: 21.0 = 42 / 2
