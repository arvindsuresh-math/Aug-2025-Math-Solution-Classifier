def solve(
    ...
    #: L2
    total_additional_cans = times_ratio_occurred + additional_cans_jennifer # eval: 16.0 = 10.0 + 6

    #: L3
    total_cans_jennifer = jennifer_initial_cans + total_additional_cans # eval: 56.0 = 40 + 16.0
