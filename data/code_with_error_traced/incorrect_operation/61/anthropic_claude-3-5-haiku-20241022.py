def solve(
    ...
    #: L2
    acorn_weight = acorn_multiplier - berry_weight # eval: -198.0 = 2 - 200.0

    #: L3
    remaining_weight = total_weight_needed - berry_weight - acorn_weight # eval: 998.0 = 1000 - 200.0 - -198.0

    #: L4
    salmon_weight = remaining_weight * salmon_fraction # eval: 499.0 = 998.0 * 0.5

    #: L5
    small_animals_weight = remaining_weight - salmon_weight # eval: 499.0 = 998.0 - 499.0

    #: FA
    answer = small_animals_weight
    return answer # eval: return 499.0
