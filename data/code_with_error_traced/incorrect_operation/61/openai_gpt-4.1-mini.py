def solve(
    ...
    #: L3
    remaining_weight_needed = total_weight_needed + weight_from_berries - weight_from_acorns # eval: 800.0 = 1000 + 200.0 - 400.0

    #: L4
    weight_from_salmon = remaining_weight_needed / 2 # eval: 400.0 = 800.0 / 2
