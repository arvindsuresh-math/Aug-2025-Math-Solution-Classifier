def solve(
    ...
    #: L3
    remaining_weight_after_berries_acorns = weight_needed_total + weight_from_berries - weight_from_acorns # eval: 800.0 = 1000 + 200.0 - 400.0

    #: L4
    weight_from_salmon = remaining_weight_after_berries_acorns * fraction_from_salmon # eval: 400.0 = 800.0 * 0.5

    #: L5
    weight_from_small_animals = remaining_weight_after_berries_acorns - weight_from_salmon # eval: 400.0 = 800.0 - 400.0
