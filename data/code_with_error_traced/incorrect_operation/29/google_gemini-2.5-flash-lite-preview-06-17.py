def solve(
    ...
    #: L8
    previous_monthly_income = (new_rent_utility_percentage * income_increase) / (previous_rent_utility_percentage + new_rent_utility_percentage) # eval: 230.76923076923077 = (0.25 * 600) / (0.4 + 0.25)

    #: FA
    answer = previous_monthly_income
    return answer # eval: return 230.76923076923077
