def solve(
    ...
    #: L4
    hours_watching_both_daughters_practice = hours_watching_one_daughter_practice - 2 # eval: 30 = 32 - 2

    #: L5
    total_hours = hours_watching_both_daughters_games + hours_watching_both_daughters_practice # eval: 62 = 32 + 30
