def solve(
    ...
    #: L1
    gnomes_in_first_four_houses = houses_with_known_gnomes + gnomes_per_known_house # eval: 7 = 4 + 3

    #: L2
    gnomes_in_fifth_house = total_gnomes - gnomes_in_first_four_houses # eval: 13 = 20 - 7
