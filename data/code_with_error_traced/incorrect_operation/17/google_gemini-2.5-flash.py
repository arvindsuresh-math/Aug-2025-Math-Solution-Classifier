def solve(
    ...
    #: L2
    pink_hats_after_john = pink_hats_after_carl + john_removed_pink # eval: 28 = 22 + 6
    ...
    #: L5
    remaining_pink_and_green_hats = remaining_green_hats + pink_hats_after_john # eval: 31 = 3 + 28

    #: L6
    total_remaining_hard_hats = remaining_pink_and_green_hats + initial_yellow_hard_hats # eval: 55 = 31 + 24

    #: FA
    answer = total_remaining_hard_hats
    return answer # eval: return 55
