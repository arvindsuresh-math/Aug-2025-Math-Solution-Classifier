def solve(
    ...
    #: L2
    hourly_wage_second = hourly_wage_main + wage_reduction # eval: 24.0 = 20 + 4.0
    ...
    #: L5
    earnings_second = hours_second_job * hourly_wage_second # eval: 360.0 = 15.0 * 24.0

    #: L6
    total_earnings = earnings_main + earnings_second # eval: 960.0 = 600 + 360.0
