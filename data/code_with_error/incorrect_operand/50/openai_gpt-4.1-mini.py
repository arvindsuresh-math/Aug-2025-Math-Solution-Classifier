def solve(
    ...
    #: L1
    total_savings_needed = season_length_months * monthly_supplies_cost

    #: L2
    months_to_save = season_length_months - season_length_months

    #: L3
    monthly_savings_goal = total_savings_needed / months_to_save

    #: L4
    chores_per_month = monthly_savings_goal / chore_charge
