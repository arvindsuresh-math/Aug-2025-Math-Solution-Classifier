def solve(
    ...
    #: L1
    weight_lost_person2 = weight_lost_person1 - weight_diff_person2

    #: L2
    weight_lost_remaining = num_people - weight_lost_person1 - weight_lost_person2

    #: L3
    weight_lost_each_remaining = weight_lost_remaining / num_remaining_people
