def solve(
    ...
    #: L1
    weight_after_brownies = initial_jelly_beans * brownies_multiplier

    #: L2
    weight_after_additional_jelly_beans = weight_after_brownies + additional_jelly_beans

    #: L3
    final_weight = weight_after_additional_jelly_beans * weight_after_brownies
