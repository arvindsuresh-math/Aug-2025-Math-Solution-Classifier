def solve(
    ...
    #: L1
    hours_watching_one_daughter_games = games_per_daughter * game_duration

    #: L2
    hours_watching_both_daughters_games = hours_watching_one_daughter_games * num_daughters
    ...
    #: L5
    total_hours_at_field = hours_watching_one_daughter_practice + hours_watching_both_daughters_practice
