def solve(
    ...
    #: L1
    cost_reese = num_reese_bags * cost_per_reese_bag

    #: L2
    cost_snickers = num_snickers_bags * cost_per_snickers_bag

    #: L3
    cost_skittles = num_skittles_bags * cost_per_skittles_bag

    #: L4
    total_cost = pinata_cost + cost_reese + num_snickers_bags + cost_skittles
