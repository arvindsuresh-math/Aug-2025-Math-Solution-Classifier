def solve(
    ...
    #: L1
    total_fabric_area = living_room_width * bolt_width

    #: L2
    living_room_curtain_area = living_room_length * living_room_width

    #: L3
    bedroom_curtain_area = bedroom_length * bedroom_width

    #: L4
    fabric_left = total_fabric_area - living_room_curtain_area - bedroom_curtain_area
