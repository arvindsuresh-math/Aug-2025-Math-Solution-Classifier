def solve(
    ...
    #: L1
    earnings_large_paintings_last_month = large_painting_price * large_paintings_sold_last_month

    #: L2

    #: L3
    total_sales_last_month = earnings_large_paintings_last_month + large_painting_price
