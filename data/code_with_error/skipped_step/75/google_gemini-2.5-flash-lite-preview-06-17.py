def solve(
    ...
    #: L1
    dale_toast_cost = dale_toast * toast_cost

    #: L2
    andrew_toast_cost = andrew_toast * toast_cost

    #: L3
    dale_eggs_cost = dale_eggs * egg_cost

    #: L4

    #: L5
    total_cost = dale_toast_cost + andrew_toast_cost + dale_eggs_cost + dale_toast
