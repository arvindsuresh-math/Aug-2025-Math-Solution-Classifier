def solve(
    ...
    #: L1
    gallons_in_second_tank = gallons_in_first_tank / ratio_first_to_second_tank
    ...
    #: L4
    num_fish_first_tank_after_eating = ratio_first_to_second_tank - fish_eaten_in_first_tank
