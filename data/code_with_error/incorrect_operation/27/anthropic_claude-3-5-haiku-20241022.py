def solve(
    ...
    #: L1
    first_round_non_valuable_files = first_download_files * first_download_delete_percent

    #: L2
    first_round_valuable_files = first_download_files - first_round_non_valuable_files

    #: L3
    second_round_non_valuable_files = second_download_files + second_download_delete_fraction

    #: L4
    second_round_valuable_files = second_download_files - second_round_non_valuable_files
