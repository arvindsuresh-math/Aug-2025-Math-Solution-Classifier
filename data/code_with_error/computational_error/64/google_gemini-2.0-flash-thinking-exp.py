def solve(
    ...
    #: L1
    second_job_pay_reduction_amount = main_job_hourly_rate * (second_job_pay_reduction_percent / 100)

    #: L2
    second_job_hourly_rate = main_job_hourly_rate - second_job_pay_reduction_amount

    #: L3
    main_job_earnings = 590
