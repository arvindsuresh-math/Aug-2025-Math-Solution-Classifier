def solve():
    """Index: 2739.
    Returns: the total value of gold the three have together.
    """
    # L1
    legacy_bars = 5 # Legacy has 5 bars of gold
    aleena_fewer_bars = 2 # Aleena has 2 bars fewer than she has
    aleena_bars = legacy_bars - aleena_fewer_bars
