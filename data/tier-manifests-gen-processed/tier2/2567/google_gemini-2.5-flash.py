def solve():
    """Index: 2567.
    Returns: the total amount of money Hank donates.
    """
    # L1
    ...
    bake_sale_donation_percent = 0.75 # donates 75% of the proceeds
    bake_sale_donation = bake_sale_proceeds * bake_sale_donation_percent
