...
def solve():
    """Index: 83.
    Returns: the number of hats each person gets after sharing equally.
    """
    # L1
    ...
    # L2
    zola_red_fraction = Fraction(4, 5) # 4/5 times as many red hats
    zola_red_hats = zola_red_fraction * paityn_red_hats

    # L3
    zola_blue_multiplier = 2 # twice the number of blue hats
    ...
    # L6
    people = 2 # 2 people
    hats_per_person = combined_hats / people
