def solve(
    ...
    #: L1
    person2_lost = person1_lost - person2_weight_difference

    #: L2
    weight_lost_by_last_two = total_weight_lost - person1_lost - person2_lost

    #: L3
    weight_lost_per_person_last_two = weight_lost_by_last_two / (num_people - 2)

    answer = weight_lost_per_person_last_two # FINAL ANSWER
    return answer