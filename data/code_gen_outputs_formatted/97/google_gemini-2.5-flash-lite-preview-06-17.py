def solve(
    ...
    #: L1
    num_mystery_books = num_western_novels + num_biographies

    #: L2
    total_books = num_history_books + num_romance_books + num_poetry_books + num_mystery_books + num_western_novels + num_biographies
