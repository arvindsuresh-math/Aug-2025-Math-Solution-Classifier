def solve(
    ...
    #: L1
    non_valuable_files_first_round = initial_files_downloaded * percentage_deleted_first_round

    #: L2
    valuable_files_first_round = initial_files_downloaded - non_valuable_files_first_round

    #: L3
    non_valuable_files_second_round = additional_files_downloaded * fraction_deleted_second_round

    #: L4
    valuable_files_second_round = additional_files_downloaded - non_valuable_files_second_round
