def solve(
    ...
    #: L1
    bananas_from_type1_piles = piles_type1 * hands_per_pile_type1 * bananas_per_hand_type1

    #: L2
    remaining_piles = total_piles - piles_type1

    #: L3
    bananas_from_type2_piles = remaining_piles * hands_per_pile_type2 * bananas_per_hand_type2

    #: L4
    total_bananas = bananas_from_type1_piles + bananas_from_type2_piles
