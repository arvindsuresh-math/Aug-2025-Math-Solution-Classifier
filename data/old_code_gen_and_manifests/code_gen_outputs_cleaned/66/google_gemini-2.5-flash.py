def solve(
    ...
    #: L4
    # The solution implies a 12-month payment plan for the remaining balance.
    monthly_payment_calculated = remaining_balance_initial / 12

    #: L5
    total_paid_4_months = monthly_payment_calculated * months_paid
