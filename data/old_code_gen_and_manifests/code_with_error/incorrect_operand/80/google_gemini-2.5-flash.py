def solve(
    ...
    #: L1
    times_jennifer_added = mark_total_cans / jennifer_additional_cans_per_ratio

    #: L2
    total_additional_cans_jennifer = times_jennifer_added * jennifer_additional_cans_per_ratio

    #: L3
    total_cans_jennifer_brought_home = jennifer_initial_cans + total_additional_cans_jennifer
