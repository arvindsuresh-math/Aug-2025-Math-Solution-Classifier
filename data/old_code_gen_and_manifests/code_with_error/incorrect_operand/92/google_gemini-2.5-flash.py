def solve(
    ...
    #: L1
    sally_daily_savings = fraction_saved * sally_daily_earnings

    #: L2
    sally_yearly_savings = sally_daily_savings * days_in_year

    #: L3
    bob_daily_savings = fraction_saved * bob_daily_earnings

    #: L4
    bob_yearly_savings = bob_daily_savings * bob_daily_earnings
