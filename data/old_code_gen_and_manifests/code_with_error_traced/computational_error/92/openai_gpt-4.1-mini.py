def solve(
    ...
    #: L4
    bob_yearly_savings = 729.0 # eval: 729.0 = 729.0

    #: L5
    total_savings = sally_yearly_savings + bob_yearly_savings # eval: 1824.0 = 1095.0 + 729.0

    #: FA
    answer = total_savings
    return answer # eval: return 1824.0
