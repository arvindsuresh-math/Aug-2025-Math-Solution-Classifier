def solve(
    ...
    #: L2
    allowance_saved = 14 # eval: 14 = 14

    #: L3
    lawn_mowing_earnings = mowed_lawns * lawn_mowing_charge # eval: 60 = 4 * 15

    #: L4
    shoveling_earnings = total_saved - lawn_mowing_earnings - allowance_saved # eval: 36 = 110 - 60 - 14

    #: L5
    driveways_shoveled = shoveling_earnings / shoveling_charge # eval: 5.142857142857143 = 36 / 7

    #: FA
    answer = driveways_shoveled
    return answer # eval: return 5.142857142857143
