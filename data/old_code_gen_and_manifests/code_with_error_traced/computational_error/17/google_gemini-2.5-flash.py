def solve(
    ...
    #: L2
    pink_hats_after_john = 26 # eval: 26 = 26
    ...
    #: L5
    remaining_pink_and_green_hats = remaining_green_hats + pink_hats_after_john # eval: 29 = 3 + 26

    #: L6
    total_remaining_hard_hats = remaining_pink_and_green_hats + initial_yellow_hard_hats # eval: 53 = 29 + 24
