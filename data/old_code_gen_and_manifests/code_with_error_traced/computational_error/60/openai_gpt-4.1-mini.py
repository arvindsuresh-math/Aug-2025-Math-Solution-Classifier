def solve(
    ...
    #: L4
    hours_watching_both_daughters_practice = 54 # eval: 54 = 54

    #: L5
    total_hours = hours_watching_both_daughters_games + hours_watching_both_daughters_practice # eval: 86 = 32 + 54

    #: FA
    answer = total_hours
    return answer # eval: return 86
