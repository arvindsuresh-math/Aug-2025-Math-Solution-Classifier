def solve(
    ...
    #: L3
    total_high_allowance = 241.0 # eval: 241.0 = 241.0

    #: L4
    total_low_allowance = num_students_low_allowance * low_daily_allowance # eval: 80.0 = 20.0 * 4

    #: L5
    total_daily_allowance = total_high_allowance + total_low_allowance # eval: 321.0 = 241.0 + 80.0

    #: FA
    answer = total_daily_allowance
    return answer # eval: return 321.0
