def solve(
    ...
    #: L2
    total_practice_minutes_per_day = 70 # eval: 70 = 70

    #: L3
    total_practice_minutes_per_week = total_practice_minutes_per_day * practice_days_per_week # eval: 420 = 70 * 6

    #: L4
    total_practice_minutes_per_month = total_practice_minutes_per_week * weeks_per_month # eval: 1680 = 420 * 4

    #: FA
    answer = total_practice_minutes_per_month
    return answer # eval: return 1680
