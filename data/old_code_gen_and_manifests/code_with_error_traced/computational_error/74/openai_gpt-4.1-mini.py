def solve(
    ...
    #: L1
    second_person_loss = 19 # eval: 19 = 19

    #: L2
    remaining_weight_loss = total_weight_lost - first_person_loss - second_person_loss # eval: 57 = 103 - 27 - 19

    #: L3
    last_two_each_loss = remaining_weight_loss / 2 # eval: 28.5 = 57 / 2

    #: FA
    answer = last_two_each_loss
    return answer # eval: return 28.5
