def solve(
    ...
    #: L4
    zola_total_hats = 74.0 # eval: 74.0 = 74.0

    #: L5
    combined_hats = zola_total_hats + paityn_total_hats # eval: 118.0 = 74.0 + 44

    #: L6
    hats_per_person = combined_hats / 2 # eval: 59.0 = 118.0 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 59.0
