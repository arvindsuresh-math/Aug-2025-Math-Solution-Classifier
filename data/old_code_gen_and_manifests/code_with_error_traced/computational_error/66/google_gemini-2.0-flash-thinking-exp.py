def solve(
    ...
    #: L3
    remaining_balance_after_down_payment = 781.0 # eval: 781.0 = 781.0

    #: L5
    total_paid_in_installments = monthly_installment * months_paid # eval: 260 = 65 * 4

    #: L6
    balance_after_installments = remaining_balance_after_down_payment - total_paid_in_installments # eval: 521.0 = 781.0 - 260
