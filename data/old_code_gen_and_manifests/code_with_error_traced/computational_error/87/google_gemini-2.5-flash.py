def solve(
    ...
    #: L1
    final_weight = 601.0 # eval: 601.0 = 601.0

    #: L2
    weight_gained = final_weight - initial_weight # eval: 201.0 = 601.0 - 400

    #: L3
    increased_value = weight_gained * price_per_pound # eval: 603.0 = 201.0 * 3
