def solve(
    ...
    #: L1
    regular_pay_per_shift = 134.0 # eval: 134.0 = 134.0
    ...
    #: L5
    regular_pay_total = regular_pay_per_shift * days_worked # eval: 670.0 = 134.0 * 5
    ...
    #: L8
    total_earnings = regular_pay_total + overtime_pay_total # eval: 940.0 = 670.0 + 270.0

    #: FA
    answer = total_earnings
    return answer # eval: return 940.0
