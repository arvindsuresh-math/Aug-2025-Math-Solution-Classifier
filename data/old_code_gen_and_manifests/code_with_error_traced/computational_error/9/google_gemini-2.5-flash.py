def solve(
    ...
    #: L6
    daily_overtime_pay = 53.0 # eval: 53.0 = 53.0

    #: L7
    total_overtime_pay_5_days = daily_overtime_pay * num_work_days # eval: 265.0 = 53.0 * 5

    #: L8
    total_earnings = total_base_pay_5_days + total_overtime_pay_5_days # eval: 985.0 = 720.0 + 265.0

    #: FA
    answer = total_earnings
    return answer # eval: return 985.0
