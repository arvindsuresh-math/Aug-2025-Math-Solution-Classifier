def solve(
    ...
    #: L1
    total_work_hours_with_bonus = work_hours_no_bonus + extra_work_hours # eval: 10 = 8 + 2

    #: L2
    total_daily_pay_with_bonus = 101 # eval: 101 = 101

    #: L3
    hourly_rate_with_bonus = total_daily_pay_with_bonus / total_work_hours_with_bonus # eval: 10.1 = 101 / 10

    #: FA
    answer = hourly_rate_with_bonus
    return answer # eval: return 10.1
