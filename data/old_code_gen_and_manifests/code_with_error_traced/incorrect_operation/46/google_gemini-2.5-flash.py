def solve(
    ...
    #: L3
    total_practice_minutes_per_week = total_practice_minutes_per_day - practice_days_per_week # eval: 74 = 80 - 6

    #: L4
    total_practice_minutes_per_month = total_practice_minutes_per_week * weeks_per_month # eval: 296 = 74 * 4

    #: FA
    answer = total_practice_minutes_per_month
    return answer # eval: return 296
