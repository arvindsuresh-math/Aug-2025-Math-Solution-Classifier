def solve(
    ...
    #: L4
    overtime_rate = hourly_wage * overtime_extra_per_hour # eval: 162.0 = 18.0 * 9.0

    #: L5
    total_base_pay = regular_shift_pay * num_days # eval: 720.0 = 144.0 * 5

    #: L6
    overtime_pay_per_day = overtime_rate * overtime_hours_per_day # eval: 324.0 = 162.0 * 2

    #: L7
    total_overtime_pay = overtime_pay_per_day * num_days # eval: 1620.0 = 324.0 * 5

    #: L8
    total_pay = total_base_pay + total_overtime_pay # eval: 2340.0 = 720.0 + 1620.0

    #: FA
    answer = total_pay
    return answer # eval: return 2340.0
