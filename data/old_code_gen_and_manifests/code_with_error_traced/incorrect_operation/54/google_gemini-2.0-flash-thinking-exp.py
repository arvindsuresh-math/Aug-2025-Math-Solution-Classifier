def solve(
    ...
    #: L2
    money_left_after_milkshake = initial_earnings + money_spent_on_milkshake # eval: 32.0 = 28 + 4.0

    #: L3
    money_in_wallet = money_left_after_milkshake * (1 - fraction_saved) # eval: 16.0 = 32.0 * (1 - 0.5)

    #: L4
    money_lost = money_in_wallet - money_left_after_dog # eval: 15.0 = 16.0 - 1
