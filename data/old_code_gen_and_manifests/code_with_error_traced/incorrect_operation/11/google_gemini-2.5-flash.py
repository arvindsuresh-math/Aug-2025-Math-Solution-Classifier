def solve(
    ...
    #: L4
    money_from_shoveling_driveways = total_money_saved + money_from_mowing_lawns - money_from_allowance # eval: 155 = 110 + 60 - 15

    #: L5
    num_driveways_shoveled = money_from_shoveling_driveways / driveway_shoveling_charge # eval: 22.142857142857142 = 155 / 7

    #: FA
    answer = num_driveways_shoveled
    return answer # eval: return 22.142857142857142
