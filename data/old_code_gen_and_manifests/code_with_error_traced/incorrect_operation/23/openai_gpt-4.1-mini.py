def solve(
    ...
    #: L3
    total_shorts_and_shoes = total_shorts_cost * total_shoes_cost # eval: 700 = 35 * 20

    #: L4
    remaining_amount = total_spent - total_shorts_and_shoes # eval: -625 = 75 - 700

    #: L5
    cost_per_top = remaining_amount / num_tops # eval: -156.25 = -625 / 4
