def solve(
    ...
    #: L4
    cost_tops_total = total_spent + combined_cost_shorts_shoes # eval: 130 = 75 + 55

    #: L5
    cost_per_top = cost_tops_total / num_tops # eval: 32.5 = 130 / 4

    #: FA
    answer = cost_per_top
    return answer # eval: return 32.5
