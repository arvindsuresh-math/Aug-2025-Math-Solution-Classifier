def solve(
    ...
    #: L1
    oil_in_specific_cans = num_cans_holding_specific_amount + liters_per_specific_can # eval: 18 = 10 + 8

    #: L2
    remaining_oil = total_oil_liters - oil_in_specific_cans # eval: 272 = 290 - 18

    #: L3
    remaining_cans = total_cans - num_cans_holding_specific_amount # eval: 14 = 24 - 10

    #: L4
    liters_per_remaining_can = remaining_oil / remaining_cans # eval: 19.428571428571427 = 272 / 14
