def solve(
    ...
    #: L2
    pages_read_per_hour = pages_read_in_20_min + sets_of_20_min_in_an_hour # eval: 11.0 = 8 + 3.0

    #: L3
    hours_to_read_120_pages = pages_to_read / pages_read_per_hour # eval: 10.909090909090908 = 120 / 11.0
