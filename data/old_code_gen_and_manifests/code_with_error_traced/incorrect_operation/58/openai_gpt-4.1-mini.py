def solve(
    ...
    #: L4
    total_allowance_four_dollars = students_with_four_dollars - allowance_four_dollars # eval: 16.0 = 20.0 - 4

    #: L5
    total_daily_allowance = total_allowance_six_dollars + total_allowance_four_dollars # eval: 256.0 = 240.0 + 16.0

    #: FA
    answer = total_daily_allowance
    return answer # eval: return 256.0
