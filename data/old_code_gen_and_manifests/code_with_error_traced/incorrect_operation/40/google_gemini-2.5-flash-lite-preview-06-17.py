def solve(
    ...
    #: L4
    cost_of_discounted_tickets = discounted_ticket_price - discountable_tickets # eval: 36.0 = 38.0 - 2

    #: L5
    cost_of_full_price_tickets = ticket_price * discountable_tickets # eval: 80 = 40 * 2

    #: L6
    total_cost = cost_of_full_price_tickets + cost_of_discounted_tickets # eval: 116.0 = 80 + 36.0

    #: FA
    answer = total_cost
    return answer # eval: return 116.0
