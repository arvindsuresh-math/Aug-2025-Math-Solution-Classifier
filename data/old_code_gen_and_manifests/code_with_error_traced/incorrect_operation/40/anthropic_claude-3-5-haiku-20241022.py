def solve(
    ...
    #: L4
    total_discounted_tickets_cost = discounted_ticket_price - discounted_tickets # eval: 36.0 = 38.0 - 2

    #: L5
    total_regular_tickets_cost = ticket_price * discount_threshold # eval: 400 = 40 * 10

    #: L6
    total_cost = total_regular_tickets_cost + total_discounted_tickets_cost # eval: 436.0 = 400 + 36.0

    #: FA
    answer = total_cost
    return answer # eval: return 436.0
