def solve(
    ...
    #: L3
    total_sales_last_month = sales_large_last_month * sales_small_last_month # eval: 57600 = 480 * 120

    #: L4
    total_sales_this_month = total_sales_last_month * multiplier_this_month # eval: 115200 = 57600 * 2

    #: FA
    answer = total_sales_this_month
    return answer # eval: return 115200
