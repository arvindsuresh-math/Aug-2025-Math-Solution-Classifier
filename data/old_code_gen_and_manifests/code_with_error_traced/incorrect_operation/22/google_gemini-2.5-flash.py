def solve(
    ...
    #: L1
    bobbie_last_name_length = jamie_last_name_length - bobbie_length_multiplier + bobbie_letters_off # eval: 4 = 4 - 2 + 2

    #: L2
    samantha_last_name_length = bobbie_last_name_length - samantha_fewer_letters # eval: 1 = 4 - 3
