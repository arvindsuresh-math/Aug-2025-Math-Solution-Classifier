def solve(
    ...
    #: L1
    weight_after_brownies = initial_weight * 3 # eval: 6 = 2 * 3

    #: L2
    weight_after_more_jelly_beans = weight_after_brownies - added_jelly_beans # eval: 4 = 6 - 2

    #: L3
    final_weight = weight_after_more_jelly_beans * 2 # eval: 8 = 4 * 2
