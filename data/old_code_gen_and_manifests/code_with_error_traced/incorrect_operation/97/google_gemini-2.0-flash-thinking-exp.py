def solve(
    ...
    #: L1
    mystery_books = western_novels * biographies # eval: 30 = 5 * 6

    #: L2
    total_books = history_books + romance_books + poetry_books + mystery_books + western_novels + biographies # eval: 65 = 12 + 8 + 4 + 30 + 5 + 6
