def solve(
    ...
    #: L5
    total_profit_from_sales = weekly_profit + number_of_weeks # eval: 22520.0 = 22500.0 + 20

    #: L6
    net_profit = total_profit_from_sales - movie_creation_cost # eval: 20520.0 = 22520.0 - 2000

    #: FA
    answer = net_profit
    return answer # eval: return 20520.0
