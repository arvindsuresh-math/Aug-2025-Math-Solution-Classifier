def solve(
    ...
    #: L5
    total_profit_before_cost = weekly_profit - number_of_weeks # eval: 22480.0 = 22500.0 - 20

    #: L6
    total_profit_after_cost = total_profit_before_cost - movie_creation_cost # eval: 20480.0 = 22480.0 - 2000

    #: FA
    answer = total_profit_after_cost
    return answer # eval: return 20480.0
