def solve(
    ...
    #: L3
    green_john_took = john_takes_pink + john_takes_green_multiplier # eval: 8 = 6 + 2

    #: L4
    remaining_green_after_john = initial_green_hard_hats - green_john_took # eval: 7 = 15 - 8

    #: L5
    total_pink_green_remaining = remaining_green_after_john + remaining_pink_after_john # eval: 23 = 7 + 16

    #: L6
    total_remaining_hard_hats = total_pink_green_remaining + initial_yellow_hard_hats # eval: 47 = 23 + 24
