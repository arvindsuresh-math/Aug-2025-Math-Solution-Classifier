def solve(
    ...
    #: L4
    num_fish_first_tank_after_eating = num_fish_first_tank + fish_eaten_in_first_tank # eval: 17.0 = 16.0 + 1

    #: L5
    difference_in_fish = num_fish_first_tank_after_eating - num_fish_second_tank # eval: 5.0 = 17.0 - 12.0
