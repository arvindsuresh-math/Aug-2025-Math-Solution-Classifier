def solve(
    ...
    #: L4
    final_fish_in_first_tank = initial_fish_in_first_tank + fish_eaten_in_first_tank # eval: 17.0 = 16.0 + 1

    #: L5
    more_fish_in_first_tank = final_fish_in_first_tank - fish_in_second_tank # eval: 5.0 = 17.0 - 12.0
