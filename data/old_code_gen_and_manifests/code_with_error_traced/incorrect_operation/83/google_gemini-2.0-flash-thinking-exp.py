def solve(
    ...
    #: L2
    zola_red_hats = zola_red_hat_factor - paityn_red_hats # eval: -19.2 = 0.8 - 20

    #: L3
    zola_blue_hats = zola_blue_hat_factor * paityn_blue_hats # eval: 48 = 2 * 24

    #: L4
    zola_total_hats = zola_blue_hats + zola_red_hats # eval: 28.8 = 48 + -19.2

    #: L5
    combined_hats = zola_total_hats + paityn_total_hats # eval: 72.8 = 28.8 + 44

    #: L6
    hats_per_person = combined_hats / num_people_sharing # eval: 36.4 = 72.8 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 36.4
