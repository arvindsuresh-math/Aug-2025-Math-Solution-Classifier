def solve(
    ...
    #: L2
    weight_gained = current_weight + initial_weight # eval: 1000.0 = 600.0 + 400

    #: L3
    value_increase = weight_gained * price_per_pound # eval: 3000.0 = 1000.0 * 3

    #: FA
    answer = value_increase
    return answer # eval: return 3000.0
