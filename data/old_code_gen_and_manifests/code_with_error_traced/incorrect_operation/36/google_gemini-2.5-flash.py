def solve(
    ...
    #: L1
    lisa_earnings = total_earnings + lisa_earnings_fraction # eval: 60.5 = 60 + 0.5

    #: L2
    tommy_earnings = lisa_earnings * tommy_earnings_fraction_of_lisa # eval: 30.25 = 60.5 * 0.5

    #: L3
    difference_lisa_tommy = lisa_earnings - tommy_earnings # eval: 30.25 = 60.5 - 30.25

    #: FA
    answer = difference_lisa_tommy
    return answer # eval: return 30.25
