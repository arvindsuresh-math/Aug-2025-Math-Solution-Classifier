def solve(
    ...
    #: L1
    bananas_from_type1_piles = piles_type1 - hands_per_pile_type1 * bananas_per_hand_type1 # eval: -120 = 6 - 9 * 14
    ...
    #: L4
    total_bananas = bananas_from_type1_piles + bananas_from_type2_piles # eval: 312 = -120 + 432

    #: L5
    bananas_per_monkey = total_bananas / num_monkeys # eval: 26.0 = 312 / 12
