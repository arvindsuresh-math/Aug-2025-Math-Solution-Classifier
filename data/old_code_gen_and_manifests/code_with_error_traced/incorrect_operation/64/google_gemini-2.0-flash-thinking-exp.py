def solve(
    ...
    #: L5
    second_job_earnings = second_job_hours - second_job_hourly_rate # eval: -1.0 = 15.0 - 16.0

    #: L6
    total_weekly_earnings = main_job_earnings + second_job_earnings # eval: 599.0 = 600 + -1.0

    #: FA
    answer = total_weekly_earnings
    return answer # eval: return 599.0
