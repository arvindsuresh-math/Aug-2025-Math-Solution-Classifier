def solve(
    ...
    #: L5
    total_coins_before_giving = coins_hour_one - coins_hour_two + coins_hour_three + coins_hour_four # eval: 65 = 15 - 35 + 35 + 50

    #: L6
    total_coins_after_giving = total_coins_before_giving - coins_given_to_coworker # eval: 50 = 65 - 15
