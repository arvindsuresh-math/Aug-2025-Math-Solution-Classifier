def solve(
    ...
    #: L1
    known_distances = first_turn_distance - second_turn_distance + fourth_turn_distance # eval: -3 = 5 - 8 + 0

    #: L2
    third_turn_distance = total_distance - known_distances # eval: 26 = 23 - -3
