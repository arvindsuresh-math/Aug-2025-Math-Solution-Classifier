def solve(
    ...
    #: L1
    total_work_hours_with_bonus = work_hours_no_bonus * extra_work_hours # eval: 16 = 8 * 2

    #: L2
    total_daily_pay_with_bonus = daily_wage_no_bonus + performance_bonus # eval: 100 = 80 + 20

    #: L3
    hourly_rate_with_bonus = total_daily_pay_with_bonus / total_work_hours_with_bonus # eval: 6.25 = 100 / 16
