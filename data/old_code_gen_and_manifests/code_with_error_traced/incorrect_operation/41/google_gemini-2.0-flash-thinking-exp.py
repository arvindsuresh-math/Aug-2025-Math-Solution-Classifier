def solve(
    ...
    #: L1
    rachel_shoes_budget = sara_shoes_cost - rachel_multiplier # eval: 48 = 50 - 2

    #: L2
    rachel_dress_budget = sara_dress_cost * rachel_multiplier # eval: 400 = 200 * 2

    #: L3
    total_rachel_budget = rachel_shoes_budget + rachel_dress_budget # eval: 448 = 48 + 400

    #: FA
    answer = total_rachel_budget
    return answer # eval: return 448
