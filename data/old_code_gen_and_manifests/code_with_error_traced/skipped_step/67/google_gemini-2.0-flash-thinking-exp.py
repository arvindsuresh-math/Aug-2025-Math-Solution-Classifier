def solve(
    ...
    #: L2
    jesse_remaining_distance = total_distance - jesse_day_four_distance - mia_initial_days # eval: 16 = 30 - 10 - 4

    #: L3
    jesse_avg_final_days = jesse_remaining_distance / final_days # eval: 5.333333333333333 = 16 / 3
    ...
    #: L7
    total_avg_final_days = jesse_avg_final_days + mia_avg_final_days # eval: 11.333333333333332 = 5.333333333333333 + 6.0

    #: L8
    average_of_their_averages = total_avg_final_days / 2 # eval: 5.666666666666666 = 11.333333333333332 / 2

    #: FA
    answer = average_of_their_averages
    return answer # eval: return 5.666666666666666
