def solve(
    ...
    #: L4
    total_cost_discounted_tickets = cost_per_discounted_ticket * ticket_cost # eval: 1520.0 = 38.0 * 40
    ...
    #: L6
    total_paid = total_cost_full_price_tickets + total_cost_discounted_tickets # eval: 1920.0 = 400 + 1520.0

    #: FA
    answer = total_paid
    return answer # eval: return 1920.0
