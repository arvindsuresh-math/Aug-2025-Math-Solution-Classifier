def solve(
    ...
    #: L3
    monthly_saving_goal = total_cost_for_season / season_length_months # eval: 100.0 = 400 / 4

    #: L4
    chores_per_month = monthly_saving_goal / charge_per_chore # eval: 10.0 = 100.0 / 10
