def solve(
    ...
    #: L3
    combined_cost_shorts_shoes = cost_shorts + num_shorts # eval: 40 = 35 + 5

    #: L4
    cost_tops = total_spent - combined_cost_shorts_shoes # eval: 35 = 75 - 40

    #: L5
    price_per_top = cost_tops / num_tops # eval: 8.75 = 35 / 4

    #: FA
    answer = price_per_top
    return answer # eval: return 8.75
