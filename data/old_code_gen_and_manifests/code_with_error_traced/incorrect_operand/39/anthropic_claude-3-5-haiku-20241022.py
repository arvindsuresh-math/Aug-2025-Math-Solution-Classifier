def solve(
    ...
    #: L2
    billy_total_candy = anna_houses * billy_houses # eval: 4500 = 60 * 75

    #: L3
    candy_difference = anna_total_candy - billy_total_candy # eval: -3660 = 840 - 4500

    #: FA
    answer = candy_difference
    return answer # eval: return -3660
