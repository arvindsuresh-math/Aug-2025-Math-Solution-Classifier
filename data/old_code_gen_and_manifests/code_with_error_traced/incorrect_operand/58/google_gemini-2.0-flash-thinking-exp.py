def solve(
    ...
    #: L4
    total_allowance_group2 = total_allowance_group1 * avg_allowance_group2 # eval: 960.0 = 240.0 * 4

    #: L5
    total_daily_allowance = total_allowance_group1 + total_allowance_group2 # eval: 1200.0 = 240.0 + 960.0

    #: FA
    answer = total_daily_allowance
    return answer # eval: return 1200.0
