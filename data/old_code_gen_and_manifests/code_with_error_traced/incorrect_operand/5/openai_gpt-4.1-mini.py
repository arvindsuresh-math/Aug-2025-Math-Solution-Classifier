def solve(
    ...
    #: L4
    green_flowers = green_fraction * yellow_flowers # eval: 2.5 = 0.25 * 10

    #: L5
    total_flowers = yellow_purple_sum + green_flowers # eval: 30.5 = 28.0 + 2.5

    #: FA
    answer = total_flowers
    return answer # eval: return 30.5
