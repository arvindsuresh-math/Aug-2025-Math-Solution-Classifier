def solve(
    ...
    #: L3
    jesse_avg_final_three_days = jesse_remaining_miles / jesse_remaining_miles # eval: 1.0 = 18.0 / 18.0
    ...
    #: L7
    total_avg_both = jesse_avg_final_three_days + mia_avg_final_three_days # eval: 7.0 = 1.0 + 6.0

    #: L8
    average_of_their_averages = total_avg_both / 2 # eval: 3.5 = 7.0 / 2
