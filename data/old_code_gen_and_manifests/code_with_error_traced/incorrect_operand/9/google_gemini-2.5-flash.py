def solve(
    ...
    #: L2
    overtime_hours_per_day = hourly_wage - standard_shift_hours # eval: 10.0 = 18.0 - 8
    ...
    #: L6
    daily_overtime_pay = overtime_hourly_rate * overtime_hours_per_day # eval: 270.0 = 27.0 * 10.0

    #: L7
    total_overtime_pay_5_days = daily_overtime_pay * num_work_days # eval: 1350.0 = 270.0 * 5

    #: L8
    total_earnings = total_base_pay_5_days + total_overtime_pay_5_days # eval: 2070.0 = 720.0 + 1350.0

    #: FA
    answer = total_earnings
    return answer # eval: return 2070.0
