def solve(
    ...
    #: L2
    money_from_grandparents = money_from_parents * initial_fraction_has # eval: 7.5 = 15 * 0.5

    #: L3
    money_needed = wallet_cost - initial_money_betty_has - money_from_grandparents - money_from_parents # eval: 27.5 = 100 - 50.0 - 7.5 - 15

    #: FA
    answer = money_needed
    return answer # eval: return 27.5
