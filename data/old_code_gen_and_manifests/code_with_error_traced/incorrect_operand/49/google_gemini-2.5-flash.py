def solve(
    ...
    #: L1
    ben_shells = alan_multiplier / ben_fraction_denominator # eval: 1.3333333333333333 = 4 / 3

    #: L2
    alan_shells = ben_shells * alan_multiplier # eval: 5.333333333333333 = 1.3333333333333333 * 4

    #: FA
    answer = alan_shells
    return answer # eval: return 5.333333333333333
