def solve(
    ...
    not_hit_first_batch = fraction_not_hit_first_batch * fraction_hit_second_batch # eval: 0.19999999999999998 = 0.6 * 0.3333333333333333
    ...
    #: L3
    total_not_hit = not_hit_first_batch + not_hit_second_batch # eval: 50.20000000000001 = 0.19999999999999998 + 50.00000000000001

    #: FA
    answer = total_not_hit
    return answer # eval: return 50.20000000000001
