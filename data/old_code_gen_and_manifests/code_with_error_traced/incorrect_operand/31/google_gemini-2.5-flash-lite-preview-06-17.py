def solve(
    ...
    #: L3
    total_sales_last_month = price_large_painting + sales_small_paintings_last_month # eval: 180 = 60 + 120

    #: L4
    total_sales_this_month = total_sales_last_month * sales_multiplier_this_month # eval: 360 = 180 * 2

    #: FA
    answer = total_sales_this_month
    return answer # eval: return 360
