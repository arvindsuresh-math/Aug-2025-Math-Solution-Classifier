def solve(
    ...
    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + rounds # eval: 52 = 15 + 13 + 20 + 4

    #: L6
    average_jeff_skips = total_jeff_skips / rounds # eval: 13.0 = 52 / 4
