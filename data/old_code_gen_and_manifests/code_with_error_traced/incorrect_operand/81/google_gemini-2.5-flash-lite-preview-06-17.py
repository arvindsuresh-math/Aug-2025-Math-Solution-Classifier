def solve(
    ...
    #: L3
    jeff_round3 = jeff_round2 + round3_diff # eval: 17 = 13 + 4

    #: L4
    jeff_round4 = sam_skips_per_round * round4_ratio # eval: 8.0 = 16 * 0.5

    #: L5
    jeff_total_skips = jeff_round1 + jeff_round2 + jeff_round3 + jeff_round4 # eval: 53.0 = 15 + 13 + 17 + 8.0

    #: L6
    jeff_avg_skips = jeff_total_skips / 4 # eval: 13.25 = 53.0 / 4

    #: FA
    answer = jeff_avg_skips
    return answer # eval: return 13.25
