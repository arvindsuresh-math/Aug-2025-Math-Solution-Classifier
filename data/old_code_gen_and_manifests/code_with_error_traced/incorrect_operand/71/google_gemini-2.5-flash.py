def solve(
    ...
    #: L1
    sales_from_crafts = craft_price * craft_price # eval: 144 = 12 * 12

    #: L2
    total_money_before_deposit = sales_from_crafts + extra_money_from_customer # eval: 151 = 144 + 7

    #: L3
    money_left_after_deposit = total_money_before_deposit - deposit_amount # eval: 133 = 151 - 18
