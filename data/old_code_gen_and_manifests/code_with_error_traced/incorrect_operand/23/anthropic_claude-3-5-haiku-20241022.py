def solve(
    ...
    #: L3
    total_shorts_and_shoes_cost = num_tops + total_shoes_cost # eval: 24 = 4 + 20

    #: L4
    remaining_money = total_spent - total_shorts_and_shoes_cost # eval: 51 = 75 - 24

    #: L5
    cost_per_top = remaining_money / num_tops # eval: 12.75 = 51 / 4
