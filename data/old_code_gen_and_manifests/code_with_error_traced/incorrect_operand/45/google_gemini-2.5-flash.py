def solve(
    ...
    #: L3
    cost_skittles = num_reese_bags * num_skittles_bags # eval: 20 = 4 * 5

    #: L4
    total_cost = pinata_cost + cost_reese + cost_snickers + cost_skittles # eval: 84 = 13 + 36 + 15 + 20

    #: FA
    answer = total_cost
    return answer # eval: return 84
