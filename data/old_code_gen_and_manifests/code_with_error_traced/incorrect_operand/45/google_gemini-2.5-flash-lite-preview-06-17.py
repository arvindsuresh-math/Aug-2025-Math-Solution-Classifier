def solve(
    ...
    #: L2
    cost_snickers = num_bags_snickers * cost_per_bag_skittles # eval: 21 = 3 * 7

    #: L3
    cost_skittles = num_bags_skittles * cost_per_bag_skittles # eval: 35 = 5 * 7

    #: L4
    total_cost = cost_pinata + cost_reeses + cost_snickers + cost_skittles # eval: 105 = 13 + 36 + 21 + 35

    #: FA
    answer = total_cost
    return answer # eval: return 105
