def solve(
    ...
    #: L1
    cost_cream_cheese = cold_cuts_price_multiplier / cream_cheese_price_divisor # eval: 1.0 = 2 / 2

    #: L2
    cost_cold_cuts = cost_cheddar_total * cold_cuts_price_multiplier # eval: 20 = 10 * 2

    #: L3
    total_spent = cost_cheddar_total + cost_cream_cheese + cost_cold_cuts # eval: 31.0 = 10 + 1.0 + 20

    #: FA
    answer = total_spent
    return answer # eval: return 31.0
