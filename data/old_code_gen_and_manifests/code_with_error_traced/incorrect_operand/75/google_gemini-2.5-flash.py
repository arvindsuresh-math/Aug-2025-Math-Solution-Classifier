def solve(
    ...
    #: L3
    cost_dale_eggs = dale_num_eggs * cost_toast_per_slice # eval: 2 = 2 * 1

    #: L4
    cost_andrew_eggs = andrew_num_eggs * cost_egg_per_egg # eval: 6 = 2 * 3

    #: L5
    total_breakfast_cost = cost_dale_toast + cost_andrew_toast + cost_dale_eggs + cost_andrew_eggs # eval: 11 = 2 + 1 + 2 + 6
