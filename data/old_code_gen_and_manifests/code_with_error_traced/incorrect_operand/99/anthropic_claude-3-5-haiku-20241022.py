def solve(
    ...
    #: L1
    second_tank_water = fish_size_first_tank / 2 # eval: 1.5 = 3 / 2

    #: L2
    fish_in_second_tank = second_tank_water / fish_size_second_tank # eval: 0.75 = 1.5 / 2
    ...
    #: L5
    difference_in_fish = fish_in_first_tank_after_eating - fish_in_second_tank # eval: 14.25 = 15.0 - 0.75

    #: FA
    answer = difference_in_fish
    return answer # eval: return 14.25
