def solve(
    ...
    #: L1
    distance_known = distance_after_2nd_turn + distance_after_2nd_turn + distance_after_4th_turn # eval: 16 = 8 + 8 + 0

    #: L2
    distance_after_3rd_turn = total_distance - distance_known # eval: 7 = 23 - 16
