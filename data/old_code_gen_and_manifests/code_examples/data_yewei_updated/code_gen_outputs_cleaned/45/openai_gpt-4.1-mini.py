def solve(
    ...
    """
    #: L1
    total_reeses_cost = cost_per_bag_reeses * num_bags_reeses

    #: L2
    total_snickers_cost = cost_per_bag_snickers * num_bags_snickers

    #: L3
    total_skittles_cost = cost_per_bag_skittles * num_bags_skittles

    #: L4
    total_cost = pinata_cost + total_reeses_cost + total_snickers_cost + total_skittles_cost
