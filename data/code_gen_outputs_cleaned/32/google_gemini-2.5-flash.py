def solve(
    ...
    """
    #: L1
    # The problem states "at the 4th turn, it immediately exits the tunnel", implying 0 meters traveled after the 4th turn.
    known_distances_sum = dist_after_1st_turn + dist_after_2nd_turn + 0

    #: L2
    distance_after_3rd_turn = total_dist_around_ring - known_distances_sum
