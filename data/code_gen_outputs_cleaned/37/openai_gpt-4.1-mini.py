def solve(
    ...
    """
    #: L1
    total_cost_hamburgers = cost_per_hamburger * num_hamburgers

    #: L2
    total_cost_fries = cost_per_fries * num_fries

    #: L3
    total_cost_sodas = cost_per_soda * num_sodas

    #: L4
    total_bill = total_cost_hamburgers + total_cost_fries + total_cost_sodas + (cost_per_spaghetti * num_spaghetti)

    #: L5
    amount_per_friend = total_bill / num_friends

    answer = amount_per_friend  # FINAL ANSWER
    return answer