def solve(
    ...
    #: L4
    remaining_butter_after_chocolate_peanut_butter = total_butter_kg - butter_used_chocolate_peanut_butter

    #: L5
    butter_sugar = remaining_butter_after_chocolate_peanut_butter * fraction_sugar_remaining

    #: L6
    butter_left = remaining_butter_after_chocolate_peanut_butter - butter_sugar
