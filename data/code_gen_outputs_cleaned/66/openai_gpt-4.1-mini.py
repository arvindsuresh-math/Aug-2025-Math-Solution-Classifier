def solve(
    ...
    """
    #: L1
    down_payment = laptop_cost * down_payment_percent / 100

    #: L2
    total_down_payment = down_payment + extra_down_payment

    #: L3
    remaining_balance = laptop_cost - total_down_payment

    #: L4
    monthly_payment = remaining_balance / 12

    #: L5
    total_paid_4_months = monthly_payment * months_paid

    #: L6
    balance_after_4_months = remaining_balance - total_paid_4_months
