def solve(
    ...
    """
    #: L1
    jeff_skips_round1 = sam_skips_round1 - sam_skips_more_than_jeff_round1

    #: L2
    jeff_skips_round2 = sam_skips_round1 - jeff_skips_fewer_round2

    #: L3
    jeff_skips_round3 = sam_skips_round1 + jeff_skips_more_round3

    #: L4
    jeff_skips_round4 = sam_skips_round1 * jeff_skips_factor_round4

    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4

    #: L6
    average_jeff_skips_per_round = total_jeff_skips / num_rounds

    answer = average_jeff_skips_per_round # FINAL ANSWER
    return answer