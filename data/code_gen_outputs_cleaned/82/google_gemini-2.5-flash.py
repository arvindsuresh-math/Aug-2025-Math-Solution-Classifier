def solve(
    ...
    """
    #: L1
    overtime_hours = hours_worked_last_week - standard_hours_per_week

    #: L2
    overtime_earnings = overtime_hours * overtime_rate_per_hour

    #: L3
    total_income = base_income + overtime_earnings
