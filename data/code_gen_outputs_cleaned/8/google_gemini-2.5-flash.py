def solve(
    ...
    """
    #: L1
    # Let S be the amount Alexis paid for the shoes. (This is the variable we will solve for)

    #: L2
    spent_on_known_items = shirt_cost + suit_pants_cost + suit_coat_cost + socks_cost + belt_cost

    #: L3
    total_spent = budget - remaining_budget

    #: L4
    shoes_cost = total_spent - spent_on_known_items
