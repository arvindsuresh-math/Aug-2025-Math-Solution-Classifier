def solve(
    ...
    #: L6
    mia_avg_last_three_days = mia_miles_left / remaining_days

    #: L7
    total_avg_miles_per_day = (jesse_avg_last_three_days + mia_avg_last_three_days)

    #: L8
    average_of_their_averages = total_avg_miles_per_day / 2
