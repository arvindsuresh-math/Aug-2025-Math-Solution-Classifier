def solve(
    ...
    """
    #: L1
    non_valuable_files_first_round = percentage_deleted_first_round * initial_files_downloaded

    #: L2
    valuable_files_first_round = initial_files_downloaded - non_valuable_files_first_round

    #: L3
    non_useful_files_second_round = fraction_irrelevant_second_round * additional_files_downloaded

    #: L4
    valuable_files_second_round = additional_files_downloaded - non_useful_files_second_round
