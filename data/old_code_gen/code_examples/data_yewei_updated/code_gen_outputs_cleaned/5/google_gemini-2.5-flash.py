def solve(
        ...
        percent_more_purple: int = 80, # 80% more of those in purple
        percent_as_many_green: int = 25 # only 25% as many green flowers
    ):
    """Index: 5.
    ...
    #: L4
    num_green_flowers = (percent_as_many_green / 100) * total_yellow_purple_flowers
