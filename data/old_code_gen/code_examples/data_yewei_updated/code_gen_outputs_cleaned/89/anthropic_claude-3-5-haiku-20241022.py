def solve(
        ...
        library_days: int = 5  # The library is open from Monday to Friday
):
    """Index: 89.
    ...
    #: L3
    total_books_in_week = total_books_regular_days + friday_extra_books

    answer = total_books_in_week  # FINAL ANSWER
    return answer