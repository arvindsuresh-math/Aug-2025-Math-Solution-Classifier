def solve(
    ...
    """
    #: L1
    cost_ice_cream = cartons_ice_cream * cost_per_ice_cream

    #: L2
    cost_frozen_yoghurt = cartons_frozen_yoghurt * cost_per_frozen_yoghurt

    #: L3
    difference = cost_ice_cream - cost_frozen_yoghurt
