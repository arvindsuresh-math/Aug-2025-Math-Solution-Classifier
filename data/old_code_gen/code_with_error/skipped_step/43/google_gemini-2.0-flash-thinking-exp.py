def solve(
    ...
    #: L2
    collapsed_earthquake_3 = initial_collapsed_buildings * collapse_multiplier

    #: L3
    collapsed_earthquake_4 = collapsed_earthquake_3 * collapse_multiplier

    #: L4
    total_collapsed_buildings = initial_collapsed_buildings + initial_collapsed_buildings + collapsed_earthquake_3 + collapsed_earthquake_4
