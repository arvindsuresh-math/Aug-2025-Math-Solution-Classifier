def solve(
    ...
    #: L1
    weight_from_berries = fraction_from_berries * fraction_from_berries

    #: L2
    weight_from_acorns = multiplier_acorns * weight_from_berries

    #: L3
    remaining_weight_after_berries_acorns = weight_needed_total - weight_from_berries - weight_from_acorns

    #: L4
    weight_from_salmon = remaining_weight_after_berries_acorns * fraction_from_salmon
