def solve(
    ...
    #: L1
    sally_daily_savings = sally_daily_rate * savings_fraction

    #: L2
    sally_yearly_savings = sally_daily_savings * days_in_year

    #: L3
    bob_daily_savings = bob_daily_rate * savings_fraction

    #: L4
    bob_yearly_savings = bob_daily_savings * days_in_year

    #: L5
    total_savings = sally_daily_savings + bob_yearly_savings
