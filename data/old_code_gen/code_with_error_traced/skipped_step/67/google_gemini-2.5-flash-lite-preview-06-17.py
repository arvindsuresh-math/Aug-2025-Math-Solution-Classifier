def solve(
    ...
    #: L3
    jesse_avg_last_3_days = jesse_avg_first_3_days / 3 # eval: 0.2222222222222222 = 0.6666666666666666 / 3
    ...
    #: L7
    total_avg_last_3_days = jesse_avg_last_3_days + mia_avg_last_3_days # eval: 6.222222222222222 = 0.2222222222222222 + 6.0

    #: L8
    average_of_averages = total_avg_last_3_days / 2 # eval: 3.111111111111111 = 6.222222222222222 / 2

    #: FA
    answer = average_of_averages
    return answer # eval: return 3.111111111111111
