def solve(
    ...
    #: L5
    total_base_pay_5_days = standard_shift_hours * num_work_days # eval: 40 = 8 * 5
    ...
    #: L8
    total_earnings = total_base_pay_5_days + total_overtime_pay_5_days # eval: 310.0 = 40 + 270.0
