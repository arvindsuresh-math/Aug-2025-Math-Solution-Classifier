def solve(
    ...
    #: L4
    zola_total_hats = zola_red_hat_factor + zola_red_hats # eval: 16.8 = 0.8 + 16.0

    #: L5
    combined_hats = zola_total_hats + paityn_total_hats # eval: 60.8 = 16.8 + 44

    #: L6
    hats_per_person = combined_hats / num_people_sharing # eval: 30.4 = 60.8 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 30.4
