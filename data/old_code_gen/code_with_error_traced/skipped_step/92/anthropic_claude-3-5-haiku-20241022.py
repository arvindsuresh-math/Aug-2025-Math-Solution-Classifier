def solve(
    ...
    #: L2
    sally_yearly_savings = sally_daily_rate * days_in_year # eval: 2190 = 6 * 365
    ...
    #: L5
    total_savings = sally_yearly_savings + bob_yearly_savings # eval: 2920.0 = 2190 + 730.0

    #: FA
    answer = total_savings
    return answer # eval: return 2920.0
