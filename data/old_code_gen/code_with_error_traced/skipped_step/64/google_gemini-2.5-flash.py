def solve(
    ...
    #: L5
    second_job_earnings = main_job_hours * second_job_hourly_rate # eval: 480.0 = 30 * 16.0

    #: L6
    total_weekly_earnings = main_job_earnings + second_job_earnings # eval: 1080.0 = 600 + 480.0
