def solve(
    ...
    #: L3
    total_sales_last_month = earnings_large_paintings_last_month + large_painting_price # eval: 540 = 480 + 60

    #: L4
    sales_this_month = total_sales_last_month * sales_multiplier_this_month # eval: 1080 = 540 * 2
