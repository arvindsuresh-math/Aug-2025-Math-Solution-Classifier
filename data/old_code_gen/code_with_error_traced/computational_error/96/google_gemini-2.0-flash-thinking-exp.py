def solve(
    ...
    #: L1
    total_rain_inches = 8 # eval: 8 = 8

    #: L2
    total_gallons_collected = total_rain_inches * gallons_per_inch # eval: 120 = 8 * 15

    #: L3
    total_money_made = total_gallons_collected * price_per_gallon # eval: 144.0 = 120 * 1.2

    #: FA
    answer = total_money_made
    return answer # eval: return 144.0
