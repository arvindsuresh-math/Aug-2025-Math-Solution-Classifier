def solve(
    ...
    #: L3
    jesse_avg_last_3_days = -4.0 # eval: -4.0 = -4.0
    ...
    #: L7
    total_avg_last_3_days = jesse_avg_last_3_days + mia_avg_last_3_days # eval: 2.0 = -4.0 + 6.0

    #: L8
    average_of_averages = total_avg_last_3_days / 2 # eval: 1.0 = 2.0 / 2
