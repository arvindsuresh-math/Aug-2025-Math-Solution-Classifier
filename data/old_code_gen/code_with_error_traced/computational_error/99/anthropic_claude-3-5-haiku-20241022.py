def solve(
    ...
    #: L1
    second_tank_water = 34.0 # eval: 34.0 = 34.0

    #: L2
    fish_in_second_tank = second_tank_water / fish_size_second_tank # eval: 17.0 = 34.0 / 2
    ...
    #: L5
    difference_in_fish = fish_in_first_tank_after_eating - fish_in_second_tank # eval: -2.0 = 15.0 - 17.0
