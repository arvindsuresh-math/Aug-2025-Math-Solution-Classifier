def solve(
    ...
    #: L3
    bedroom_fabric_area = 18 # eval: 18 = 18

    #: L4
    fabric_left = original_bolt_area - living_room_fabric_area - bedroom_fabric_area # eval: 150 = 192 - 24 - 18

    #: FA
    answer = fabric_left
    return answer # eval: return 150
