def solve(
    ...
    #: L2
    cost_total_fries = 3.8 # eval: 3.8 = 3.8

    #: L3
    cost_total_soda = cost_soda * num_soda # eval: 2.5 = 0.5 * 5

    #: L4
    total_bill = cost_total_hamburger + cost_total_fries + cost_total_soda + cost_spaghetti # eval: 24.0 = 15 + 3.8 + 2.5 + 2.7

    #: L5
    cost_per_friend = total_bill / num_friends # eval: 4.8 = 24.0 / 5
