def solve(
    ...
    #: L2
    jeff_skips_round2 = 23 # eval: 23 = 23
    ...
    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4 # eval: 66.0 = 15 + 23 + 20 + 8.0

    #: L6
    average_jeff_skips_per_round = total_jeff_skips / num_rounds # eval: 16.5 = 66.0 / 4
