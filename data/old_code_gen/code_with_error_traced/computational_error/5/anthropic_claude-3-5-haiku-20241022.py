def solve(
    ...
    #: L3
    yellow_and_purple_flowers = 27.0 # eval: 27.0 = 27.0

    #: L4
    green_flowers = yellow_and_purple_flowers * green_flower_percentage # eval: 6.75 = 27.0 * 0.25

    #: L5
    total_flowers = yellow_and_purple_flowers + green_flowers # eval: 33.75 = 27.0 + 6.75
