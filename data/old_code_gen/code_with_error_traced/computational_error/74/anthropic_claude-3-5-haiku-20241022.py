def solve(
    ...
    #: L1
    second_person_loss = 10 # eval: 10 = 10

    #: L2
    remaining_weight_loss = total_weight_loss - first_person_loss - second_person_loss # eval: 66 = 103 - 27 - 10

    #: L3
    last_two_people_loss = remaining_weight_loss / 2 # eval: 33.0 = 66 / 2
