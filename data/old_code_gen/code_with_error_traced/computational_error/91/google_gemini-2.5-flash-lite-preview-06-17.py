def solve(
    ...
    #: L1
    total_hours_with_bonus = 9 # eval: 9 = 9

    #: L2
    total_daily_pay_with_bonus = base_daily_pay + bonus_pay_per_day # eval: 100 = 80 + 20

    #: L3
    hourly_rate_with_bonus = total_daily_pay_with_bonus / total_hours_with_bonus # eval: 11.11111111111111 = 100 / 9

    #: FA
    answer = hourly_rate_with_bonus
    return answer # eval: return 11.11111111111111
