def solve(
    ...
    #: L1
    num_discounted_tickets = tickets_bought + discount_threshold # eval: 22 = 12 + 10
    ...
    #: L4
    total_cost_discounted_tickets = cost_per_discounted_ticket * num_discounted_tickets # eval: 836.0 = 38.0 * 22

    #: L5
    total_cost_full_price_tickets = ticket_cost * discount_threshold # eval: 400 = 40 * 10

    #: L6
    total_paid = total_cost_full_price_tickets + total_cost_discounted_tickets # eval: 1236.0 = 400 + 836.0

    #: FA
    answer = total_paid
    return answer # eval: return 1236.0
