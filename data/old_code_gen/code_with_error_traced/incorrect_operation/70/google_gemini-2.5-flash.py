def solve(
    ...
    #: L1
    tim_apples = martha_apples + tim_less_than_martha # eval: 98 = 68 + 30

    #: L2
    harry_apples = tim_apples * harry_fraction_of_tim # eval: 49.0 = 98 * 0.5

    #: FA
    answer = harry_apples
    return answer # eval: return 49.0
