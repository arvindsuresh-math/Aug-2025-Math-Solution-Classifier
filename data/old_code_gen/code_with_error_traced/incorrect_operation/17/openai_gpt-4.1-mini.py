def solve(
    ...
    #: L2
    pink_after_john = pink_after_carl + john_pink_taken # eval: 28 = 22 + 6
    ...
    #: L5
    pink_green_total = green_after_john + pink_after_john # eval: 31 = 3 + 28

    #: L6
    total_remaining = pink_green_total + yellow_hard_hats # eval: 55 = 31 + 24
