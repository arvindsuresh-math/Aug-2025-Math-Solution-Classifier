def solve(
    ...
    #: L1
    initial_earnings = crafts_sold + price_per_craft # eval: 15 = 3 + 12

    #: L2
    total_earnings = initial_earnings + extra_tip # eval: 22 = 15 + 7

    #: L3
    remaining_cash = total_earnings - deposit_amount # eval: 4 = 22 - 18
