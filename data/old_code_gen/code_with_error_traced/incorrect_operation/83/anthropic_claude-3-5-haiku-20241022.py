def solve(
    ...
    #: L1
    paityn_total_hats = paityn_red_hats * paityn_blue_hats # eval: 480 = 20 * 24
    ...
    #: L5
    total_combined_hats = zola_total_hats + paityn_total_hats # eval: 544.0 = 64.0 + 480

    #: L6
    hats_per_person = total_combined_hats / 2 # eval: 272.0 = 544.0 / 2

    #: FA
    answer = hats_per_person
    return answer # eval: return 272.0
