def solve(
    ...
    #: L1
    total_flowers = roses - tulips + daisies # eval: 20 = 25 - 40 + 35

    #: L2
    flowers_not_roses = tulips + daisies # eval: 75 = 40 + 35

    #: L3
    percentage_not_roses = (flowers_not_roses / total_flowers) * 100 # eval: 375.0 = (75 / 20) * 100

    #: FA
    answer = percentage_not_roses
    return answer # eval: return 375.0
