def solve(
    ...
    #: L4
    hours_watching_both_daughters_practice = hours_watching_one_daughter_practice - num_daughters # eval: 30 = 32 - 2

    #: L5
    total_hours_at_field = hours_watching_both_daughters_play + hours_watching_both_daughters_practice # eval: 62 = 32 + 30
