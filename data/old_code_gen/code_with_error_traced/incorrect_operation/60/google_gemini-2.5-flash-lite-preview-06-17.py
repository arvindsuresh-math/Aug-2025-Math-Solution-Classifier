def solve(
    ...
    #: L4
    total_hours_watching_practice = hours_watching_one_daughter_practice - num_daughters # eval: 30 = 32 - 2

    #: L5
    total_hours_at_field = total_hours_watching_games + total_hours_watching_practice # eval: 62 = 32 + 30
