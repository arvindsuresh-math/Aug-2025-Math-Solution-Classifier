def solve(
    ...
    #: L1
    sally_daily_savings = 0.5 + sally_daily_earnings # eval: 6.5 = 0.5 + 6

    #: L2
    sally_yearly_savings = sally_daily_savings * days_per_year # eval: 2372.5 = 6.5 * 365
    ...
    #: L5
    total_savings = sally_yearly_savings + bob_yearly_savings # eval: 3102.5 = 2372.5 + 730.0

    #: FA
    answer = total_savings
    return answer # eval: return 3102.5
