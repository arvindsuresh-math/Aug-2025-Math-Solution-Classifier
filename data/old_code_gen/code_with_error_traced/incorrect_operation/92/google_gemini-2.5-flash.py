def solve(
    ...
    #: L3
    bob_daily_savings = fraction_saved + bob_daily_earnings # eval: 4.5 = 0.5 + 4

    #: L4
    bob_yearly_savings = bob_daily_savings * days_in_year # eval: 1642.5 = 4.5 * 365

    #: L5
    total_saved = bob_yearly_savings + sally_yearly_savings # eval: 2737.5 = 1642.5 + 1095.0
