def solve(
    ...
    #: L2
    rachel_dress_cost = sara_dress_cost + 2 # eval: 202 = 200 + 2

    #: L3
    total_rachel_budget = rachel_shoes_cost + rachel_dress_cost # eval: 302 = 100 + 202

    #: FA
    answer = total_rachel_budget
    return answer # eval: return 302
