def solve(
    ...
    #: L1
    total_snakes_eaten = snakes_per_jaguar + num_jaguars # eval: 11 = 5 + 6

    #: L2
    total_birds_eaten = total_snakes_eaten * birds_per_snake # eval: 33 = 11 * 3

    #: L3
    total_beetles_eaten = total_birds_eaten * beetles_per_bird # eval: 396 = 33 * 12

    #: FA
    answer = total_beetles_eaten
    return answer # eval: return 396
