def solve(
    ...
    #: L1
    total_snakes_eaten = snakes_per_jaguar - jaguars # eval: -1 = 5 - 6

    #: L2
    total_birds_eaten = total_snakes_eaten * birds_per_snake # eval: -3 = -1 * 3

    #: L3
    total_beetles_eaten = total_birds_eaten * beetles_per_bird # eval: -36 = -3 * 12
