def solve(
    ...
    #: L1
    walk_hours_to_work = walk_time_one_way + walk_days_per_week # eval: 5 = 2 + 3

    #: L2
    walk_hours_round_trip = walk_hours_to_work * 2 # eval: 10 = 5 * 2
    ...
    #: L5
    total_hours = walk_hours_round_trip + bike_hours_round_trip # eval: 14 = 10 + 4
