def solve(
    ...
    #: L2
    proportion_after_spill = initial_fill_fraction + (1 - fraction_spilled) # eval: 1.0 = 0.5 + (1 - 0.5)

    #: L3
    proportion_after_triple = proportion_after_spill * tripling_factor # eval: 3.0 = 1.0 * 3

    #: L4
    final_water_volume = volume_aquarium * proportion_after_triple # eval: 216.0 = 72 * 3.0
