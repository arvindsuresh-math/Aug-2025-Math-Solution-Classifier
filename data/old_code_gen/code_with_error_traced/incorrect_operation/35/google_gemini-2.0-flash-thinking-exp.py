def solve(
    ...
    #: L1
    percent_b_and_above = 100 + percent_below_b # eval: 140 = 100 + 40

    #: L2
    students_b_and_above = total_students * percent_b_and_above / 100 # eval: 84.0 = 60 * 140 / 100

    #: FA
    answer = students_b_and_above
    return answer # eval: return 84.0
