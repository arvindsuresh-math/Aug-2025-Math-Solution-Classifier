def solve(
    ...
    #: L2
    jeff_skips_round2 = sam_skips_per_round + 3 # eval: 19 = 16 + 3
    ...
    #: L5
    total_jeff_skips = jeff_skips_round1 + jeff_skips_round2 + jeff_skips_round3 + jeff_skips_round4 # eval: 62.0 = 15 + 19 + 20 + 8.0
