def solve(
    ...
    #: L2
    weight_lost_by_last_two = total_weight_lost + person1_lost - person2_lost # eval: 110 = 103 + 27 - 20

    #: L3
    weight_lost_per_person_last_two = weight_lost_by_last_two / (num_people - 2) # eval: 55.0 = 110 / (4 - 2)

    #: FA
    answer = weight_lost_per_person_last_two
    return answer # eval: return 55.0
