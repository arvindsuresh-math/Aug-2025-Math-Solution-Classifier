def solve(
    ...
    #: L3
    total_sales_last_month = earnings_large_paintings_last_month - earnings_small_paintings_last_month # eval: 360 = 480 - 120

    #: L4
    total_sales_this_month = total_sales_last_month * sales_multiplier_this_month # eval: 720 = 360 * 2
