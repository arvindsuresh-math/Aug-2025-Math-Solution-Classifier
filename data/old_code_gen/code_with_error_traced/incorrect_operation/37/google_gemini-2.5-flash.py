def solve(
    ...
    #: L4
    total_bill = cost_total_hamburgers - cost_total_french_fries + cost_total_soda + cost_spaghetti_platter # eval: 15.399999999999999 = 15 - 4.8 + 2.5 + 2.7

    #: L5
    cost_per_friend = total_bill / num_friends # eval: 3.0799999999999996 = 15.399999999999999 / 5

    #: FA
    answer = cost_per_friend
    return answer # eval: return 3.0799999999999996
