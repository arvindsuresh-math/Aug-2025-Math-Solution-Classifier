def solve(
    ...
    #: L2
    total_work_distance = daily_work_distance + workdays # eval: 45 = 40 + 5

    #: L3
    total_weekly_distance = total_work_distance + weekend_ride_distance # eval: 245 = 45 + 200

    #: L4
    total_time_biking = total_weekly_distance / biking_speed # eval: 9.8 = 245 / 25

    #: FA
    answer = total_time_biking
    return answer # eval: return 9.8
