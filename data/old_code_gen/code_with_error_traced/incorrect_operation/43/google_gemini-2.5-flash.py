def solve(
    ...
    #: L1
    second_earthquake_collapsed = collapse_multiplier - initial_collapsed_buildings # eval: -2 = 2 - 4

    #: L2
    third_earthquake_collapsed = collapse_multiplier * second_earthquake_collapsed # eval: -4 = 2 * -2

    #: L3
    fourth_earthquake_collapsed = collapse_multiplier * third_earthquake_collapsed # eval: -8 = 2 * -4

    #: L4
    total_collapsed_buildings = initial_collapsed_buildings + second_earthquake_collapsed + third_earthquake_collapsed + fourth_earthquake_collapsed # eval: -10 = 4 + -2 + -4 + -8
