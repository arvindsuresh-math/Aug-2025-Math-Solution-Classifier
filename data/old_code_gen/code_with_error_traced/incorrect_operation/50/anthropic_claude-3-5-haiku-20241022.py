def solve(
    ...
    #: L1
    total_baseball_supplies_cost = monthly_baseball_supplies - baseball_season_months # eval: 96 = 100 - 4

    #: L2
    months_to_save = total_months_in_year - baseball_season_months # eval: 8 = 12 - 4

    #: L3
    monthly_savings_needed = total_baseball_supplies_cost / months_to_save # eval: 12.0 = 96 / 8

    #: L4
    chores_per_month = monthly_savings_needed / chore_price # eval: 1.2 = 12.0 / 10

    #: FA
    answer = chores_per_month
    return answer # eval: return 1.2
