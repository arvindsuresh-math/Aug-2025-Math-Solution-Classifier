def solve(
    ...
    #: L1
    total_cost_for_season = season_length_months + monthly_cost_supplies # eval: 104 = 4 + 100

    #: L2
    saving_months = total_months_in_year - season_length_months # eval: 8 = 12 - 4

    #: L3
    monthly_saving_goal = total_cost_for_season / saving_months # eval: 13.0 = 104 / 8

    #: L4
    chores_per_month = monthly_saving_goal / charge_per_chore # eval: 1.3 = 13.0 / 10

    #: FA
    answer = chores_per_month
    return answer # eval: return 1.3
