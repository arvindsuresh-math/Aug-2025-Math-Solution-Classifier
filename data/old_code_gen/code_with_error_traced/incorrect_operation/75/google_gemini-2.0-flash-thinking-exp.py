def solve(
    ...
    #: L2
    cost_andrew_toast = andrew_toast_slices - cost_toast_slice # eval: 0 = 1 - 1

    #: L3
    cost_dale_eggs = dale_eggs * cost_egg # eval: 6 = 2 * 3

    #: L4
    cost_andrew_eggs = andrew_eggs * cost_egg # eval: 6 = 2 * 3

    #: L5
    total_cost = cost_dale_toast + cost_andrew_toast + cost_dale_eggs + cost_andrew_eggs # eval: 14 = 2 + 0 + 6 + 6
