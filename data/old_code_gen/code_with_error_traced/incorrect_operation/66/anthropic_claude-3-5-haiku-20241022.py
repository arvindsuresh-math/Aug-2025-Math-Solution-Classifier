def solve(
    ...
    #: L5
    total_payments = monthly_installment + months_paid # eval: 69 = 65 + 4

    #: L6
    balance_after_payments = remaining_balance - total_payments # eval: 711.0 = 780.0 - 69

    #: FA
    answer = balance_after_payments
    return answer # eval: return 711.0
