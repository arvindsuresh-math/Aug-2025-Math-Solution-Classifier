def solve(
    ...
    #: L6
    daily_overtime_pay = overtime_hourly_rate - overtime_hours_per_day # eval: 25.0 = 27.0 - 2

    #: L7
    total_overtime_pay_5_days = daily_overtime_pay * num_work_days # eval: 125.0 = 25.0 * 5

    #: L8
    total_earnings = total_base_pay_5_days + total_overtime_pay_5_days # eval: 845.0 = 720.0 + 125.0

    #: FA
    answer = total_earnings
    return answer # eval: return 845.0
