def solve(
    ...
    #: L1
    earnings_from_mowing = charge_per_lawn * lawns_mowed_last_week # eval: 528 = 33 * 16

    #: L2
    total_tips = num_customers_tip * num_customers_tip # eval: 9 = 3 * 3

    #: L3
    total_earnings = earnings_from_mowing + total_tips # eval: 537 = 528 + 9

    #: FA
    answer = total_earnings
    return answer # eval: return 537
