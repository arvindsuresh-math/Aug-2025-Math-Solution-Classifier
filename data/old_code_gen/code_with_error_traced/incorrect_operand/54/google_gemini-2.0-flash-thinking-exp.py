def solve(
    ...
    #: L2
    money_left_after_milkshake = initial_earnings - initial_earnings # eval: 0 = 28 - 28

    #: L3
    money_in_wallet = money_left_after_milkshake * (1 - fraction_saved) # eval: 0.0 = 0 * (1 - 0.5)

    #: L4
    money_lost = money_in_wallet - money_left_after_dog # eval: -1.0 = 0.0 - 1
