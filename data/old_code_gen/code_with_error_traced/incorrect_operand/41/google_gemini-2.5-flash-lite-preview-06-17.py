def solve(
    ...
    #: L2
    rachel_dress_budget = rachel_shoes_budget * 2 # eval: 200 = 100 * 2

    #: L3
    total_rachel_budget = rachel_shoes_budget + rachel_dress_budget # eval: 300 = 100 + 200

    #: FA
    answer = total_rachel_budget
    return answer # eval: return 300
