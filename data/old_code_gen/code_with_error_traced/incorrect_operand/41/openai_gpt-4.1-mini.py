def solve(
    ...
    #: L1
    cost_shoes_rachel = cost_dress_sara * 2 # eval: 400 = 200 * 2

    #: L2
    cost_dress_rachel = cost_dress_sara * 2 # eval: 400 = 200 * 2

    #: L3
    total_budget_rachel = cost_shoes_rachel + cost_dress_rachel # eval: 800 = 400 + 400

    #: FA
    answer = total_budget_rachel
    return answer # eval: return 800
