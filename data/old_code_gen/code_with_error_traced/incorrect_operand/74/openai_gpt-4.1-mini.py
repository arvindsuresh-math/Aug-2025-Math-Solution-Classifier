def solve(
    ...
    #: L2
    remaining_weight_loss = total_weight_lost - second_person_loss - second_person_loss # eval: 63 = 103 - 20 - 20

    #: L3
    last_two_each_loss = remaining_weight_loss / 2 # eval: 31.5 = 63 / 2

    #: FA
    answer = last_two_each_loss
    return answer # eval: return 31.5
