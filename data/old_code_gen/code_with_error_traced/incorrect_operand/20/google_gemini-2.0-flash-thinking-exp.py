def solve(
    ...
    #: L1
    truck_stamps = more_truck_than_snowflake + more_truck_than_snowflake # eval: 18 = 9 + 9

    #: L2
    rose_stamps = truck_stamps - fewer_rose_than_truck # eval: 5 = 18 - 13

    #: L3
    total_stamps = snowflake_stamps + truck_stamps + rose_stamps # eval: 34 = 11 + 18 + 5

    #: FA
    answer = total_stamps
    return answer # eval: return 34
