def solve(
    ...
    #: L1
    dale_toast_cost = andrew_toast_slices * toast_price # eval: 1 = 1 * 1
    ...
    #: L5
    total_breakfast_cost = dale_toast_cost + andrew_toast_cost + dale_eggs_cost + andrew_eggs_cost # eval: 14 = 1 + 1 + 6 + 6
