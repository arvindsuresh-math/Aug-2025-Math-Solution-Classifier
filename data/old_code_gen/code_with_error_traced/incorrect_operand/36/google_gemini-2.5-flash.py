def solve(
    ...
    #: L1
    lisa_earnings = total_earnings * total_earnings # eval: 3600 = 60 * 60

    #: L2
    tommy_earnings = lisa_earnings * tommy_earnings_fraction_of_lisa # eval: 1800.0 = 3600 * 0.5

    #: L3
    difference_lisa_tommy = lisa_earnings - tommy_earnings # eval: 1800.0 = 3600 - 1800.0

    #: FA
    answer = difference_lisa_tommy
    return answer # eval: return 1800.0
