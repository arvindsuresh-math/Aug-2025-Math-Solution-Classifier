def solve(
    ...
    #: L3
    biking_time_to_work = walking_time_one_way * biking_days_per_week # eval: 4 = 2 * 2

    #: L4
    biking_time_round_trip = biking_time_to_work * 2 # eval: 8 = 4 * 2

    #: L5
    total_commute_time = walking_time_round_trip + biking_time_round_trip # eval: 20 = 12 + 8
