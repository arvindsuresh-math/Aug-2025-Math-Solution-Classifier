def solve(
    ...
    #: L2
    cost_of_shoes = num_tops * price_per_shoe # eval: 40 = 4 * 10

    #: L3
    cost_shorts_and_shoes = cost_of_shorts + cost_of_shoes # eval: 75 = 35 + 40

    #: L4
    cost_of_tops = total_spent - cost_shorts_and_shoes # eval: 0 = 75 - 75

    #: L5
    price_per_top = cost_of_tops / num_tops # eval: 0.0 = 0 / 4
