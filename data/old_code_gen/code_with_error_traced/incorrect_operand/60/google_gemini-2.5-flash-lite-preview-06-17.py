def solve(
    ...
    #: L4
    total_hours_watching_practice = hours_watching_one_daughter_play * num_daughters # eval: 32 = 16 * 2

    #: L5
    total_hours_at_field = total_hours_watching_games + total_hours_watching_practice # eval: 64 = 32 + 32

    #: FA
    answer = total_hours_at_field
    return answer # eval: return 64
