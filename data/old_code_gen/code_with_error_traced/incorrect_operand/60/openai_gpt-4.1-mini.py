def solve(
    ...
    #: L2
    hours_watching_both_daughters_games = hours_per_game * 2 # eval: 4 = 2 * 2
    ...
    #: L5
    total_hours = hours_watching_both_daughters_games + hours_watching_both_daughters_practice # eval: 68 = 4 + 64
