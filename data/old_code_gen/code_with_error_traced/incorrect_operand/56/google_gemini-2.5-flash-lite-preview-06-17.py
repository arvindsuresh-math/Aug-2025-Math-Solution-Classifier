def solve(
    ...
    #: L1
    time_part_2 = time_part_1 * time_part_1 # eval: 625 = 25 * 25

    #: L2
    time_part_1_and_2 = time_part_1 + time_part_2 # eval: 650 = 25 + 625

    #: L3
    total_time_minutes = total_time_hours * 60 # eval: 120 = 2 * 60

    #: L4
    time_part_3 = total_time_minutes - time_part_1_and_2 # eval: -530 = 120 - 650
