def solve(
    ...
    #: L3
    bedroom_area = bedroom_length * bedroom_length # eval: 4 = 2 * 2

    #: L4
    fabric_left = original_bolt_area - living_room_area - bedroom_area # eval: 164 = 192 - 24 - 4

    #: FA
    answer = fabric_left
    return answer # eval: return 164
