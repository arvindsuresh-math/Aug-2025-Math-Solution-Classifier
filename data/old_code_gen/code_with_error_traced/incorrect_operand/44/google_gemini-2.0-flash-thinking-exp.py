def solve(
    ...
    food_percentage: float = 0.30, # spends 30% of his money on food
    accommodation_percentage: float = 0.15, # 15% on accommodation
    entertainment_percentage: float = 0.25 # 25% on entertainment
):
    """Index: 44.
    Returns: the amount of money spent on coursework materials.
    """
    ...
    #: L4
    coursework_materials_cost = budget - (accommodation_cost + food_percentage + entertainment_cost) # eval: 599.7 = 1000 - (150.0 + 0.3 + 250.0)

    #: FA
    answer = coursework_materials_cost
    return answer # eval: return 599.7
