def solve(
    ...
    #: L3
    remaining_balance = laptop_price - standard_down_payment # eval: 800.0 = 1000 - 200.0

    #: L5
    total_payments = monthly_installment * months_paid # eval: 260 = 65 * 4

    #: L6
    balance_after_payments = remaining_balance - total_payments # eval: 540.0 = 800.0 - 260

    #: FA
    answer = balance_after_payments
    return answer # eval: return 540.0
