def solve(
    ...
    #: L2
    total_pencils = pencils_kept + total_pencils_shared # eval: 50 = 10 + 40

    #: L3
    pencils_per_box = total_pencils / total_pencils_shared # eval: 1.25 = 50 / 40

    #: FA
    answer = pencils_per_box
    return answer # eval: return 1.25
