def solve(
    ...
    #: L3
    fourth_earthquake_collapsed = collapse_multiplier * initial_collapsed_buildings # eval: 8 = 2 * 4

    #: L4
    total_collapsed_buildings = initial_collapsed_buildings + second_earthquake_collapsed + third_earthquake_collapsed + fourth_earthquake_collapsed # eval: 36 = 4 + 8 + 16 + 8
