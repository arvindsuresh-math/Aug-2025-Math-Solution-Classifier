def solve(
    ...
    #: L3
    remaining_pages = pages_read_yesterday - total_pages_read # eval: -24 = 12 - 36

    #: L4
    pages_to_read_tomorrow = remaining_pages * fraction_remaining_to_read_tomorrow # eval: -12.0 = -24 * 0.5
