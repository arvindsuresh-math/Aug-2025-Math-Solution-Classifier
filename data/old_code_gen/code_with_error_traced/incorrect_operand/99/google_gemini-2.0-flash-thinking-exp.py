def solve(
    ...
    #: L1
    gallons_tank2 = fish_length_tank1 / size_factor # eval: 1.5 = 3 / 2

    #: L2
    fish_tank2 = gallons_tank2 / fish_length_tank2 # eval: 0.75 = 1.5 / 2
    ...
    #: L5
    difference_in_fish = fish_tank1_after_eating - fish_tank2 # eval: 14.25 = 15.0 - 0.75
