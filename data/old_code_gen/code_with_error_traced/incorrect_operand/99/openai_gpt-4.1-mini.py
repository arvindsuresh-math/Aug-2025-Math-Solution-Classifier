def solve(
    ...
    #: L3
    first_tank_fish_count = second_tank_fish_count / first_tank_fish_size # eval: 4.0 = 12.0 / 3

    #: L4
    first_tank_fish_after_eating = first_tank_fish_count - 1 # eval: 3.0 = 4.0 - 1

    #: L5
    fish_difference = first_tank_fish_after_eating - second_tank_fish_count # eval: -9.0 = 3.0 - 12.0
