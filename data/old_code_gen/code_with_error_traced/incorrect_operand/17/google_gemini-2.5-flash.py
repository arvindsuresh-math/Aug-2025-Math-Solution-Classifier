def solve(
    ...
    #: L4
    remaining_green_hats = initial_green_hard_hats - pink_hats_after_john # eval: -1 = 15 - 16

    #: L5
    remaining_pink_and_green_hats = remaining_green_hats + pink_hats_after_john # eval: 15 = -1 + 16

    #: L6
    total_remaining_hard_hats = remaining_pink_and_green_hats + initial_yellow_hard_hats # eval: 39 = 15 + 24
