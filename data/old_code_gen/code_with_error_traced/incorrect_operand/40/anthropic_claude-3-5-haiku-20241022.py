def solve(
    ...
    #: L1
    discounted_tickets = total_tickets - total_tickets # eval: 0 = 12 - 12
    ...
    #: L4
    total_discounted_tickets_cost = discounted_ticket_price * discounted_tickets # eval: 0.0 = 38.0 * 0

    #: L5
    total_regular_tickets_cost = ticket_price * discount_threshold # eval: 400 = 40 * 10

    #: L6
    total_cost = total_regular_tickets_cost + total_discounted_tickets_cost # eval: 400.0 = 400 + 0.0
