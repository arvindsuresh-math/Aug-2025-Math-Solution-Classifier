def solve(
    ...
    #: L4
    cost_of_discounted_tickets = ticket_price * discountable_tickets # eval: 80 = 40 * 2

    #: L5
    cost_of_full_price_tickets = ticket_price * discountable_tickets # eval: 80 = 40 * 2

    #: L6
    total_cost = cost_of_full_price_tickets + cost_of_discounted_tickets # eval: 160 = 80 + 80
