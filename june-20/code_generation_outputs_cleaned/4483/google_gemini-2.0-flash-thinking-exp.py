def solve(
    ...
    #: L2
    half_records = total_records * bryan_fraction_interested

    #: L3
    bryan_offer_interested = half_records * bryan_price_interested

    #: L4
    bryan_offer_not_interested = half_records * bryan_price_not_interested
