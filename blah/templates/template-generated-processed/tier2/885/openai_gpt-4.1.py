def solve():
    """Index: 885.
    Returns: the total amount Bobby paid for the handmade shoes.
    """
    # L1
    ...
    # L2
    discount_percent = 0.8 # only charge 80% of the cost for work
    discounted_labor_cost = labor_cost * discount_percent
