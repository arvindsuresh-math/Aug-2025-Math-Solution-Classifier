def solve():
    """Index: 1181.
    Returns: the total amount of money both workers received altogether.
    """
    # L1
    hours_day1 = 10 # worked for 10 hours on the first day
    hours_day2 = 8 # 8 hours on the second day
    hours_first_two_days = hours_day1 + hours_day2

    # L2
    hours_day3 = 15 # 15 hours on the third day
    ...
    # L4
    num_workers = 2 # 2 men
    total_pay = pay_per_worker * num_workers
